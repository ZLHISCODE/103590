...
On Error GoTo ErrorHand
    ...
    Exit Sub
ErrorHand:
    If errHandle("zlSoftCISInterface.frmArchiveView.ShowMe", "显示病案查阅窗口出现错误") = 1 Then Resume
End Sub
...
On Error GoTo ErrorHand
    ...
    Exit Function
ErrorHand:
    If errHandle("zlSoftCISInterface.frmArchiveView.zlRefresh", "刷新病案查阅窗口出现错误，病人ID=" & lngPatientID & "，就诊ID=" & lngClinicID) = 1 Then Resume
End Function
