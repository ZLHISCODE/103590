...
'        strPassword = Trim(FrmChangePass.TXT原密码.Text)
    ...
    '修改注册表
    SaveSetting "ZLSOFT", "注册信息\登陆信息_干保", "USER", strUserName
    SaveSetting "ZLSOFT", "注册信息\登陆信息_干保", "SERVER", strServerName
...
Private Sub Form_Load()
    ...
    mblnFirst = False
    mintTimes = 1
    txt用户.Text = GetSetting(appName:="ZLSOFT", Section:="注册信息\登陆信息_干保", Key:="USER", Default:="")
    cmb数据库.Text = GetSetting(appName:="ZLSOFT", Section:="注册信息\登陆信息_干保", Key:="SERVER", Default:="")
