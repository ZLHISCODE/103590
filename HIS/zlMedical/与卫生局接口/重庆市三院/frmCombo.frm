...
Begin VB.Form frmCombo 
   ...
   Begin MSComctlLib.ImageList ils16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCombo.frx":6AD8
            Key             =   "Class"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCombo.frx":7072
            Key             =   "Root"
         EndProperty
      EndProperty
   End
   ...
   Begin XtremeCommandBars.CommandBars cbsThis 
      ...
      _StockProps     =   0
      VisualTheme     =   2
      DesignerControls=   "frmCombo.frx":ED22
   End
...
Private Function ApplyEditColor() As Boolean
    ...
    '返回： True
    '------------------------------------------------------------------------------------------------------------------
    vsf.Cell(flexcpBackColor, 1, mCol.干保编码, vsf.Rows - 1, mCol.科室编码) = &HFFEBD7
    ApplyEditColor = True
...
Private Function zlMenuClick(ByVal strMenuItem As String) As Boolean
    ...
    Case "明细数据"
        ...
        gstrSQL = "Select RowNum As 序号,A.ID,A.名称,A.编码,D.简码,B.名称 as 所属分类,Decode(A.类别,'C','检验','D','检查','') As 类别 " & _
                    "From "
        ...
        gstrSQL = gstrSQL & _
                    ...
                    "Where (A.撤档时间 Is Null Or A.撤档时间 = To_Date('3000-01-01','YYYY-MM-DD')) " & _
                            "and A.ID=D.诊疗项目id(+) " & _
                            "and ((A.类别='C' And A.组合项目=1) OR A.类别='D')" & _
                            "and B.ID=A.分类ID "
        
        If mblnShowOK Then
            gstrSQL = "Select A.*,B.干保编码,B.干保名称,B.组合科室 As 科室编码 From (" & gstrSQL & ") A,诊疗项目目录_干保 B Where A.ID=B.诊疗项目id Order By 类别,编码"
        Else
            gstrSQL = "Select A.*,B.干保编码,B.干保名称,B.组合科室 As 科室编码 From (" & gstrSQL & ") A,诊疗项目目录_干保 B Where A.ID=B.诊疗项目id(+) Order By 类别,编码"
        End If
...
Private Function CheckValid() As Boolean
    ...
    '检查唯一性
    gstrSQL = "Select 1 From 诊疗项目目录_干保 Where 诊疗项目id<>" & lngKey & " And 干保编码='" & strCode & "'"
...
Private Function SaveData() As Boolean
    ...
    If lngKey > 0 Then
        ...
        strSQL = "Delete From 诊疗项目目录_干保 Where 诊疗项目id=" & lngKey
        gcnOracle.Execute strSQL

        If strCode <> "" Then
            
            strSQL = "Insert Into 诊疗项目目录_干保(诊疗项目id,干保编码,干保名称,组合科室) Values (" & lngKey & ",'" & strCode & "','" & Trim(vsf.TextMatrix(vsf.Row, mCol.干保名称)) & "','" & Trim(vsf.TextMatrix(vsf.Row, mCol.科室编码)) & "')"
            gcnOracle.Execute strSQL
...
Private Function InitData() As Boolean
    ...
    With vsf
        ...
        .NewColumn "干保编码", 1080, 1, , 1, GetMaxLength("诊疗项目目录_干保", "干保编码")
        .NewColumn "干保名称", 1200, 1, , 1, GetMaxLength("诊疗项目目录_干保", "干保名称")
        .NewColumn "科室编码", 1080, 1, , 1, GetMaxLength("诊疗项目目录_干保", "组合科室")
    ...
    txt(1).MaxLength = GetMaxLength("诊疗项目目录_干保", "干保编码")
    txt(0).MaxLength = GetMaxLength("诊疗项目目录_干保", "干保名称")
    txt(2).MaxLength = GetMaxLength("诊疗项目目录_干保", "组合科室")
...
Private Sub txt_KeyPress(Index As Integer, KeyAscii As Integer)
    ...
    If KeyAscii = vbKeyReturn Then
        ...
        If Index = 2 Then vsf.TextMatrix(vsf.Row, mCol.科室编码) = txt(Index)
    ...
    If KeyAscii = vbKeyReturn Then
        ...
        If Trim(txtFind.Text) <> "" Then
            ...
            Else
                ...
                txt(2).Text = vsf.TextMatrix(vsf.Row, mCol.科室编码)
...
Private Sub vsf_AfterRowColChange(ByVal OldRow As Long, ByVal OldCol As Long, ByVal NewRow As Long, ByVal NewCol As Long)
    ...
    If vsf.Col > mCol.科室编码 Then vsf.Col = mCol.科室编码
