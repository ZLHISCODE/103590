...
Begin VB.UserControl VsfGrid 
   ...
   Begin MSComctlLib.ImageList ils16 
      ...
      EndProperty
   End
   Begin ComctlLib.ImageList ils161 
      Left            =   3630
      Top             =   2040
      _ExtentX        =   1005
      _ExtentY        =   1005
...
Public Event EnterCell(ByVal Row As Long, ByVal Col As Long)
...
Private Sub vsf_EnterCell()
    RaiseEvent EnterCell(vsf.Row, vsf.Col)
End Sub
...
Private Sub vsf_SetupEditWindow(ByVal Row As Long, ByVal Col As Long, ByVal EditWindow As Long, ByVal IsCombo As Boolean)
    vsf.EditSelStart = 0
    vsf.EditSelLength = ActualLen(vsf.EditText)
End Sub
