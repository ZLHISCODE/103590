...
Public mobjEmr As Object

Public mstrConnection As String    '包含用户名、密码及服务器名的连接串

Public Property Get InputPwd() As String
    '用户输入的密码，或外部程序调用时传入的密码
    InputPwd = mvarPwd
End Property
Public Property Let InputPwd(vData As String)
    mvarPwd = vData
End Property
Public Property Get InputUser() As String
    InputUser = mvarUser
End Property
Public Property Let InputUser(vData As String)
    mvarUser = vData
End Property
...
Private Sub Form_Activate()
    If InStr(Command(), "=") > 0 Or InStr(Command(), "&") > 0 Then Me.Hide
End Sub
