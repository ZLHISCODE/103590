...
Public Function PrintSet(objParent As Object, ByVal blnFirst As Boolean, ByVal strParam As String, ByRef intPrintRange As Integer, ByRef lngBeginY As Long, ByRef intBeginPage As Integer, strPage As String, ByVal strPrivs As String) As Byte
'功能：调用打印选项
