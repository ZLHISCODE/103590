...
Begin VB.Form frmCaseTendBodyPara 
   ...
   Begin VB.PictureBox PicValue 
      ...
      Begin VB.CommandButton cmdUnVisible 
         ...
         Width           =   450
      End
      Begin zl9TemperatureChartYN.ColorPicker usrColor 
         Height          =   2190
         Left            =   -15
         TabIndex        =   86
         Top             =   -450
...
Public Function ShowPara(ByVal frmMain As Object, ByVal strPrivs As String) As Boolean
    ...
    picColor(0).BackColor = Val(zlDatabase.GetPara("手术天数显示颜色", glngSys, 1255, "0", , InStr(mstrPrivs, "护理选项设置") > 0))
    '62989:刘鹏飞,2013-07-24,体温单标记显示颜色
    picColor(1).BackColor = Val(zlDatabase.GetPara("体温单标记显示颜色", glngSys, 1255, "0", , InStr(mstrPrivs, "护理选项设置") > 0))
