...
'            Call zlRefreshData
        ...
        Case conMenu_Edit_Curve, conMenu_Edit_CurveTable '设置记录
            ...
            If Format(mDTime, "YYYY-MM-DD") = Format(strCurDate, "YYYY-MM-DD") Then
                If Format(strCurDate, "YYYY-MM-DD HH:mm:ss") < Format(mDTime, "YYYY-MM-DD HH:mm:ss") Then
                     strCurDate = Format(mDTime, "YYYY-MM-DD HH:mm:ss")
                ElseIf Format(strCurDate, "YYYY-MM-DD HH:mm:ss") > Format(mDEndTime, "YYYY-MM-DD HH:mm:ss") Then
                     strCurDate = Format(mDEndTime, "YYYY-MM-DD HH:mm:ss")
                End If
            Else
                 If Format(mDTime, "YYYY-MM-DD") = Format(mDEndTime, "YYYY-MM-DD") Then
                    intCOl = GetCurveColumn(mDEndTime, mDTime, gintHourBegin)
                    strDate = GetCurveDate(intCOl, mDTime, gintHourBegin)
                 End If
            End If
            If strDate <> "" Then
                mDTime = strCurDate
