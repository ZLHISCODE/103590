   ...
   Begin VB.Frame fra 
      ...
      Begin VB.PictureBox PicValue 
         ...
         Begin VB.CommandButton cmdUnVisible 
            ...
            Width           =   450
         End
         Begin zl9TemperatureChartYDEY.ColorPicker usrColor 
            Height          =   2190
            Left            =   0
            TabIndex        =   14
            Top             =   -495
...
Public Function ShowPara(ByVal frmMain As Object, ByVal strPrivs As String) As Boolean
    ...
    '43588:刘鹏飞,2012-09-13,添加记录单审签模式
    strTmp = Val(zlDatabase.GetPara("记录单审签模式", glngSys, 1255, "0", Array(cboSinger, lbl(12)), InStr(mstrPrivs, "护理选项设置") > 0))
    ...
    chk(18).Value = Val(zlDatabase.GetPara("脉搏短绌以(心率/脉搏)方式录入", glngSys, 1255, "0", Array(chk(18)), InStr(mstrPrivs, "护理选项设置") > 0))
...
Private Sub cmdOK_Click()
    ...
    Call zlDatabase.SetPara("脉搏短绌以(心率/脉搏)方式录入", chk(18).Value, glngSys, 1255, InStr(mstrPrivs, "护理选项设置") > 0)
    '51338,刘鹏飞,2012-07-06
