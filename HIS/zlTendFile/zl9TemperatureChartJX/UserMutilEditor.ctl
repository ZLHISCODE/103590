...
Private Sub AddActiveMenu(ByVal lngItemNO As Long)
    ...
    If lngItemNO = gint体温 Then '体温
        ...
        Set cbrControl = mcbrMenuBar部位.CommandBar.Controls.Add(xtpControlButton, conMenu_Edit_Compend * 10, "耳温" & varTmp(3) & " (&4)", -1, False): cbrControl.Parameter = "耳温": cbrControl.IconId = 1
...
Private Function InitEnv() As Boolean
    ...
    blnType = Val(GetSetting("ZLSOFT", "私有模块\UserMutilEditor\" & gstrUserName, "Value")) = 0
    If blnType Then
...
Private Sub optLevel_MouseUp(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    If optLevel(0).Value Then
         SaveSetting "ZLSOFT", "私有模块\UserMutilEditor\" & gstrUserName, "Value", 0
    Else
        SaveSetting "ZLSOFT", "私有模块\UserMutilEditor\" & gstrUserName, "Value", 1
    End If
End Sub
