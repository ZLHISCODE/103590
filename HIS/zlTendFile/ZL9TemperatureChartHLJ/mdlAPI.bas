...
Public Declare Function SetWindowsFocus Lib "user32" Alias "SetFocus" (ByVal hwnd As Long) As Long
...
Public T_ControlRect As RECT     '窗体菜单有效区域
...
Public Declare Function CreateHatchBrush _
...
Public Declare Function FloodFill _
               Lib "gdi32" (ByVal hdc As Long, _
                            ByVal X As Long, _
                            ByVal Y As Long, _
                            ByVal crColor As Long) As Long
...
Public Declare Function GetBrushOrgEx _
               Lib "gdi32" (ByVal hdc As Long, _
                            lpPoint As POINTAPI) As Long

Public Declare Function GetCurrentObject _
               Lib "gdi32" (ByVal hdc As Long, _
                            ByVal uObjectType As Long) As Long

Public Declare Function GetCurrentPositionEx _
               Lib "gdi32" (ByVal hdc As Long, _
                            lpPoint As POINTAPI) As Long
...
Public Declare Function InvertRect _
               Lib "user32" (ByVal hdc As Long, _
                             lpRect As RECT) As Long
...
Public Declare Function PtInRegion _
...
Public Declare Function CreateFont _
               Lib "gdi32" _
...
Public Declare Function GetUpdateRect _
