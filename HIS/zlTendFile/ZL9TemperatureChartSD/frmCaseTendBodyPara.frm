...
Begin VB.Form frmCaseTendBodyPara 
   ...
   Begin VB.PictureBox PicValue 
      ...
      Begin VB.CommandButton cmdUnVisible 
         ...
         Width           =   450
      End
      Begin zl9TemperatureChartSD.ColorPicker usrColor 
         Height          =   2190
         Left            =   -15
         TabIndex        =   97
         Top             =   -450
...
Public Function ShowPara(ByVal frmMain As Object, ByVal strPrivs As String) As Boolean
    ...
    '75319:刘鹏飞,2015-07-29,体温复试合格颜色
    picColor(3).BackColor = Val(zlDatabase.GetPara("体温复试合格颜色", glngSys, 1255, "10485760", Array(picColor(3)), InStr(mstrPrivs, "护理选项设置") > 0))
...
Private Sub cmdOK_Click()
    ...
    lngColor = picColor(3).BackColor
    Call zlDatabase.SetPara("体温复试合格颜色", lngColor, glngSys, 1255, InStr(mstrPrivs, "护理选项设置") > 0)
    mblnOK = True
