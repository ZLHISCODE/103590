...
Begin VB.Form frmCaseTendBodyData 
   ...
   Begin VB.PictureBox picCurve 
      ...
      Begin VB.PictureBox pic上下标 
         ...
         Visible         =   0   'False
         Width           =   1575
         Begin VB.ListBox lst上下标 
            Appearance      =   0  'Flat
            BackColor       =   &H80000018&
            Height          =   1290
            ItemData        =   "frmCaseTendBodyData.frx":6852
            Left            =   -15
            List            =   "frmCaseTendBodyData.frx":6859
            TabIndex        =   47
            Top             =   -15
            Width           =   1575
         End
      ...
      Begin VB.PictureBox pic未记 
         ...
         Begin VB.ListBox lst未记 
            ...
            BackColor       =   &H80000018&
            Height          =   1290
            ItemData        =   "frmCaseTendBodyData.frx":6868
            Left            =   -15
            List            =   "frmCaseTendBodyData.frx":686A
            TabIndex        =   16
            Top             =   -15
            Visible         =   0   'False
            Width           =   1575
      ...
      Begin VB.Frame fraDetail 
         ...
         Top             =   3840
         Width           =   7815
         Begin zl9TemperatureChart.VsfGrid vsfDetail 
            Height          =   1335
            Left            =   120
            TabIndex        =   19
            Top             =   360
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCaseTendBodyData.frx":686C
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.PictureBox picTab 
      ...
      Begin VB.PictureBox PicLst 
         ...
         Begin VB.ListBox lstSelect 
            ...
            Height          =   570
            Index           =   0
            ItemData        =   "frmCaseTendBodyData.frx":6C06
            Left            =   0
            List            =   "frmCaseTendBodyData.frx":6C13
            TabIndex        =   39
            Top             =   855
            Visible         =   0   'False
            Width           =   1215
      ...
      Begin VB.ListBox lstSelect 
         ...
         Height          =   1080
         Index           =   1
         ItemData        =   "frmCaseTendBodyData.frx":6C2C
         Left            =   8100
         List            =   "frmCaseTendBodyData.frx":6C39
         Style           =   1  'Checkbox
         TabIndex        =   29
         Top             =   900
         Visible         =   0   'False
   ...
   Begin MSComctlLib.ImageList ilsDate 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   6
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCaseTendBodyData.frx":6C52
            Key             =   "preGreen"
            Object.Tag             =   "preGreen"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCaseTendBodyData.frx":7664
            Key             =   "preGray"
            Object.Tag             =   "preGray"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCaseTendBodyData.frx":8076
            Key             =   "nextGreen"
            Object.Tag             =   "nextGreen"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCaseTendBodyData.frx":8A88
            Key             =   "nextGray"
            Object.Tag             =   "nextGray"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCaseTendBodyData.frx":949A
            Key             =   "preLight"
            Object.Tag             =   "preLight"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCaseTendBodyData.frx":9EAC
            Key             =   "nextLight"
   ...
   Begin VB.PictureBox picDate 
      ...
      Begin VB.Image imgbtn 
         ...
         Index           =   1
         Left            =   1635
         Picture         =   "frmCaseTendBodyData.frx":A8BE
         Stretch         =   -1  'True
         Top             =   0
         Width           =   255
      End
      Begin VB.Image imgbtn 
         ...
         Index           =   0
         Left            =   1920
         Picture         =   "frmCaseTendBodyData.frx":11110
         Top             =   0
         Width           =   240
      End
   ...
   Begin MSComctlLib.ImageList ilsDetail 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   1
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCaseTendBodyData.frx":11B12
            Key             =   "detele"
            Object.Tag             =   "detele"
         EndProperty
      EndProperty
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2355
            MinWidth        =   882
            Picture         =   "frmCaseTendBodyData.frx":18374
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
   ...
   Begin MSComctlLib.ImageList ilstab 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   1
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCaseTendBodyData.frx":18C08
            Key             =   "mark"
            Object.Tag             =   "mark"
         EndProperty
      EndProperty
...
Private Function CheckDateTime(ByVal lngRow As Long, ByVal strName As String, ByVal strTime As String) As Boolean
    ...
    If Format(mstrETime, "YYYY-MM-DD hh:mm:ss") < Format(Split(dtpDate.Value & " " & lblTime, "～")(1), "YYYY-MM-DD hh:mm:ss") And mstrETime > mstrEnd Then mstrEnd = mstrETime
...
Private Sub cmd上下标_Click()
    Dim strSQL As String
    Dim i As Integer
    Dim blnSelect As Boolean
    
    lst上下标.Visible = True
    cmd上下标.Visible = False
    
    On Error GoTo Errhand
        pic上下标.Tag = cmd上下标.Tag
        
        mrsCurMark.Filter = "": mrsCurMark.Sort = "编码"
        lst上下标.Clear
        If mrsCurMark.RecordCount > 0 Then
            i = 0
            With mrsCurMark
                Do While Not .EOF
                    lst上下标.AddItem zlCommFun.Nvl(!名称)
                    If zlCommFun.Nvl(!名称) = vsfCurve.TextMatrix(vsfCurve.Row, vsfCurve.Col) Then
                        lst上下标.Selected(i) = True
                        blnSelect = True
                    End If
                    i = i + 1
                .MoveNext
        ...
        If blnSelect = False And lst上下标.ListCount <> 0 Then lst上下标.Selected(0) = True
        
        If lst上下标.ListCount > 0 Then
            pic上下标.Left = vsfCurve.CellLeft + vsfCurve.Left + 15
            pic上下标.Top = vsfCurve.CellTop + vsfCurve.Top + vsfCurve.CellHeight
            If lst上下标.Height < vsfCurve.CellHeight + 20 Then lst上下标.Height = vsfCurve.CellHeight + 20
            lst上下标.Width = vsfCurve.CellWidth + 20
            pic上下标.Height = lst上下标.Height
            pic上下标.Width = lst上下标.Width
            
            If pic上下标.Top + pic上下标.Height > vsfCurve.Top + vsfCurve.Height Then
                pic上下标.Top = vsfCurve.CellTop + vsfTab.Top - pic上下标.Height
            End If
            pic上下标.Visible = True
            lst上下标.Visible = True: lst上下标.Enabled = True
            lst上下标.SetFocus
        End If
...
Private Sub lst上下标_DblClick()
    Dim intType As Integer
    Dim blnAllow As Boolean
    Dim intCount As Integer
    Dim str上下标 As String
    Dim intRows As Integer, intRow As Integer
    intType = 2
    If InStr(1, pic上下标.Tag, "|") <> 0 Then
        vsfCurve.Row = Split(pic上下标.Tag, "|")(0)
        vsfCurve.Col = Split(pic上下标.Tag, "|")(1)
    End If
    If Trim(vsfCurve.TextMatrix(vsfCurve.Row, col_数据)) <> lst上下标.Text Then
        vsfCurve.TextMatrix(vsfCurve.Row, COL_修改状态) = 2
    End If
    
    vsfCurve.TextMatrix(vsfCurve.Row, col_数据) = lst上下标.Text
    str上下标 = lst上下标.Text
    
    pic上下标.Visible = False
    lst上下标.Visible = False: lst上下标.Enabled = False
    
    blnAllow = True
    intCount = 0
    intRows = 0
    Call UpdateCurveDate(vsfCurve, vsfCurve.Row, vsfCurve.Col, intType, True)
    Call vsfCurve.SetFocus
End Sub

Private Sub lst上下标_KeyPress(KeyAscii As Integer)
    If KeyAscii = vbKeyEscape Then Call txtEdit_KeyPress(vbKeyEscape)
End Sub
...
Private Sub vsfCurve_AfterNextRow(ByVal Row As Long, Col As Long)
    If Col = col_时间 And Row <> vsfCurve.FixedRows Then
        If vsfCurve.TextMatrix(Row, col_时间) = "" Then
...
Private Sub vsfCurve_AfterRowColChange(ByVal OldRow As Long, ByVal OldCol As Long, ByVal NewRow As Long, ByVal NewCol As Long)
    ...
    Select Case Trim(vsfCurve.TextMatrix(NewRow, COL_分组名))
        ...
        Case "2)上下标说明"
            ...
            If NewCol = col_数据 Then
                cmd上下标.Visible = True
                cmd上下标.Top = vsfCurve.CellTop + 15
                cmd上下标.Left = vsfCurve.CellLeft + 15 + vsfCurve.CellWidth - 300
                cmd上下标.Height = vsfCurve.CellHeight
                cmd上下标.Tag = NewRow & "|" & NewCol
            End If
    End Select
    ...
    If Trim(vsfCurve.TextMatrix(NewRow, COL_分组名)) = "1)体温曲线项目" Then
        Select Case lng项目序号
            ...
            Case 2
                If mint心率应用 = 2 And mblnEdit心率 Then
                    If mbln脉搏共用显示 Then
                        strTmp = strTmp & Space(4) & "脉搏短绌表示法(心率/脉搏)100/130"
                    Else
                        strTmp = strTmp & Space(4) & "脉搏短绌表示法(脉搏/心率)100/130"
                    End If
                End If
...
Private Sub vsfCurve_BeforeDeleteRow(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)
    ...
    Call ShowTabUpDown
    Cancel = True
    If Trim(vsfCurve.TextMatrix(Row, COL_分组名)) = "2)上下标说明" Then Exit Sub
...
GONext:
    ...
    If Not CheckDateTime(Row, strName, Format(Split(lblTime, "～")(0), "HH:mm")) Then
        Cancel = True
        vsfCurve.Body.Cell(flexcpBackColor, Row, Col, Row, Col) = &H80000005
        vsfCurve.Body.Cell(flexcpAlignment, Row, Col, Row, Col) = flexAlignCenterCenter
    End If
...
Private Sub vsfDetail_AfterRowColChange(ByVal OldRow As Long, ByVal OldCol As Long, ByVal NewRow As Long, ByVal NewCol As Long)
    ...
    If OldRow < vsfDetail.Rows Then Call vsfDetail.SelectRow(vsfDetail.Body, OldRow, NewRow, &HFFC0C0)
