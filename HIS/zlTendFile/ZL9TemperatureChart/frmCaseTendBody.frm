...
Public Function PrintData(ByVal bytMode As Byte, Optional ByVal strPrintDevice As String = "") As Boolean
    ...
    If strPrintDevice = "" Then
        ...
        bytMode = frmCaseTendBodyPrintSet.PrintSet(Me, strParam, intPrintRange, lngBeginY, intBeginPage, strPage, mstrPrivs, bytMode)
    Else
        bytMode = 2
        intPrintRange = 2
    End If
    ...
    If intPrintRange = 0 Then
        strPage = IIf(strPage = "", Me.BodyEdit.intPage - 1, strPage)
    End If
...
Public Sub BodyEditCur(ByVal intDataEditor As Integer, Optional ByVal strParam As String = "")
    ...
    ElseIf intDataEditor = 1 Then
         Call BodyEdit.zlMenuClick("体温手术设置", strParam)
    End If
End Sub
