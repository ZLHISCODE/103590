...
Private Sub cmdOK_Click()
    ...
    Call zlDatabase.SetPara("体温单进纸", mstrBin, glngSys, 1255)
...
'    初始化打印参数
    mstrPrinter = zlDatabase.GetPara("体温单打印机", glngSys, 1255, Printer.DeviceName, , True)
    mstrBin = zlDatabase.GetPara("体温单进纸", glngSys, 1255, Printer.PaperBin, , True)
