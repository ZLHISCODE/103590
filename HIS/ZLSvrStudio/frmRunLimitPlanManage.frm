...
Begin VB.Form frmRunLimitPlanManage 
   ...
   Begin MSComctlLib.ImageList img24 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRunLimitPlanManage.frx":6944
            Key             =   "enabled"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRunLimitPlanManage.frx":7A56
            Key             =   "enabledLock"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRunLimitPlanManage.frx":94D8
            Key             =   "disabled"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRunLimitPlanManage.frx":AF5A
            Key             =   "disabledLock"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgPlanDetail 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   1
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRunLimitPlanManage.frx":C9DC
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin XtremeCommandBars.ImageManager ImageMan 
      ...
      _ExtentY        =   635
      _StockProps     =   0
      Icons           =   "frmRunLimitPlanManage.frx":10CB2
   End
...
Private Sub AdjustFormDisplay()
    With vsfPlanDetail
        ...
        .rowHeight(.Rows - 1) = vsfPlanDetail.Height - (.Rows - 1) * .rowHeight(PDT_时间段1) + 450
    End With
End Sub
...
'新增时间段
    ...
    With vsfPlanDetail
        ...
        If frmRunLimitTimeEdit.ShowMe(0, Mid(tvwPlanTree.SelectedItem.Key, 3), lngCol, strTimeStart, strTimeStop) Then
...
'删除时间段
    ...
    If tvwPlanTree.SelectedItem Is Nothing Then Exit Sub
    With vsfPlanDetail
        If .Col = 0 Or .Row = 0 Or .TextMatrix(.Row, .Col) = "" Then Exit Sub
...
'修改时间段
    ...
    With vsfPlanDetail
        ...
        .Cell(flexcpBackColor, lngRow, lngCol) = HighlightBackColor
        .Cell(flexcpForeColor, lngRow, lngCol) = HighlightForeColor
        If frmRunLimitTimeEdit.ShowMe(.Cell(flexcpData, .Row, .Col), Mid(tvwPlanTree.SelectedItem.Key, 3), .Col, strTimeStart, strTimeStop) Then
            Call tvwPlanTree_NodeClick(tvwPlanTree.SelectedItem)
            If lngRow > .Rows - 1 Then lngRow = .Rows - 1
            If lngCol > .Cols - 1 Then lngCol = .Cols - 1
            .Row = lngRow
...
'展示方案说明
Private Sub tvwPlanTree_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    Dim lngIndex As Long
    
    lngIndex = Int(Y / 350) + 1
    If lngIndex > tvwPlanTree.Nodes.Count Then Exit Sub
    Call ShowTipInfo(tvwPlanTree.hwnd, tvwPlanTree.Nodes(lngIndex).Tag, True)
End Sub
    ...
    On Error GoTo errH
        ...
        With rsTemp
            Do While Not .EOF
                ...
                vsfPlanDetail.Cell(flexcpData, j, !星期 + 1) = Val(!Id & "")
                lngLastWeekNo = !星期
                .MoveNext
            Loop
            Call AdjustFormDisplay
