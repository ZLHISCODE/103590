...
Begin VB.Form frmClientUpgradeFileUpload 
   ...
   ClientTop       =   375
   ClientWidth     =   15915
   Icon            =   "frmClientUpgradeFileUpload.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.PictureBox picHelp 
      ...
      Begin VB.Image imgPro 
         ...
         Index           =   4
         Left            =   13875
         Picture         =   "frmClientUpgradeFileUpload.frx":6852
         Top             =   285
         Width           =   675
      End
      Begin VB.Image imgPro 
         ...
         Index           =   3
         Left            =   12150
         Picture         =   "frmClientUpgradeFileUpload.frx":807E
         Top             =   285
         Width           =   675
      End
      Begin VB.Image imgPro 
         ...
         Index           =   2
         Left            =   14685
         Picture         =   "frmClientUpgradeFileUpload.frx":98AA
         Top             =   270
         Width           =   720
      End
      Begin VB.Image imgPro 
         ...
         Index           =   1
         Left            =   12990
         Picture         =   "frmClientUpgradeFileUpload.frx":B3EC
         Top             =   270
         Width           =   720
      End
      Begin VB.Image imgPro 
         ...
         Index           =   0
         Left            =   11235
         Picture         =   "frmClientUpgradeFileUpload.frx":CF2E
         Top             =   255
         Width           =   720
      End
      Begin VB.Image imgCaption 
         Height          =   720
         Left            =   300
         Picture         =   "frmClientUpgradeFileUpload.frx":EA70
         Top             =   120
         Width           =   720
      End
      Begin VB.Label lblEXP 
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeFileUpload.frx":105B2
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeFileUpload.frx":2519C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeFileUpload.frx":39D86
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeFileUpload.frx":4E970
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeFileUpload.frx":6355A
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeFileUpload.frx":78144
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeFileUpload.frx":8CD2E
            Key             =   "文件"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeFileUpload.frx":8E880
            Key             =   "检查文件"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeFileUpload.frx":903D2
            Key             =   "收集文件"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeFileUpload.frx":91F24
            Key             =   "上传文件"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeFileUpload.frx":93A76
            Key             =   "文件异常"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeFileUpload.frx":955C8
            Key             =   "警告"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeFileUpload.frx":9711A
            Key             =   "异常"
         EndProperty
      EndProperty
   End
   Begin VB.PictureBox picInformation 
      ...
      Begin VB.Image imgInformation 
         Height          =   324
         Left            =   12
         Picture         =   "frmClientUpgradeFileUpload.frx":98C6C
         Stretch         =   -1  'True
         Top             =   0
         Width           =   15684
      End
   ...
   End
End
Attribute VB_Name = "frmClientUpgradeFileUpload"
...
'        Call FloderToClipBoard(mstrScratchFilePath)
    ...
    With vsfSever
        ...
        If strNote <> "" Then
            If mblnAllUpload Then
                '插入重要操作日志
                Call SaveAuditLog(1, "上传所有文件", "成功向" & Mid(strNote, 2) & "号服务器上传文件")
            Else
                '插入重要操作日志
                Call SaveAuditLog(1, "上传新的文件", "成功向" & Mid(strNote, 2) & "号服务器上传文件")
            End If
        End If
    ...
    With vsfMain
        ...
        For i = 1 To .Rows - 1
            ...
            If BlnState Then
                ...
                If InStr(";ZLHISCRUST.EXE;7Z.EXE;7Z.DLL;AAMD532.DLL;ZLRUNAS.EXE;REGCOM.DLL;GACUTIL.EXE;GACUTIL.EXE.CONFIG;ZL7Z.DLL;", ";" & UCase(strFileName) & ";") > 0 Or UCase(strFileName) Like "*.7Z" Then
                ...
                Else
                    ...
                    If blnCollect = True Then
                        If obj7zZip.ZipFile(strFilePath, strDescPath) Then
