...
Begin VB.Form frmClientUpgradeSever 
   ...
   ClientTop       =   375
   ClientWidth     =   6390
   Icon            =   "frmClientUpgradeSever.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6630
   ...
   Begin VSFlex8Ctl.VSFlexGrid vsfUse 
      ...
      FormatString    =   $"frmClientUpgradeSever.frx":6852
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid vsfPart 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"frmClientUpgradeSever.frx":68C3
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image imgCaption 
         Height          =   720
         Left            =   525
         Picture         =   "frmClientUpgradeSever.frx":6934
         Top             =   120
         Width           =   720
      End
   ...
   Begin VSFlex8Ctl.VSFlexGrid vsfNode 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"frmClientUpgradeSever.frx":8476
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin MSComctlLib.ImageList imgEdit 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeSever.frx":84DC
            Key             =   "Check"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeSever.frx":8A76
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeSever.frx":9010
            Key             =   "签名"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeSever.frx":9362
            Key             =   "Woman"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeSever.frx":FBC4
            Key             =   "Man"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeSever.frx":16426
            Key             =   "UnCheck"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClientUpgradeSever.frx":168EE
            Key             =   "AllCheck"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmClientUpgradeSever"
...
'        strSQL = "select 名称 as 站点,位置 as 服务器地址 from zltools.zlnodelist A,zltools.zlupgradeserver B where A.编号 = B.编号(+)"
        ...
        .Cell(flexcpText, 1, Col_部门) = "[客户端无对应院区]"
