...
Begin VB.Form frmClientUpgradeFileRepair 
   ...
   ClientTop       =   375
   ClientWidth     =   8910
   Icon            =   "frmClientUpgradeFileRepair.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8130
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfWarning 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"frmClientUpgradeFileRepair.frx":6852
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin MSComctlLib.ImageList imgList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmClientUpgradeFileRepair.frx":6942
               Key             =   "准备检查"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmClientUpgradeFileRepair.frx":8494
               Key             =   "正在检查"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmClientUpgradeFileRepair.frx":9FE6
               Key             =   "检查完成正常"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmClientUpgradeFileRepair.frx":BB38
               Key             =   "检查完成错误"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmClientUpgradeFileRepair.frx":D68A
               Key             =   "检查完成信息"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmClientUpgradeFileRepair.frx":F1DC
               Key             =   "检查完成警告"
            EndProperty
         EndProperty
      End
      ...
      Begin VB.Image imgCaption 
         Height          =   720
         Left            =   240
         Picture         =   "frmClientUpgradeFileRepair.frx":10D2E
         Top             =   255
         Width           =   720
      End
      Begin VB.Label lblEXP 
   ...
   End
End
Attribute VB_Name = "frmClientUpgradeFileRepair"
                ...
                For i = 1 To .Rows - 1
                    ...
                    If objFile.FileExists(strFileSource) = True Then  '判断服务器上文件是否存在
                        ...
                        If blnZip Then
                            ...
                            strErrInfor = ""
                            If Not obj7zZip.UnZipFile(strFilePath, strCompressionPath, False, strErrInfor) Then
                                MsgBox strErrInfor, vbInformation, gstrSysName
                            End If
