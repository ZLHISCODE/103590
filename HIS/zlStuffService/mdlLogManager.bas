...
Public Sub zlWritLogEx(ByVal objCallMain As Object, ByVal lngModule As Long, ByVal strFunName As String, ByVal strLogClassify As String, _
    ByVal strLogInfor As String, Optional ByVal intLogType As Integer = 0, Optional strLogName As String = "药品服务日志跟踪", _
    Optional strGroupName As String, Optional strBusinessName As String = "药品服务")
    '---------------------------------------------------------------------------------------------------------------------------------------------
    '功能:日志写入
