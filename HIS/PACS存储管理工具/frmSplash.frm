...
Public WithEvents ChildForm As Form
Attribute ChildForm.VB_VarHelpID = -1

Private Sub ChildForm_Unload(Cancel As Integer)
    Me.Tag = "Unload": Me.Show: zlCommFun.PressKey vbKeyEscape
End Sub

Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
    If Me.Tag = "Unload" And KeyCode = vbKeyEscape Then Unload Me
End Sub
