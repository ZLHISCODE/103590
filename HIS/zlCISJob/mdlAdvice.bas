...
'    排除自由录入的诊断
'参数:
'bytType =0 取首要诊断,=1首要诊断找不到时取次要诊断;2- 取病人除首要诊断之外的诊断（（入院非第一诊断或门诊诊断非第一诊断）或住院诊断的其他诊断、并发症诊断）
    ...
    ElseIf bytType = 2 Then
            strSQL = "Select a.疾病id, a.诊断id, a.诊断描述, a.诊断类型, a.记录来源" & vbNewLine & _
                            ...
                            "(" & IIf(gblnGetPath, " a.诊断类型 In (2, 3, 12,13)", " a.诊断类型 In (1, 2, 3, 11, 12,13)") & " And a.诊断次序 <> 1 Or" & vbNewLine & _
