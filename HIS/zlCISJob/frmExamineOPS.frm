...
Begin VB.Form frmExamineOPS 
   Caption         =   "手术审核管理"
   ClientHeight    =   10230
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   15165
   Icon            =   "frmExamineOPS.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   10230
   ScaleWidth      =   15165
   ...
   Begin VB.PictureBox picUnAudited 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsAudit 
         ...
         FormatString    =   $"frmExamineOPS.frx":6852
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      _ExtentX        =   26749
      _ExtentY        =   635
      SimpleText      =   $"frmExamineOPS.frx":68ED
      _Version        =   393216
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2355
            MinWidth        =   882
            Picture         =   "frmExamineOPS.frx":6934
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
   ...
   Begin MSComctlLib.ImageList img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExamineOPS.frx":71C8
            Key             =   "Male"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExamineOPS.frx":DA2A
            Key             =   "feMale"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExamineOPS.frx":1428C
            Key             =   "unCheck"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExamineOPS.frx":14826
            Key             =   "Check"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgAdvice 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   3
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExamineOPS.frx":14DC0
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExamineOPS.frx":1535A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExamineOPS.frx":158F4
            Key             =   "签名"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmExamineOPS"
...
'隐藏列
    ...
    col_护理等级 = col_医嘱ID + 8
    col_病人Id = col_医嘱ID + 9
    col_主页ID = col_医嘱ID + 10
    COL_组ID = col_医嘱ID + 1
    COL_诊疗类别 = col_医嘱ID + 12
    COL_病人来源 = col_医嘱ID + 13
    COL_签名id = col_医嘱ID + 14
    COL_医嘱状态 = col_医嘱ID + 15
    COL_门诊号 = col_医嘱ID + 16
    col_住院号 = col_医嘱ID + 17
    COL_当前床号 = col_医嘱ID + 18
    COL_开嘱医生 = col_医嘱ID + 19
    COL_开嘱时间 = col_医嘱ID + 20
    COL_开嘱科室ID = col_医嘱ID + 21
    COL_出院科室ID = col_医嘱ID + 22
    COL_当前病区ID = col_医嘱ID + 23
    COL_主项目ID = col_医嘱ID + 24
End Enum
...
'共公接口
    ...
    Call frmExamineOPS.Show(0, frmParent)
...
'加载权限比操作员低的医生
    ...
    strSQL = "Select DISTINCT a.Id, A.性别" & IIf(Val(cboDept.ItemData(cboDept.ListIndex)) = -1, "", ",b.部门ID,e.名称 as 所属部门") & ",a.姓名,a.手术等级,a.简码 As 拼音简码, a.简码 As 五笔简码" & vbNewLine & _
...
Private Sub Form_Load()
    ...
    mlngModul = p手术审核管理
    mbln分级审核 = Val(zlDatabase.GetPara(250, glngSys)) <> 0
    mblnIsUpdate = False
    mstrChangeRows = ""
    mstr签名IDs = "0"
    ...
    'vsFlexGrid
    '-----------------------------------------------------
    strHead = ",450,1; ;审核说明,2560,1;审核时间;病人姓名,1000,1;医嘱内容,3500,1;期效,500,1;单量;主刀医生,1350,1;开始时间,2000,1;审核人,1350,1"
    strHead = strHead & ";医嘱ID;相关ID;性别;年龄;体重;入院时间;床号;组号;病况;护理等级;病人ID;主页ID;组ID;诊疗类别;病人来源;签名id;医嘱状态;门诊号;住院号;当前床号;开嘱医生;开嘱时间;开嘱科室id;出院科室id;当前病区id;主项目ID"
...
'参数：是否加载已审核医嘱,为空为加载待审核医嘱
    ...
    strSQL = "Select a.Id, a.相关id, Nvl(a.相关id, a.Id) As 组id, a.诊疗类别, Null As 选择, Null As 输入, A.姓名, p.当前床号 As 床号," & vbNewLine & _
            ...
            ",p.门诊号,p.住院号,p.当前床号,a.开嘱医生,To_Char(a.开嘱时间,'YYYY-MM-DD HH24:MI') As 开嘱时间,a.开嘱科室id,e.出院科室id,e.当前病区id,a.诊疗项目id"
    strSQL = strSQL & " From 病人医嘱记录 A, 病人信息 P, 诊疗项目目录 B, 病案主页 E,收费项目目录 F,诊治所见项目 G,病人医嘱附件 D" & vbNewLine & _
            IIf(blnIsAudited, ",(Select 医嘱id,操作时间,操作说明,操作类型,签名ID" & vbNewLine & _
                ...
                "Where Top = 1)  C", "") & _
            IIf(mbln分级审核, ",疾病编码目录 I, 疾病诊断对照 R", "")
    strSQL = strSQL & " Where a.病人id = p.病人id And a.诊疗项目id = b.Id  And f.id(+)=e.护理等级id  And e.病人id(+) = a.病人id And e.主页id(+) = a.主页id And d.医嘱ID(+)=a.id And d.要素id=g.id(+) And g.中文名(+)='主刀医生' " & _
            IIf(blnIsAudited, " And c.医嘱id = a.Id ", " And A.开嘱时间 between [5] and [6]  And a.医嘱状态 = 1 And a.审核状态 = 1 ") & vbNewLine & _
            " And a.开嘱医生=[1] And a.诊疗类别 ='F'  And a.相关ID is null" & IIf(mbln分级审核, "  And i.Id(+) = r.疾病id And r.手术id(+) = a.诊疗项目id and (I.手术类型 is null or instr([7],I.手术类型)>0)", "") & _
    ...
    If mbln分级审核 Then
        If InStr(mstrPrivs, ";一级手术;") > 0 Then strPrivs = strPrivs & ";一级;"
        If InStr(mstrPrivs, ";二级手术;") > 0 Then strPrivs = strPrivs & ";二级;"
        If InStr(mstrPrivs, ";三级手术;") > 0 Then strPrivs = strPrivs & ";三级;"
        If InStr(mstrPrivs, ";四级手术;") > 0 Then strPrivs = strPrivs & ";四级;"
    End If
    
    Set rsTmp = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, rptDoc.SelectedRows(0).Record(col_姓名).Value, UserInfo.姓名, CDate(dtpTime(0).Value), CDate(dtpTime(1).Value + 1 - 1 / 24 / 60 / 60), CDate(dtpTimeY(0).Value), CDate(dtpTimeY(1).Value + 1 - 1 / 24 / 60 / 60), strPrivs)
    ...
    With vsAudit
        ...
        .Redraw = flexRDNone
        .Rows = 1
        .ColHidden(COL_审核人) = Not blnIsAudited
        If rsTmp.RecordCount > 0 Then
            ...
            Do While Not rsTmp.EOF
                ...
                If blnIsAudited Then
                    .TextMatrix(i, COL_审核人) = UserInfo.姓名
                Else
                    .TextMatrix(i, COL_审核人) = ""
                End If
            ...
            If Not .Rows(i).GroupRow Then
                If blnIsAllChar Then
                    If .Rows(i).Record(col_姓名).Value Like IIf(gstrLike = "", "", "*") & strMsg & "*" Or _
                            UCase(.Rows(i).Record(COL_拼音简码).Value) Like IIf(gstrLike = "", "", "*") & strMsg & "*" Then
