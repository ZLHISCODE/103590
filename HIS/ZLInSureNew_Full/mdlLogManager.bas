...
Public Const G_STR_LOG_NAME = "医保接口调试日志"
Public Const G_STR_PROJECT = "ZL9Insure"
...
Public Sub WriteLogCall(ByVal strLogName As String, ByVal strFuncName As String, strCallName As String, lcsCurentLogCallState As gLogCallState, _
    ...
    gobjLog.LogCall strLogName, G_STR_PROJECT, CStr(glngModul), strFuncName, strCallName, lcsCurentLogCallState, varPara
End Sub
Public Sub WriteLog(ByVal strLogName As String, ByVal strFuncName As String, ByVal strLogInfor As String, ParamArray arrPars() As Variant)
    '---------------------------------------------------------------------------------------------------------------------------------------------
    '功能:日志跟踪
    '入参:
    '返回:成功返回true,否则返回False
    ...
    End If
    Call SetLogBusinessDB
    Call gobjLog.Log(strLogName, G_STR_PROJECT, CStr(glngModul), strFuncName, EM_Trace, strLogInfor, varPara)
End Sub
...
'    ByVal strLogInfor As String, Optional ByVal intLogType As Integer = 0, Optional strLogName As String = "医保接口调试日志", _
...
'    ByVal strLogInfor As String, Optional ByVal intLogType As Integer = 0, Optional strLogName As String = "医保接口调试日志", _
'    Optional strGroupName As String, Optional strBusinessName As String = "医保")
'    '---------------------------------------------------------------------------------------------------------------------------------------------
'    '功能:日志写入
