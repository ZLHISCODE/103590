...
Private Function IsValid() As Boolean
    ...
    If mbytType <> 2 Then
        ...
        Else
            ...
            Set rsTemp = zlDatabase.OpenSQLRecord(gstrSQL, Me.Caption, TYPE_黔南, g病人身份_黔南.医保证号)
    ...
    Else
        ...
        If InStr(1, g病人身份_黔南.动态信息, "'") > 0 Then
            gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & TYPE_黔南 & ",'动态信息','''" & Replace(g病人身份_黔南.动态信息, "'", "''") & "''')"
        Else
            gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & TYPE_黔南 & ",'动态信息','''" & g病人身份_黔南.动态信息 & "''')"
        End If
