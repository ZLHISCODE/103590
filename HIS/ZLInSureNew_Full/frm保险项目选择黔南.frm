   ...
   Begin MSComctlLib.ImageList img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择黔南.frx":0E42
            Key             =   "Detail"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择黔南.frx":1C94
            Key             =   "Class"
         EndProperty
      EndProperty
   End
...
Public Function GetCode(ByVal frmMain As Form, strCode As String, strName As String, Optional bln诊疗 As Boolean = False) As Boolean
    ...
    '返回：成功返回True
    mLocalCode = strCode
    frm保险项目选择黔南.Show vbModal, frm保险项目
...
Private Sub cmdRequery_Click()
    ...
    '1.下载药品
    lblInfor.Caption = "药品"
    If 下载服务项目目录_黔南(1, prgs) = False Then
        GoTo GoEnd:
    End If
    '2.下载诊疗
    lblInfor.Caption = "诊疗"
    If 下载服务项目目录_黔南(2, prgs) = False Then
        GoTo GoEnd:
    End If
    '3.下载服务
    lblInfor.Caption = "服务"
    If 下载服务项目目录_黔南(3, prgs) = False Then
        GoTo GoEnd:
    End If
    '4.下载费用类别
    lblInfor.Caption = "费用类别"
    If 下载服务项目目录_黔南(4, prgs) = False Then
       GoTo GoEnd:
    End If
    '5.下载病种
    lblInfor.Caption = "病种"
    If 下载服务项目目录_黔南(5, prgs) = False Then
        GoTo GoEnd:
    End If
GoEnd:
