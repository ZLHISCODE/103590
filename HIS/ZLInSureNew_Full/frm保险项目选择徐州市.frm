...
Begin VB.Form frm保险项目选择徐州市 
   ...
   Begin MSComctlLib.ImageList img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择徐州市.frx":0000
            Key             =   "Detail"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择徐州市.frx":0E52
            Key             =   "Class"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frm保险项目选择徐州市"
...
Private Sub cmdOK_Click()
    ...
    '返回选择项目编码
    mstrCode = lvwDetail.SelectedItem.ListSubItems(1)
    If mint险类 = TYPE_铜山县 Then
        mstrCode = mstrCode & "|" & lvwDetail.SelectedItem.ListSubItems(5)
    End If
    mstrName = lvwDetail.SelectedItem.ListSubItems(2)
    mstrMemo = lvwDetail.SelectedItem.Text
...
'返回：成功返回True
    ...
    FillList
    mint险类 = int险类
    frm保险项目选择徐州市.Show vbModal, frm保险项目
    '返回值
    If mblnOK = True Then
        strCODE = mstrCode
        strName = mstrName
...
'功能：显示当前类别下的医保明细
    ...
    If tvwClass.SelectedItem.Key = "YAO" Then
        gstrSQL = "Select 流水号 As 项目ID, 商品名编号 As 医保编码, 商品名 As 项目名称,规格, 剂型,医保类别 From 中心药品库"
    Else
        gstrSQL = "Select 流水号 As 项目ID, 中心编号 As 医保编码, 项目名称, 计价单位,审批标记, 甲乙分类 From 中心诊疗库"
    End If
WriteInfo gstrSQL
