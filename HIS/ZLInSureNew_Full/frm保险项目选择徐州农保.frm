...
Begin VB.Form frm保险项目选择徐州农保 
   ...
   Begin MSComctlLib.ImageList img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择徐州农保.frx":0000
            Key             =   "Detail"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择徐州农保.frx":0E52
            Key             =   "Class"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frm保险项目选择徐州农保"
...
'功能：显示当前类别下的医保明细
    ...
    If tvwClass.SelectedItem.Key = "YAO" Then
        gstrSQL = "Select a.id As 项目ID, a.code As 医保编码, a.name As 项目名称, a.speci As 规格, b.name As 剂型, a.py As 拼音码 From price_item a,assort b " & _
            "where yp_bz=1 And a.type2=b.id union all " & _
