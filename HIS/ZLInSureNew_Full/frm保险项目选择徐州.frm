   ...
   Begin MSComctlLib.ImageList img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择徐州.frx":0000
            Key             =   "Detail"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择徐州.frx":0E52
            Key             =   "Class"
         EndProperty
      EndProperty
   End
...
'返回：成功返回True
    ...
    frm保险项目选择徐州.Show vbModal, frm保险项目
    '返回值
    If mblnOK = True Then
        strCode = mstrCode
        strName = mstrName
...
'功能：显示当前类别下的医保明细
    ...
    If tvwClass.SelectedItem.Key = "YAO" Then
        gstrSQL = "Select trade_code As 医保编码, trade_name As 项目名称,specification As 规格, means_type As 剂型, py_codes As 拼音码, wb_codes As 五笔码, Case When mi_class='1' Then '甲类' When mi_class='2' Then '乙类' When mi_class='3' Then '自费' When mi_class='4' Then '草药单味不支付复方支付' When mi_class='5' Then '自费' End As 类别 From mi_drug_trade_list Order By trade_code"
        lvwDetail.ColumnHeaders(3).Text = "剂型"
    Else
        gstrSQL = "Select item_code As 医保编码, item_name As 项目名称,'' as 规格, self_rate As 自付比例, py_codes As 拼音码,wb_codes As 五笔码, Case When mi_class='1' Then 'A类诊疗' When mi_class='2' Then 'B类诊疗' Else '自费' End As 类别 From mi_dt_item Order By item_code"
