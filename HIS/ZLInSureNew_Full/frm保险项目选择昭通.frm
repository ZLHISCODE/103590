   ...
   Begin MSComctlLib.ImageList img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择昭通.frx":0000
            Key             =   "Detail"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择昭通.frx":0E52
            Key             =   "Class"
         EndProperty
      EndProperty
   End
...
'返回：成功返回True
    ...
    frm保险项目选择昭通.Show vbModal, frm保险项目
    '返回值
    If mblnOK = True Then
        strCODE = mstrCode
        strName = mstrName
...
'功能：显示当前类别下的医保明细
    ...
    If tvwClass.SelectedItem.Key = "YAO" Then
        gstrSQL = "Select dm As 医保编码,tm As 项目名称,dl 收费类别,decode(lb,'10','甲类','11','乙类','自费') 类别,py as 拼音码,JX As 剂型,gg 规格,rq 启用日期,zt 状态,cs 生产厂商 From tab_syml Order by tm"
    Else
        gstrSQL = "Select dm As 医保编码,Mc As 项目名称,Dw As 单位,KC As 拼音码 From tab_fwcl Order by mc"
    End If
    Set rsTemp = gcn昭通.Execute(gstrSQL)
    
    lvwDetail.ColumnHeaders.Clear
    lvwDetail.ColumnHeaders.Add , , "医保编码", 1200
    lvwDetail.ColumnHeaders.Add , , "项目名称", 1200, lvwColumnCenter
    If tvwClass.SelectedItem.Key = "YAO" Then
        lvwDetail.ColumnHeaders.Add , , "收费类别", 1000, lvwColumnCenter
        lvwDetail.ColumnHeaders.Add , , "类别", 1000, lvwColumnCenter
        lvwDetail.ColumnHeaders.Add , , "拼音码", 1000, lvwColumnCenter
        lvwDetail.ColumnHeaders.Add , , "剂型", 1000, lvwColumnCenter
        lvwDetail.ColumnHeaders.Add , , "规格", 1000, lvwColumnCenter
        lvwDetail.ColumnHeaders.Add , , "启用日期", 1200, lvwColumnCenter
        lvwDetail.ColumnHeaders.Add , , "状态", 800, lvwColumnCenter
        lvwDetail.ColumnHeaders.Add , , "生产厂商", 1500, lvwColumnCenter
    Else
        lvwDetail.ColumnHeaders.Add , , "单位", 1000, lvwColumnCenter
        lvwDetail.ColumnHeaders.Add , , "拼音码", 1000, lvwColumnCenter
    End If
    ...
    While Not rsTemp.EOF
        ...
        If tvwClass.SelectedItem.Key = "YAO" Then
            ...
            itmTemp.ListSubItems.Add , , Nvl(rsTemp(6), "")
            itmTemp.ListSubItems.Add , , Nvl(rsTemp(7), "")
            itmTemp.ListSubItems.Add , , Nvl(rsTemp(8), "")
            itmTemp.ListSubItems.Add , , Nvl(rsTemp(9), "")
        End If
        rsTemp.MoveNext
    Wend
