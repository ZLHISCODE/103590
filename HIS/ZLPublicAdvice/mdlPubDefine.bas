...
Public Const conMenu_Manage_ReportPacsView = 2330    '查阅Pacs报告(&P)
...
Public Const conMenu_Edit_AdviceBalance = 30138      '*诊间结算
Public Const conMenu_Edit_Untread = 5019    '*回退(&R)
Public Const conMenu_Edit_SendBack = 3015   '*超期发送收回(&Z)
Public Const conMenu_Edit_Test = 990056       '*皮试结果(&T)
...
Public Const conMenu_Edit_Refcom = 30822          '拒绝审核理由
Public Const conMenu_Edit_ViewRefcom = 30823      '查阅审方结果
...
Public Const conMenu_Edit_ViewPacs = 4255     '浏览检查图像和报告
...
Public Const conMenu_Edit_TraReaction = 30799    '输血反应
...
Public Const conMenu_Edit_MeetArrive = 3855    '确认医生参加会诊

'中医辨证论治
Public Const conMenu_Edit_ZyAdd = 3856     '新增处方
Public Const conMenu_Edit_ZyEdit = 3857   '修改处方
Public Const conMenu_Edit_ZyView = 3858   '查看处方
Public Const conMenu_Edit_ZyDel = 3859   '删除处方
...
Public Const conMenu_Edit_Save = 3503        '*保存
...
Public Const conMenu_Edit_FeeAudit = 804    '审核或开始审核
...
Public Const conMenu_Edit_Transf_Save = 3501     '保存
...
Public Const conMenu_LIS_HideList = 741       '隐藏病人列表
...
Public Const conMenu_Report_ClinicIndexBill = 409      '门诊指引单
Public Const conMenu_Report_BloodInstant = 410    '输血执行单(&I)
...
Public Const conMenu_View_AdviceLost = 707           '医嘱刷新时定位到最后
...
Public Const conMenu_Help_Web_Mail = 6879       '*发送反馈(&M)
