...
Private mobjCurPati As PatiInfor
Private mobjCurCardData As PatiInfor   '当前三方卡病人数据或IC卡类存储的病人信息
...
Public Sub zlInit(ByVal frmMain As Object, Optional ByVal lngSys As Long, Optional ByVal lngModul As Long, _
    ...
    Call IDKind.zlInit(frmMain, lngSys, lngModul, cnOracle, strDBUser, objCardSquare, strIDKindStr, txtPatient, strProductName, OnlyThreeCard)
...
End Property
Public Function zlGetPatiObjectFromPatiID(ByVal lng病人ID As Long, ByRef objPati As PatiInfor, ByRef strErrMsg As String, Optional strOtherName As String = "", _
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------
    zlGetPatiObjectFromPatiID = zlGetPati(gcnOracle, lng病人ID, objPati, strErrMsg, strOtherName, strOtherValue)
End Function
