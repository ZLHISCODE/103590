...
Public Function GetSearch(ByVal FrmMain As Form, _
        ...
        ByRef int已复核单据 As Integer) As String
    ...
    SQLCondition.date复核时间开始 = date复核时间开始
    SQLCondition.date复核时间结束 = date复核时间结束
    
    TemporaryInquiries.int未审核单据 = int未审核单据
    TemporaryInquiries.int已审核单据 = int已审核单据
    TemporaryInquiries.int已复核单据 = int已复核单据
    '---------------------
    ...
    int已复核单据 = TemporaryInquiries.int已复核单据
    '---------------------
...
Private Sub Form_Load()
    ...
    Me.dtp结束时间(2) = SQLCondition.date复核时间结束
    Me.dtp开始时间(0) = SQLCondition.date填制时间开始
    Me.dtp开始时间(1) = SQLCondition.date审核时间开始
    Me.dtp开始时间(2) = SQLCondition.date复核时间开始
