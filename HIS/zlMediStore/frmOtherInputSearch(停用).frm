...
Public Function GetSearch(ByVal FrmMain As Form, _
        ...
        ByRef lng入出类别 As Long, _
        ByRef int未审核单据 As Integer, _
        ByRef int已审核单据 As Integer, _
        ByRef int包含冲销 As Integer) As String
...
Private Sub Cmd药品_Click()
    ...
    Call SetSelectorRS(1, "药品其他入库管理", mfrmMain.cboStock.ItemData(mfrmMain.cboStock.ListIndex), mfrmMain.cboStock.ItemData(mfrmMain.cboStock.ListIndex), , , , True)
