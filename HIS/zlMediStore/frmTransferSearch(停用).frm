...
Public Function GetSearch(ByVal FrmMain As Form, ByVal lngMode As Long, ByVal lngStoreid As Long, _
        ...
        Optional ByRef int未审核单据 As Integer, Optional ByRef int未审核冲销 As Integer, Optional ByRef int已审核单据 As Integer, Optional ByRef int已审核冲销 As Integer, Optional ByRef int包含冲销 As Integer) As String
    ...
    TemporaryInquiries.int未审核冲销 = int未审核冲销
    TemporaryInquiries.int已审核单据 = int已审核单据
    TemporaryInquiries.int已审核冲销 = int已审核冲销
    ...
    int未审核冲销 = TemporaryInquiries.int未审核冲销
    int已审核单据 = TemporaryInquiries.int已审核单据
    int已审核冲销 = TemporaryInquiries.int已审核冲销
