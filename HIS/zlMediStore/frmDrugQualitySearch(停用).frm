...
Public Function GetSearch(ByVal FrmMain As Form, _
        ...
        ByRef int未处理单据 As Integer, ByRef int已处理单据 As Integer) As String
    ...
    TemporaryInquiries.int未处理单据 = int未处理单据
    TemporaryInquiries.int已处理单据 = int已处理单据
    '---------------------
    ...
    '临时查询保留
    '---------------------
    int未处理单据 = TemporaryInquiries.int未处理单据
    int已处理单据 = TemporaryInquiries.int已处理单据
    '---------------------
...
Private Sub Cmd确定_Click()
    ...
    TemporaryInquiries.int未处理单据 = chk填制.Value
    TemporaryInquiries.int已处理单据 = chk审核.Value
...
Private Sub Form_Load()
    ...
    Me.chk填制.Value = TemporaryInquiries.int未处理单据
    Me.chk审核.Value = TemporaryInquiries.int已处理单据
    '--------------------------------
