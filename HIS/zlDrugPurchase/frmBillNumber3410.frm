...
Begin VB.Form frmBillNumber3410 
   Caption         =   "配送单号导入"
   ClientHeight    =   8145
   ClientLeft      =   60
   ClientTop       =   405
   ClientWidth     =   15855
   Icon            =   "frmBillNumber3410.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   8145
   ScaleWidth      =   15855
   ...
   Begin VSFlex8Ctl.VSFlexGrid vsfList 
      ...
      FormatString    =   $"frmBillNumber3410.frx":6852
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VB.Image Image 
      Height          =   480
      Left            =   255
      Picture         =   "frmBillNumber3410.frx":6D76
      Top             =   120
      Width           =   480
   End
   Begin VB.Label lblInfor 
      Caption         =   $"frmBillNumber3410.frx":7080
      Height          =   405
      Left            =   840
      TabIndex        =   8
      Top             =   240
   ...
   End
End
Attribute VB_Name = "frmBillNumber3410"
...
Private Sub cmd提取补录发票信息_Click()
    ...
    strSQL = "Select Distinct g.配送单号 , a.No, a.药品id, a.序号, d.编码 As 药品编码,d.名称, d.规格, d.计算单位 as 单位,a.产地 as 生产商,  a.批号 as 批号, a.效期 as 有效日期, a.填写数量 As 数量, a.成本价 as 单价, a.成本金额 As 金额," & vbNewLine & _
                    ...
                    "                a.审核日期, a.库房id, a.外观, a.生产日期, a.配药人 As 核查人, a.配药日期 As 核查日期, Nvl(a.用法, 0) As 金额差, a.频次 As 加成率," & vbNewLine & _
