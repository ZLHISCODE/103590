...
Begin VB.Form frmBillNumber35110 
   Caption         =   "配送单号导入"
   ClientHeight    =   8145
   ClientLeft      =   60
   ClientTop       =   405
   ClientWidth     =   15855
   Icon            =   "frmBillNumber35110.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   8145
   ScaleWidth      =   15855
   ...
   Begin VSFlex8Ctl.VSFlexGrid vsfList 
      ...
      FormatString    =   $"frmBillNumber35110.frx":6852
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VB.Image Image 
      Height          =   480
      Left            =   255
      Picture         =   "frmBillNumber35110.frx":6DEE
      Top             =   120
      Width           =   480
   End
   Begin VB.Label lblInfor 
      Caption         =   $"frmBillNumber35110.frx":70F8
      Height          =   405
      Left            =   840
      TabIndex        =   9
      Top             =   240
   ...
   End
End
Attribute VB_Name = "frmBillNumber35110"
