...
Begin VB.Form frmRegistEdit 
   ...
   Begin VB.PictureBox picReg 
      ...
      Begin VB.PictureBox picPati 
         ...
         Begin zlIDKind.IDKindNew IDKind 
            ...
            _ExtentY        =   661
            Appearance      =   2
            IDKindStr       =   $"frmRegistEdit.frx":1C86
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "宋体"
               Size            =   12
               Charset         =   134
         ...
         Begin VB.CommandButton cmdComminuty 
            ...
            Height          =   360
            Left            =   4860
            Picture         =   "frmRegistEdit.frx":1D33
            Style           =   1  'Graphical
            TabIndex        =   85
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdCard 
            ...
            Height          =   360
            Left            =   4140
            Picture         =   "frmRegistEdit.frx":22BD
            Style           =   1  'Graphical
            TabIndex        =   83
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdLookup 
            ...
            Height          =   360
            Left            =   3765
            Picture         =   "frmRegistEdit.frx":2847
            Style           =   1  'Graphical
            TabIndex        =   6
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdMore 
            ...
            Height          =   360
            Left            =   4500
            Picture         =   "frmRegistEdit.frx":2991
            Style           =   1  'Graphical
            TabIndex        =   39
            TabStop         =   0   'False
         ...
         End
      End
      Begin VB.PictureBox picPayInfor 
         BorderStyle     =   0  'None
         Height          =   1605
         Left            =   3915
         ScaleHeight     =   1605
      ...
      Begin VB.CommandButton cmdPatiPic 
         Height          =   375
         Left            =   6105
         Picture         =   "frmRegistEdit.frx":2F1B
         Style           =   1  'Graphical
         TabIndex        =   100
      ...
      Begin VB.PictureBox pic备注 
         ...
         Begin VB.CommandButton cmdRemark 
            Height          =   315
            Left            =   2805
            Picture         =   "frmRegistEdit.frx":976D
            Style           =   1  'Graphical
            TabIndex        =   106
            TabStop         =   0   'False
            Top             =   30
   ...
   Begin VB.PictureBox picleft 
      ...
      Begin VSFlex8Ctl.VSFlexGrid mshPlan 
         ...
         EndProperty
         MousePointer    =   0
         MouseIcon       =   "frmRegistEdit.frx":9863
         BackColor       =   -2147483643
         ForeColor       =   -2147483640
         BackColorFixed  =   -2147483633
         ForeColorFixed  =   -2147483630
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"frmRegistEdit.frx":9E3D
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
...
Private mblnFirst As Boolean, mstrCardPrivs As String
...
Private Sub Form_Load()
   ...
   ' Call zlInitParaSet  '初始化本地参数
    ...
    If mbytInState = 1 Then '查阅时,不能更改窗体大小:25623
...
Private Sub Form_Resize()
   ...
   End If
    ...
    mblnNotChange = True
    If Me.ScaleHeight < 600 * Screen.TwipsPerPixelY Then
        picReg.Height = 600 * Screen.TwipsPerPixelY
        picReg.Top = Me.ScaleTop + (Me.ScaleHeight - picReg.Height) / 2
    Else
        picReg.Height = Me.ScaleHeight: picReg.Top = Me.ScaleTop
    End If
...
Private Sub picMoney_Resize()
    Dim lngTop As Long
    If mblnNotChange Then Exit Sub
    
    Err = 0: On Error Resume Next
    With picMoney
        txt个帐支付.Top = .ScaleHeight - txt个帐支付.Height - 20
        lbl个帐支付.Top = txt个帐支付.Top + (txt个帐支付.Height - lbl个帐支付.Height) \ 2
        lbl预交支付.Top = lbl个帐支付.Top
        txt预交支付.Top = txt个帐支付.Top
        
        If Not txt发生时间.Visible Then
             txt发生时间.Top = txt个帐支付.Top
        Else
            txt发生时间.Top = IIf(txt预交支付.Visible Or txt个帐支付.Visible, txt个帐支付.Top, .ScaleHeight) - txt发生时间.Height - 50
        End If
        lbl发生时间.Top = txt发生时间.Top + (txt发生时间.Height - lbl发生时间.Height) \ 2
        chk病历费.Top = txt发生时间.Top + (txt发生时间.Height - chk病历费.Height) \ 2
        chkExtra.Top = chk病历费.Top
        mshMoney.Height = txt发生时间.Top - mshMoney.Top - 50
        
        txt预交支付.Left = .ScaleWidth - txt预交支付.Width - 50
        lbl预交支付.Left = txt预交支付.Left - lbl预交支付.Width - 50
        
        If Not txt发生时间.Visible Then
            lbl个帐支付.Left = IIf(chkExtra.Visible, chkExtra.Left + chkExtra.Width + 50, chkExtra.Left)
        Else
            lbl个帐支付.Left = chk病历费.Left
        End If
        txt个帐支付.Left = lbl个帐支付.Left + lbl个帐支付.Width + 50
    End With
    
'
'    If stbThis.Panels(3).Visible Then '个人帐户余额
'        '调整位置
...
Private Sub picPati_Resize()
    Err = 0: On Error Resume Next
    With picPati
        cbo付款方式.Top = picPati.ScaleHeight - cbo付款方式.Height - 70
        cbo费别.Top = cbo付款方式.Top
        txt门诊号.Top = cbo付款方式.Top
    End With
    lbl付款方式.Top = cbo付款方式.Top + (cbo付款方式.Height - lbl付款方式.Height) \ 2
    lbl费别.Top = lbl付款方式.Top
    lbl门诊号.Top = lbl付款方式.Top
End Sub
...
Private Sub picReg_Resize()
    ...
    Err = 0: On Error Resume Next
    With picReg
        lblPrompt.Top = .Height - lblPrompt.Height - IIf(stbThis.Visible, stbThis.Height, 0) - 20
        cmdHelp.Top = lblPrompt.Top - cmdHelp.Height - 10
        cmd结束挂号.Top = cmdHelp.Top
        cmdOK.Top = cmdHelp.Top
        cmdCancel.Top = cmdHelp.Top
        picTotal.Top = cmdHelp.Top - picTotal.Height - 50
        picPayInfor.Top = picTotal.Top
        cbo预约方式.Top = picTotal.Top - cbo预约方式.Height - 100
        lbl预约方式.Top = cbo预约方式.Top + (cbo预约方式.Height - lbl预约方式.Height) \ 2
        pic备注.Top = cbo预约方式.Top
        txt摘要.Top = pic备注.Top
        lbl摘要.Top = lbl预约方式.Top
        
        picMoney.Height = cbo预约方式.Top - picMoney.Top - 50
    End With
...
Public Sub txtPatient_Validate(Cancel As Boolean)
    ...
    If txtPatient.Text <> "" Then
        ...
        If Not mblnStation And Not mrsInfo Is Nothing And mbytMode = 0 Then
            If mbytMode = 0 And mbytInState = 0 And mstrNoIn <> "" Then Exit Sub
...
Private Sub InitFace()
    ...
    zlControl.CboSetWidth cbo费别.Hwnd, cbo费别.Width * 2
    zlControl.CboSetWidth cbo付款方式.Hwnd, cbo付款方式.Width * 2
    zlControl.CboSetWidth cbo结算方式.Hwnd, cbo结算方式.Width * 2.5
    zlControl.CboSetWidth cbo医疗类别.Hwnd, cbo医疗类别.Width * 1.5
...
'            cbo家庭地址.Width = txt家庭电话.Width
        ...
        Else
            ...
            If mblnStation Then
                ...
                '74550,冉俊明,2014-7-2,在病人来院就诊,医生在门诊医生站挂号时能够选择结算方式(包含性质为7的一卡通结算)
                cbo结算方式.Visible = Not mblnStationPrice
...
'            lbl发生时间.Top = txt发生时间.Top + (txt发生时间.Height - lbl发生时间.Height) \ 2
    ...
    cbo家庭地址.Visible = Not mblnStructAdress: cbo户口地址.Visible = Not mblnStructAdress
    ...
    Else
        ...
        picPati.Height = 2955
    End If
    picMoney.Top = picPati.Top + picPati.Height
End Sub
...
'--------------------------
   ...
   If (mbytMode = 4 Or mbytMode = 3) And mbytInState = 1 Then
        ...
        Me.txtFact.Enabled = False: Me.txt发生时间.Enabled = False
        
        For Each Control In Me.Controls
             If TypeName(Me.pic备注) = TypeName(Control) Then
               Control.Enabled = Control Is Me.picReg Or Control Is pic备注 Or Control Is picPayInfor Or (mbytMode = 4 And Control Is Me.picMoney)
             End If
        Next
...
Private Sub SetShowBalance()
    ...
    picPayInfor.Visible = blnVisible
    picTotal.Width = IIf(picPayInfor.Left - picTotal.Left - 30 < 0, 0, picPayInfor.Left - picTotal.Left - 30)
    lbl合计.Left = picTotal.ScaleWidth - lbl合计.Width - 60
    lblSum.Caption = "合计"
...
Private Sub SetUndisplayBalance()
    ...
    If (mbytInState = 0 Or mbytInState = 1 And mbytMode = 4 Or chkCancel.Value = 1) Then
        ...
        If mRegistFeeMode = EM_RG_记帐 Or blnPrice Then
            ...
            picTotal.Width = picMoney.Width - 200
            lbl合计.Left = picTotal.ScaleWidth - lbl合计.Width - 60
    ...
    If mbytInState = 1 And mbytMode = 0 Then
        '查看
        If mRegistFeeMode = EM_RG_记帐 Or txt摘要.Tag <> "" Then '划价
            lblSum.Caption = IIf(txt摘要.Tag <> "", "划价", "记帐")
            picTotal.Width = picMoney.Width - 200
            lbl合计.Left = picTotal.ScaleWidth - lbl合计.Width - 60
            lblSum.Caption = IIf(txt摘要.Tag <> "", "划价", "记帐")
        ...
        Else
            lblSum.Caption = "合计"
            picPayInfor.Visible = True
            cbo结算方式.Visible = True: picTotal.Visible = True
            cbo结算方式.Enabled = False
            cbo结算方式.Top = txt本次应缴.Top
            lbl缴款.Top = lbl应缴.Top
            lbl缴款.Visible = True
            lbl缴款.Caption = "结算方式"
            cbo结算方式.Left = lbl缴款.Left + lbl缴款.Width + 15
            cbo结算方式.Width = picPayInfor.ScaleWidth - cbo结算方式.Left - 30
            picTotal.Width = picPayInfor.Left - picTotal.Left - 60
            lbl合计.Left = picTotal.ScaleWidth - lbl合计.Width - 60
            picTotal.Cls
            zlControl.PicShowFlat picTotal, -1, , taCenterAlign
        End If
    ...
    If mbytInState = 1 And mbytMode = 4 Or chkCancel.Value = 1 Then
        ...
        picPayInfor.Visible = blnVisible
        cbo结算方式.Visible = blnVisible
        cbo结算方式.Top = txt本次应缴.Top: txt本次应缴.Left = txt缴款.Left: txt本次应缴.Width = txt缴款.Width
    ...
    ElseIf mbytInState = 0 Then
        blnVisible = mbytInState = 0 Or mbytInState = 1 And mbytMode <> 0
         cbo结算方式.Visible = blnVisible
         cbo结算方式.Top = txt缴款.Top: txt本次应缴.Left = txt找补.Left: txt本次应缴.Width = txt找补.Width
       If mbytMode = 1 Then
            lblFact.Visible = False: txtFact.Visible = False
            picPayInfor.Visible = False
            lbl缴款.Visible = False: txt缴款.Visible = False
...
Private Function zlExcuteDelRegistered() As Boolean
    ...
    Dim objCard As Card, str退款操作员 As String
...
Private Function SaveRegister_预约接收(ByVal lng病人ID As Long, ByVal dtSysDate As Date, str门诊号 As String, ByVal str卡号 As String, _
    ...
    If mTy_Para.bln预约接收确定挂号费 Then  '预约接受，以新价格为准
        ...
        Next
    Else    '预约接受以预约时价格为准
        blnHaveBookFee = False  '是否存在病历费
        '55985 预约接收时,修改了费别,需要先修改预约单据对应的费用信息 再进行接收
        If Not mrsBill Is Nothing Then
            mrsBill.Sort = "序号 "
            mrsBill.MoveFirst
            If blnPrice Then
                dblTotalRegFee = GetRegistMoney(True, False)
        ...
        '性质:1-挂号费用;2-挂号从属项目;3-病历费;4-卡费;5-其他费用(药事服务费等)
        '病历费处理
        If blnHaveBookFee = False And Not mrsItems Is Nothing Then
            If blnPrice And dblTemp <> 0 And str划价NO = "" Then str划价NO = zlDatabase.GetNextNo(13)
            mrsItems.Filter = "性质 = 3"
            Do While Not mrsItems.EOF
                mrsInComes.Filter = "项目ID=" & Val(Nvl(mrsItems!项目ID))
                ...
                Call zlAddArray(cllPro, strSQL)
                If blnPrice And dblTemp <> 0 Then
                    strSQL = _
                    "zl_门诊划价记录_Insert('" & str划价NO & "'," & lng序号 & "," & lng病人ID & ",NULL," & _
                             IIf(str门诊号 = "", "NULL", str门诊号) & ",'" & NeedCode(cbo付款方式.Text) & "'," & _
                             "'" & txtPatient.Text & "','" & NeedName(cbo性别.Text) & "','" & str年龄 & "'," & _
                             "'" & str费别 & "',NULL," & mlng挂号科室ID & "," & _
                             IIf(mblnStation, mlng挂号科室ID, UserInfo.部门ID) & ",'" & UserInfo.姓名 & "'," & "NULL" & "," & _
        ...
        If Not mrsItems Is Nothing Then
            ...
            Do While Not mrsItems.EOF
                mrsInComes.Filter = "项目ID=" & Val(Nvl(mrsItems!项目ID))
                If mrsInComes.RecordCount = 0 Then
                    MsgBox "未找到其他费用,可能因并发原因造成数据提取失败，请重新提取数据!", vbInformation + vbDefaultButton1, gstrSysName
                    Exit Function
                End If
                lng序号 = lng序号 + 1
                strSQL = "Zl_病人预约挂号记录_Update("
                ...
                strSQL = strSQL & "'" & Trim(Nvl(mrsInComes!收据费目)) & "',"
                '  应收金额_In   门诊费用记录.应收金额%Type,
                strSQL = strSQL & "" & IIf(blnPrice, 0, mrsInComes!应收) & ","
                dblTemp = Val(Nvl(mrsInComes!实收))
                '  实收金额_In   门诊费用记录.实收金额%Type,
                strSQL = strSQL & "" & IIf(blnPrice, 0, mrsInComes!实收) & ","
                '  病历费_In Number, --该条记录是否病历工本费
                strSQL = strSQL & "" & IIf(mrsItems!性质 = 3, 1, IIf(mrsItems!性质 = 4, 2, 0)) & ","
                '  保险大类id_In 门诊费用记录.保险大类id%Type,
                strSQL = strSQL & "" & ZVal(Nvl(mrsItems!保险大类id, 0)) & ","
...
Private Sub SaveData(Optional blnCall结束挂号 As Boolean = False)
    ...
    Dim objICCard As Object, dbl费用金额 As Double, blnAfterRefresh As Boolean
                ...
                For j = 1 To mrsInComes.RecordCount
                    ...
                    Else
                         ...
                         "zl_病人挂号记录_INSERT(" & ZVal(lng病人ID) & "," & IIf(str门诊号 = "", "NULL", str门诊号) & ",'" & txtPatient.Text & "','" & NeedName(cbo性别.Text) & "'," & _
                                  ...
                                  ZVal(IIf(mbytMode <> 1 And k = 1, cur预交, 0)) & "," & ZVal(IIf(mbytMode <> 1 And k = 1 And Not (blnPrice And dblTotal(0) <> 0), cur现金 - cur卡费, 0)) & "," & _
                                  ZVal(IIf(mbytMode <> 1 And k = 1, cur个帐, 0)) & "," & ZVal(Nvl(mrsItems!保险大类id, 0)) & "," & _
                                  ZVal(Nvl(mrsItems!保险项目否, 0)) & "," & ZVal(Nvl(mrsInComes!统筹金额, 0)) & "," & _
                                  "'" & Me.cbo备注.Text & "'," & IIf(mbytMode = 1, 1, 0) & "," & IIf(gblnSharedInvoice, 1, 0) & ",'" & mrsItems!保险编码 & "'," & byt复诊 & "," & ZVal(lngSN) & "," & ZVal(mint社区) & "," & _
...
Private Function ReadBill(strNO As String, Optional blnGetBooking As Boolean = False) As Boolean
    ...
    If mbytInState <= 1 Then
        ...
        If mbytMode = 0 And chkCancel.Value = 0 Then
            ...
            "           a.保险项目否, a.统筹金额, a.保险编码, a.病人科室id,Nvl(a.记帐费用, 0)  As 记帐费用,Nvl(G.险类, 0)  As 险类,G.收费单" & _
        ...
        Else
            ...
            "           max(nvl(A.记帐费用,0)) as 记帐费用,Max(nvl(E.险类,0)) as  险类,max(E.收费单) as 收费单" & _
   ...
   Else
        ...
        "          0 as 记帐费用,Nvl(A.险类,0) as  险类,D.出生日期,D.户口地址,A.收费单" & _
...
chkBooking:
    ...
    txt摘要.Tag = Nvl(mrsBill!收费单)
    If txt摘要.Tag = "" And InStr(txt摘要.Text, "划价:") > 0 Then txt摘要.Tag = Replace(txt摘要.Text, "划价:", "")
    mbln包含病历费 = False
    mbln附加费 = False
    mbln主费用 = False
...
Private Function GetTotalFromMshMoney(Optional ByVal str项目名称 As String = "") As Double
    ...
    With mshMoney
        For i = 1 To .Rows - 1
            If str项目名称 = "" Or Trim(mshMoney.TextMatrix(i, 0)) = str项目名称 Then
...
Private Sub ShowRegistFromInput()
    ...
    Call ReadRegistPrice(lng项目id, bln病历, mblnAddCardItem, str费别, mrsItems, mrsInComes, lng病人ID, mintInsure, _
        txt号别.Text, mbytMode, , mobjfrmPatiInfo.mstrPriceGrade, _
    IIf(dtpAppointmentDate.Visible Or mbytMode = 2, Format(dtpAppointmentDate.Value, "yyyy-mm-dd") & " 23:59:59", ""), gCurSendCard.lng收费细目ID)
...
Private Function CheckIsPrice() As Boolean
    ...
    If mblnStation Then  '医生站相关
        If Not mblnStationPrice And cbo结算方式.Visible Then CheckIsPrice = False: Exit Function
        If mbytMode = 1 Then CheckIsPrice = False: Exit Function
        
        If mstrYBPati <> "" And txt个帐支付.Visible Then dbl个帐 = Val(txt个帐支付.Text)
        dbl缴款 = GetRegistMoney - dbl个帐 - Val(txt预交支付.Text)
        CheckIsPrice = dbl缴款 <> 0
        Exit Function
    End If
    ...
    blnPrice = fraBookingDate.Visible = False And (mshPlan.TextMatrix(mshPlan.Row, mshPlan.ColIndex("病案")) <> "")
...
Private Function ReserveRegNo(ByRef lngSN As Long, ByVal str发生时间 As String, ByVal Datsys As Date) As Boolean
    ...
    On Error GoTo errH
    If mshPlan.TextMatrix(mshPlan.Row, GetCol("序号控制")) <> "" And txt号别.Text <> "+" Then
