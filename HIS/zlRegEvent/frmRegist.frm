...
Begin VB.Form frmRegist 
   ...
   Begin MSComctlLib.ImageList imgColor 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   14
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":E167
            Key             =   "Preview"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":E381
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":E59B
            Key             =   "Add"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":EC95
            Key             =   "Del"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":F38F
            Key             =   "预约"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":FA89
            Key             =   "接收"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":10183
            Key             =   "取消"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":1087D
            Key             =   "View"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":10F77
            Key             =   "Go"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":11191
            Key             =   "Filter"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":113AB
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":115C5
            Key             =   "Quit"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":117DF
            Key             =   "RollingCurtain"
            Object.Tag             =   "RollingCurtain"
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRegist.frx":11ED9
            Key             =   "Extra"
            Object.Tag             =   "Extra"
         EndProperty
      EndProperty
...
Private Sub mnuEdit_CancelAuditing_Click()
   ...
   If MsgBox("确实要将单据[" & strNO & "]进行退号审核吗？", vbQuestion + vbYesNo + vbDefaultButton1, gstrSysName) = vbNo Then Exit Sub
...
'功能:按条件读取单据列表(过滤功能)
    ...
    If Not blnSort Then
        ...
        If tbsType.SelectedItem.Key = "挂号" Then
            ...
            '问题号:51672
              strSQL = "  " & _
                "       Select D.手机号,Decode(Nvl(Max(A.险类),0),0,Null,'√') As 医保,a.No As 单据号, f.实际票号 As 首张票据, Decode(a.号别, Null, Null, '[' || a.号别 || ']') || c.名称 As 号别, a.号序, e.名称 As 科室," & vbNewLine & _
                ...
                "       Group By a.No, f.实际票号, a.号别, c.名称, a.号序, e.名称, a.执行人, a.门诊号, a.姓名, d.就诊卡号,d.手机号, f.费别, a.发生时间,a.登记时间,Decode(A.记录状态,2,A.登记时间,Null), a.操作员姓名, a.摘要," & _
              ...
              strSQL = strSQL & "  Union All " & _
                ...
                "              Max(A.险类) as 险类,Max(F.记帐费用) as 记帐费用" & vbNewLine & _
                "       From 病人挂号记录 A, 病人信息 D, 挂号安排 B, 部门表　e, 门诊费用记录 F, 收费项目目录 C " & vbNewLine & _
                "       Where a.病人id = d.病人id(+) And a.收费单 Is Not Null And a.号别 = b.号码(+) And a.执行部门id = e.Id(+) And b.项目id = c.Id(+) And a.记录性质 = 1 " & " And (e.站点='" & gstrNodeNo & "' Or e.站点 is Null) And " & vbNewLine & _
                "             a.收费单 = f.No And F.记录性质 = 1 And f.记录状态 <> 2 " & IIf(mbytCancel = 1, " And a.记录状态 = 1 ", IIf(mbytCancel = 2, " And a.记录状态 = 2 ", "")) & strFilter & vbNewLine & _
                "       Group By a.No, f.实际票号, a.号别, c.名称, a.号序, e.名称, a.执行人, a.门诊号, a.姓名, d.就诊卡号,d.手机号, f.费别, a.发生时间,a.登记时间,Decode(A.记录状态,2,A.登记时间,Null), a.操作员姓名, a.摘要," & _
                "              Decode(a.预约, 1, a.发生时间, Null), a.病人id, a.记录状态, a.社区,a.退号审核人,a.退号审核时间,a.预约操作员 , a.收费单" & vbNewLine
                ...
                strSQL = _
                "       Select 医保, 单据号, 首张票据, 号别, 号序, 科室,医生, 病历, 门诊号, 姓名, 就诊卡号,手机号, 费别, " & vbNewLine & _
        ...
        ElseIf tbsType.SelectedItem.Key = "接收" Then
            ...
            "                 And (c.站点 = '" & gstrNodeNo & "' Or c.站点 Is Null)" & vbNewLine & _
            "           Group By a.No, a.发生时间, F.费别,a.号别, c.名称, a.号序, a.执行人, a.门诊号, a.姓名, d.身份证号,d.家庭电话, d.手机号, a.摘要, a.登记时间, a.操作员姓名,a.退号审核人,a.退号审核时间,a.记录状态,a.预约操作员 ,A.病人ID" & vbNewLine & _
