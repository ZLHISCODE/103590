...
Private Sub SelectRow(mshObject As Object, Optional ByVal BackColor As Long = &H8000000D, Optional ByVal ForeColor As Long = &H8000000E)
    Dim i As Integer
...
Private Sub UnSelectRow(mshObject As Object, Optional lngColorSave As Long = 0)
    Dim i As Integer
    Dim blnPre As Boolean
