...
Public Function ShowPara(ByVal frmMain As Object, ByVal strPrivs As String) As Boolean
    ...
    chk.Value = Val(GetSetting("ZLSOFT", "公共模块\" & App.ProductName & "\" & mfrmMain.Name, "发送时不自生成费用", "0"))
...
Private Sub cmdOK_Click()
    ...
    Call SaveSetting("ZLSOFT", "公共模块\" & App.ProductName & "\" & mfrmMain.Name, "发送时不自生成费用", chk.Value)
