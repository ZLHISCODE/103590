...
Private Sub vsf_CellButtonClick(Index As Integer, ByVal Row As Long, ByVal Col As Long)
    ...
    With vsf(0)
        If Col = .ColIndex("名称") Then
            ...
            bytRet = ShowPubSelect(Me, vsf(0), 3, "编码,1200,0,0;名称,1800,0,0;规格,900,0,0;产地,900,0,0;单位,900,0,0;单价,990,0,0", Me.Name & "\材料项目选择", "请从下表中选择一个材料项目", rsData, rs, 8790, 4500, , Val(.RowData(Row)))
