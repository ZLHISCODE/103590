...
Private Function InitCommandBar() As Boolean
    ...
    Set objControl = mobjFindKey.CommandBar.Controls.Add(xtpControlButton, conMenu_View_LocationItem, "&3.简码"): objControl.Parameter = "简码"
    
    Set cbrCustom = NewToolBar(objExtendedBar, xtpControlCustom, conMenu_View_Location, "")
    cbrCustom.Handle = txtLocation.hWnd
    txtLocation.ToolTipText = "快捷键:F3"
...
Private Function ExecuteCommand(strCommand As String, ParamArray varParam() As Variant) As Boolean
    ...
    Case "前一条"
        If vsf(0).Row > 1 Then
            ...
            vsf(0).ShowCell vsf(0).Row, vsf(0).Col
            Call ExecuteCommand("读取基本资料", "刷新方案内容")
        End If
    '------------------------------------------------------------------------------------------------------------------
    Case "后一条"
