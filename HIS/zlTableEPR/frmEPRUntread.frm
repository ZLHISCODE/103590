...
Public Function ShowMe(ByVal lngID As Long, _
    ...
    ByRef lngSignKey As Long) As Boolean
    ...
    gstrSQL = "Select 0 As Id, -null As 对象标记, 1 As 版本, '新增编辑' As 操作, l.创建人 As 人员," & _
        "        To_Char(l.创建时间, 'yyyy-mm-dd hh24:mi:ss') As 时间" & _
        " From 电子病历记录 l" & _
        " Where L.ID = [1]" & _
        " Union All" & _
        ...
        "        c.内容文本 As 人员, Rtrim(Substr(c.对象属性, Instr(c.对象属性, ';', 1, 4) + 1)) As 时间" & _
        ...
        "        To_Char(l.保存时间, 'yyyy-mm-dd hh24:mi:ss') As 时间" & _
        " From 电子病历记录 l," & _
