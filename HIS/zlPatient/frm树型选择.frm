...
Public Function ShowTree(ByVal strSQL As String, str上级ID As String, str上级名称 As String, str上级编码 As String, strID As String, ByVal strCaption As String, _
    ByVal strRoot As String, Optional blnRoot As Boolean = True, Optional str原编码 As String) As Boolean
...
'返回:有所选择返回True,否则返回False.
    ...
    rs树型.Open strSQL, gcnOracle, adOpenStatic, adLockReadOnly
    rs树型.ActiveConnection = Nothing
    Call SQLTest
