...
Private Sub txt_KeyPress(Index As Integer, KeyAscii As Integer)
    ...
    Else
        ...
        If gclsBase.FilterKeyAscii(KeyAscii, 99, "0123456789") = 0 Then KeyAscii = 0
...
Private Sub txt_MouseDown(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Button = 2 And txt(Index).Locked Then
        Call gclsBase.SetNewWindowLong(txt(Index).hWnd, AddressOf WndMessage)
    End If
End Sub

Private Sub txt_MouseUp(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Button = 2 And txt(Index).Locked Then
        Call gclsBase.RestoreWindowLong(txt(Index).hWnd)
    End If
End Sub

Private Sub txt_Validate(Index As Integer, Cancel As Boolean)
    Cancel = Not gclsBase.StrIsValid(txt(Index).Text, txt(Index).MaxLength)
