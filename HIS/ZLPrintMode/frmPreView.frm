...
Private Sub Form_Load()
    ...
    If gintOri = Val("2-横向") And gintSize >= Val("256-自定义大小") Then
        If gsngSaveHeight <> gsngScaleHeight Then
            '转换高与宽
            picDraw(1).Width = gsngScaleHeight
            picDraw(1).Height = gsngScaleWidth
            picDraw(1).ScaleWidth = gsngScaleHeight
            picDraw(1).ScaleHeight = gsngScaleWidth
        Else
            GoTo makGeneral
        End If
    Else
makGeneral:
        ...
        picDraw(1).ScaleHeight = gsngScaleHeight
    End If
    gsngSaveHeight = Val(picDraw(1).Height)
