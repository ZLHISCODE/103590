...
Begin VB.Form frmPlaying 
   ...
   Begin VB.PictureBox picControl 
      ...
      Top             =   6375
      Width           =   12855
      Begin zl9PACSWork.ImageButton imbSound 
         Height          =   330
         Left            =   4680
         TabIndex        =   17
         Top             =   470
         ...
         Hwnd            =   2625092
      End
      Begin zl9PACSWork.ZLScrollBar scbSound 
         Height          =   195
         Left            =   5040
         TabIndex        =   16
         Top             =   520
      ...
      End
      Begin zl9PACSWork.ImageButton imbCapture 
         Height          =   720
         Left            =   3720
         TabIndex        =   15
         Top             =   240
      ...
      Begin MSComDlg.CommonDialog comDialog 
         ...
         _Version        =   393216
      End
      Begin zl9PACSWork.ImageButton imbFullScreen 
         Height          =   480
         Left            =   3240
         TabIndex        =   10
         Top             =   360
         ...
         Hint            =   "全屏"
      End
      Begin zl9PACSWork.ImageButton imbFirst 
         Height          =   480
         Left            =   1320
         TabIndex        =   8
         ToolTipText     =   "第一帧"
         ...
         Hint            =   "第一帧"
      End
      Begin zl9PACSWork.ImageButton imbLast 
         Height          =   480
         Left            =   1800
         TabIndex        =   7
         ToolTipText     =   "上一帧"
         ...
         Hint            =   "上一帧"
      End
      Begin zl9PACSWork.ImageButton imbEnd 
         Height          =   480
         Left            =   2760
         TabIndex        =   6
         ToolTipText     =   "最后帧"
         ...
         Hint            =   "最后帧"
      End
      Begin zl9PACSWork.ImageButton imbNext 
         Height          =   480
         Left            =   2280
         TabIndex        =   5
         ToolTipText     =   "下一帧"
         ...
         Hint            =   "下一帧"
      End
      Begin zl9PACSWork.ImageButton imbStop 
         Height          =   480
         Left            =   840
         TabIndex        =   4
         ToolTipText     =   "停止"
         ...
         Hint            =   "停止"
      End
      Begin zl9PACSWork.ImageButton imbPlay 
         Height          =   705
         Left            =   120
         TabIndex        =   3
         ToolTipText     =   "播放/暂停"
         ...
         Hint            =   "播放"
      End
      Begin zl9PACSWork.ImageButton imbPause 
         Height          =   720
         Left            =   120
         TabIndex        =   13
         Top             =   240
         ...
         Hint            =   "暂停"
      End
      Begin zl9PACSWork.ImageButton imbNoSound 
         Height          =   330
         Left            =   4680
         TabIndex        =   18
         Top             =   480
   ...
   Begin VB.PictureBox picInf 
      ...
      Top             =   5760
      Width           =   12855
      Begin zl9PACSWork.ZLScrollBar scbState 
         Height          =   200
         Left            =   0
         TabIndex        =   12
         Top             =   375
...
Private Sub LoadParameterConfig()
    ...
    '保存注册表参数
    strRegPath = "公共模块\" & App.ProductName & "\frmPlaying"
      
    '播放时自动隐藏
    播放时自动隐藏.Checked = GetSetting("ZLSOFT", strRegPath, "播放时自动隐藏", True)
    '控制栏
    控制栏.Checked = GetSetting("ZLSOFT", strRegPath, "控制栏", True)
    '信息栏
    信息栏.Checked = GetSetting("ZLSOFT", strRegPath, "信息栏", True)
    ...
    '按比例缩放
    按比例缩放.Checked = GetSetting("ZLSOFT", strRegPath, "按比例缩放", True)
    If 按比例缩放.Checked Then DSPlayer.ShowModel = smFit
    '视频拉伸
    视频拉伸.Checked = GetSetting("ZLSOFT", strRegPath, "视频拉伸", False)
    If 视频拉伸.Checked Then DSPlayer.ShowModel = smStretch
    '实际大小
    实际大小.Checked = GetSetting("ZLSOFT", strRegPath, "实际大小", False)
    If 实际大小.Checked Then DSPlayer.ShowModel = smNormal
    
    
    'VMR
    VMR.Checked = GetSetting("ZLSOFT", strRegPath, "VMR", True)
    If VMR.Checked Then DSPlayer.SnatchWay = swVMR
    'DEVICE
    DEVICE.Checked = GetSetting("ZLSOFT", strRegPath, "DEVICE", False)
    ...
    If Trim(strPlayFile) <> "" Then
        If Trim(Dir(strPlayFile)) <> "" Then
            ...
            If Trim(sErrMsg) <> "" Then
                Call MsgBox(sErrMsg, vbOKOnly, Me.Caption)
                Exit Sub
            End If
...
Private Sub SaveParameterConfig()
  ...
  '播放时自动隐藏
  SaveSetting "ZLSOFT", strRegPath, "播放时自动隐藏", 播放时自动隐藏.Checked
  '控制栏
  SaveSetting "ZLSOFT", strRegPath, "控制栏", 控制栏.Checked
  '信息栏
  SaveSetting "ZLSOFT", strRegPath, "信息栏", 信息栏.Checked
  
  
  '按比例缩放
  SaveSetting "ZLSOFT", strRegPath, "按比例缩放", 按比例缩放.Checked
  '视频拉伸
  SaveSetting "ZLSOFT", strRegPath, "视频拉伸", 视频拉伸.Checked
  '实际大小
  SaveSetting "ZLSOFT", strRegPath, "实际大小", 实际大小.Checked

  
  'VMR
  SaveSetting "ZLSOFT", strRegPath, "VMR", VMR.Checked
  'DEVICE
  SaveSetting "ZLSOFT", strRegPath, "DEVICE", DEVICE.Checked
...
Private Sub VideoSaveAs()
    ...
    If Trim(DSPlayer.VideoFile) = "" Then
        MsgBox "没有可另存的视频文件。", vbOKOnly Or vbInformation, Me.Caption
        Exit Sub
    End If
