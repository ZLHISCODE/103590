...
Public Function ShowMsgBox(ByVal strInfo As String, Optional ByVal frmParent As Object, Optional ByVal blnNoAsk As Boolean, Optional ByVal intType As Integer) As VbMsgBoxResult
