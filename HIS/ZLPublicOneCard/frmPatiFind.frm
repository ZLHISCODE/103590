...
Private Sub Form_Load()
    Dim objOneDataObject As clsOneCardDataObject
    Dim blnShowCard  As Boolean
    Dim objCard As Card
    
    If zlGetOneCardDataObject(gcnOracle, objOneDataObject) Then
        If objOneDataObject.zlGetCardFromCardTypeID("就诊卡", False, objCard) Then
            blnShowCard = objCard.卡号密文规则 = ""
        End If
    End If
