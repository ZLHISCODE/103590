...
'参数：lngID=病人ID,x=控件索引,0=源病人,1=目标病人
    ...
    Set rsTmp = mobjDataBase.OpenSQLRecord(strSQL, Me.Caption, lngID)
...
Private Sub cmdMerge_Click()
    ...
    Set rsTmp = mobjDataBase.OpenSQLRecord(strSQL, Me.Caption, Val(fra(0).Tag), Val(fra(1).Tag))
...
Private Function GetPatiInfo(lng病人ID As Long) As ADODB.Recordset
    ...
    Set rsTmp = mobjDataBase.OpenSQLRecord(strSQL, Me.Caption, lng病人ID)
