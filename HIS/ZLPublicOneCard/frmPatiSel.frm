...
'参数：strIF=" And ...."形式的过滤条件
    ...
    If Not blnSort Then
        ...
        '就诊卡号显示
        strCard = "Decode(" & IIf(mblnShowCard, 1, 0) & ",1,A.就诊卡号,LPAD('*',Length(A.就诊卡号),'*')) as 就诊卡,"
        ...
        With SQLCondition
            Set mrsPati = mobjDataBase.OpenSQLRecord(strSQL, Me.Caption, lngUnitID, mstrUnitIDs, .登记时间B, .登记时间E, .出生时间B, .出生时间E, _
