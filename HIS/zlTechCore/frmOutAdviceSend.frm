...
Begin VB.Form frmOutAdviceSend 
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel5 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            Object.Width           =   617
            MinWidth        =   617
            Picture         =   "frmOutAdviceSend.frx":0E1E
            Key             =   "PY"
         ...
         BeginProperty Panel6 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   617
            MinWidth        =   617
            Picture         =   "frmOutAdviceSend.frx":1458
            Key             =   "WB"
   ...
   Begin VSFlex8Ctl.VSFlexGrid vsAdvice 
      ...
      FormatString    =   $"frmOutAdviceSend.frx":1A92
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
      ...
      Begin MSComctlLib.ImageList img16 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmOutAdviceSend.frx":1B2D
               Key             =   "T"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmOutAdviceSend.frx":20C7
               Key             =   "F"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmOutAdviceSend.frx":2661
               Key             =   "签名"
            EndProperty
         EndProperty
      End
   ...
   Begin MSComctlLib.ImageList imgColor 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   5
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOutAdviceSend.frx":29B3
            Key             =   "全选"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOutAdviceSend.frx":2BCD
            Key             =   "全清"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOutAdviceSend.frx":2DE7
            Key             =   "发送"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOutAdviceSend.frx":3001
            Key             =   "帮助"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOutAdviceSend.frx":321B
            Key             =   "退出"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgGray 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   5
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOutAdviceSend.frx":3435
            Key             =   "全选"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOutAdviceSend.frx":364F
            Key             =   "全清"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOutAdviceSend.frx":3869
            Key             =   "发送"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOutAdviceSend.frx":3A83
            Key             =   "帮助"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOutAdviceSend.frx":3C9D
            Key             =   "退出"
         EndProperty
      EndProperty
   End
...
Private Const COL_计价特性 = 21
Private Const COL_执行性质ID = 22
Private Const COL_执行科室ID = 23
Private Const COL_药品ID = 24
Private Const COL_剂量系数 = 25
Private Const COL_门诊包装 = 26
Private Const COL_门诊单位 = 27
Private Const COL_可否分零 = 28
Private Const COL_库存 = 29
Private Const COL_次数 = 30
Private Const COL_分解时间 = 31
Private Const COL_首次时间 = 32
Private Const COL_末次时间 = 33
Private Const COL_前提ID = 34
Private Const COL_签名ID = 35
...
Public Function ShowMe(frmParent As Object, ByVal strPrivs As String, ByVal lng病人ID As Long, ByVal str挂号单 As String, _
    ByVal lng前提ID As Long, Optional ByVal blnAuto As Boolean) As Boolean
'功能：发送医嘱
    ...
    '取挂号ID(就诊次数)
    mlng挂号ID = 0: mlng科室ID = 0
    strSQL = "Select ID,执行部门ID From 病人挂号记录 Where NO=[1]"
    Set rsTmp = zlDatabase.OpenSQLRecord(strSQL, "ShowMe", mstr挂号单)
    If Not rsTmp.EOF Then
        mlng挂号ID = rsTmp!ID
        mlng科室ID = rsTmp!执行部门ID
    End If
...
Private Sub Form_Activate()
    If mblnFirst Then
        ...
        '自动开始发送:固定单据类型时
        If mblnAuto Then
            If mint发送类型 = 2 Then mblnAuto = False
        End If
        If mblnAuto Then
            mblnUnLoad = True
            If mint发送类型 = 0 Then
...
'功能：读取病人信息
    ...
    strSQL = "Select A.姓名,A.性别,A.年龄,A.门诊号,A.费别,A.险类," & _
        " Decode(C.编码,'1',1,0) as 医保,A.担保额,Nvl(B.预交余额,0)-Nvl(B.费用余额,0) as 剩余款" & _
        " From 病人信息 A,(" & strSQL & ") B,医疗付款方式 C" & _
        " Where A.病人ID=B.病人ID(+) And A.医疗付款方式=C.名称(+) And A.病人ID=[1]"
...
Private Sub Form_Load()
    ...
    mbln记帐划价 = Val(GetSetting("ZLSOFT", "公共模块\" & App.ProductName, "发送为记帐划价单", 0)) <> 0
    ...
    mintSendNo = 0
    If mlng前提ID = 0 Then
        mintSendNo = Val(GetSetting("ZLSOFT", "公共模块\" & App.ProductName, "发送单据号规则", 0)) '0-多个,1-单个
    End If
    
    '发送选项:0-发送为收费单,1-发送为记帐单,2-手工选择
    mint发送类型 = Val(GetSetting("ZLSOFT", "私有模块\" & gstrDBUser & "\" & App.ProductName, "发送单据类型", 2))
    If mint发送类型 = 0 Then
    ...
    '各个库房药品出库检查方式
    Set mcolStock = InitStockCheck(1, True)
    
    '读取动态费别,发送关闭后清除
    gstr动态费别 = Load动态费别(mlng科室ID)
...
Private Sub ShowPatiMoney()
    ...
    '显示病人预交余额
    Set rsTmp = GetMoneyInfo(mlng病人ID)
    If Not rsTmp Is Nothing Then
        If Nvl(rsTmp!预交余额, 0) - Nvl(rsTmp!费用余额, 0) <> 0 Then
            stbThis.Panels(3).Text = "预交:" & Format(Nvl(rsTmp!预交余额, 0) - Nvl(rsTmp!费用余额, 0), "0.00")
...
Private Sub Form_Resize()
    ...
    If Me.ScaleWidth - tbrSys.Left - chk加班加价.Width - 100 < 4500 Then
        chk加班加价.Left = 4500
    Else
...
Private Sub tbrMain_ButtonClick(ByVal Button As MSComctlLib.Button)
    Dim bln中医 As Boolean, blnDiagnose As Boolean
    ...
    '检查病人门诊诊断是否输入:任何诊断来源
    If blnDiagnose Then
        If mlng前提ID = 0 And Val(GetSetting("ZLSOFT", "公共模块\" & App.ProductName, "要求输入门诊诊断", 0)) <> 0 Then
            bln中医 = Have部门性质(mlng科室ID, "中医科")
            If Not ExistsDiagNoses(mlng病人ID, mlng挂号ID, IIF(bln中医, "1,11", "1")) Then
                If InStr(";" & mstrPrivs & ";", ";门诊首页;") > 0 Then
                    MsgBox "病人的诊断信息还没有输入，您需要先输入病人的诊断信息。" & vbCrLf & vbCrLf & "请按 [确定] 进入诊断输入界面。", vbInformation, gstrSysName
                    blnDiagnose = True
                    If Not frmOutMedRecEdit.ShowMe(Me, mstr挂号单, blnDiagnose) Then
                        Exit Sub
                    ElseIf Not blnDiagnose Then
                        Exit Sub
                    End If
                Else
                    MsgBox "病人的诊断信息还没有输入，您需要先输入病人的诊断信息。", vbInformation, gstrSysName
                    Exit Sub
                End If
            End If
        End If
    ...
    If Button.Key = "发送为收费单" Then
        ...
        bln记帐 = False
        strMsg = "本次医嘱发送的费用将产生为收费单据，确实要发送已选择的医嘱吗？"
    ElseIf Button.Key = "发送为记帐单" Then
        bln记帐 = True
        strMsg = "本次医嘱发送的费用将产生为记帐单据，确实要发送已选择的医嘱吗？"
    End If
    If strMsg <> "" Then
    ...
    If lng发送号 <> 0 Then
        mblnSend = True
        '打印诊疗单据
        Call frmSendBillPrint.ShowMe(lng发送号, 1, Me, mlng前提ID)
...
'功能：初始化清单格式
    ...
    strHead = ",300,4;" & _
        ...
        "ID;相关ID;病人科室ID;开嘱科室ID;开嘱医生;诊疗类别;诊疗项目ID;计价特性;执行性质ID;执行科室ID;" & _
        "药品ID;剂量系数;门诊包装;门诊单位;可否分零;库存;次数;分解时间;首次时间;末次时间;前提ID;签名ID"
...
Private Sub InitRecordSet(rsSQL As ADODB.Recordset, rsTotal As ADODB.Recordset)
'初始化记录集
    'SQL记录集
        ...
        Else
            ...
            If Nvl(rsSend!计价特性, 0) = 0 And InStr(",0,5,", Nvl(rsSend!执行性质, 0)) = 0 Then
                ...
                strSQL = _
                    ...
                    " Nvl(A.从属项目,0) as 从项,D.跟踪在用,[2] as 执行科室ID,C.屏蔽费别" & _
                ...
                Do While True
                    ...
                    '计算单价和实收
                    If Not IsNull(rsTmp!单价) Then '固定价格
        ...
        If strSQL <> "" Then
            ...
            For i = 1 To rsTmp.RecordCount
                ...
                If InStr(",5,6,7,", rsTmp!类别) > 0 Then
                    ...
                    End If
                    If InStr(",5,6,7,", vsAdvice.TextMatrix(rsTmp!行号, COL_诊疗类别)) > 0 Then
                        dbl当前单价 = Format(dbl当前单价 * Nvl(rsTmp!门诊包装, 1), "0.00000")
...
Private Function GetNoneSendID() As String
'功能：获取因为皮试过敏(阳性(+))或无皮试结果而不发送的医嘱ID
    Dim rsTmp As New ADODB.Recordset
    Dim strSQL As String, i As Long
    Dim str用法IDs As String
    
    If Not mbln自动皮试 Then Exit Function
    
    On Error GoTo errH
    
    '读取皮试过敏(阳性(+))或无皮试结果(未发送或已发送)的医嘱皮试项目ID
    '不包括已作废的皮试医嘱或未发送的标记为免试的皮试医嘱
    strSQL = "Select B.ID From 病人医嘱记录 A,诊疗项目目录 B" & _
        " Where A.诊疗项目ID=B.ID And A.诊疗类别='E' And B.操作类型='1'" & _
        " And A.医嘱状态<>4 And (A.皮试结果='(+)' Or A.皮试结果 is NULL)" & _
    ...
    strSQL = "Select A.相关ID From 病人医嘱记录 A,诊疗用法用量 B" & _
        " Where A.诊疗类别 IN('5','6') And A.医嘱状态=1" & _
        " And A.诊疗项目ID=B.项目ID And B.性质=0 And Instr([3],','||B.用法ID||',')>0" & _
        " And A.病人ID+0=[1] And A.挂号单=[2]"

    '读取药品医嘱及给药途径的医嘱ID(包括一并给药)
    strSQL = "Select ID From 病人医嘱记录" & _
        " Where 诊疗类别 IN('5','6','E') And Nvl(相关ID,ID) IN(" & strSQL & ")" & _
        " And 病人ID+0=[1] And 挂号单=[2]"
    Set rsTmp = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, mlng病人ID, mstr挂号单, "," & str用法IDs & ",")
    strSQL = ""
    Do While Not rsTmp.EOF
...
'   COL_金额：原始的金额而不是累计显示的
    ...
    Dim i As Long, j As Long, strNoneIDs As String
    Dim str用法 As String
        
    Screen.MousePointer = 11
    
    stbThis.Panels(4).Text = "": Call Form_Resize
    ...
    strNoneIDs = GetNoneSendID
    
    '获取发送清单:每条医嘱记录(药品和非药品)
    '----------------------------------------------------------------------------------------------------------
    '叮嘱(手术,检查,检验不允许为叮嘱)，护理等级和免试皮试不发送,但这里先读取叮嘱(给药途径,用法,煎法,采集方法)
    strSQL = _
        ...
        " A.医嘱内容,A.标本部位,A.天数,A.总给予量,D.门诊单位,A.单次用量,B.计算单位,D.剂量系数,D.门诊包装," & _
        " A.开始执行时间,A.执行频次,A.频率次数,A.频率间隔,A.间隔单位,A.医生嘱托,A.执行时间方案," & _
        " A.病人科室ID,A.开嘱科室ID,A.开嘱医生,A.计价特性,A.执行性质,A.执行科室ID,E.名称 as 执行科室," & _
        " D.可否分零,D.药房分批,C.是否变价,C.撤档时间,C.服务对象,A.前提ID,S.签名ID" & _
        " From 病人医嘱记录 A,诊疗项目目录 B,收费项目目录 C,药品规格 D,部门表 E,诊疗项目类别 F,病人医嘱状态 S,病人医嘱记录 X" & _
        " Where A.病人ID+0=[1] And A.挂号单=[2] And Nvl(A.前提ID,0)=[4] And A.ID=S.医嘱ID And S.操作类型=1" & _
        " And A.医嘱状态=1 And A.医嘱期效=1 And A.相关ID=X.ID(+) And B.类别=F.编码" & _
        " And A.诊疗项目ID=B.ID And A.收费细目ID=C.ID(+) And A.收费细目ID=D.药品ID(+)" & _
        " And A.执行科室ID=E.ID(+) And Not (A.诊疗类别='H' And B.操作类型='1')" & _
        IIF(strNoneIDs <> "", " And Instr([3],','||A.ID||',')=0", "") & _
        " And Nvl(A.皮试结果,'无')<>'免试' And A.开始执行时间 is Not NULL And A.病人来源<>3" & _
        " Order by A.婴儿,组号,组ID,A.序号"
    
    On Error GoTo errH
    Set rsSend = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, mlng病人ID, mstr挂号单, "," & strNoneIDs & ",", mlng前提ID)
        ...
        With vsAdvice
            ...
            For i = 1 To rsSend.RecordCount
                ...
                If InStr(",5,6,7", rsSend!诊疗类别) > 0 Then
                    ...
                    .TextMatrix(lngRow, COL_库存) = GetStock(rsSend!药品ID, Nvl(rsSend!执行科室ID, 0), 1) '按门诊包装
                End If
...
'返回：根据提示，是否对选择状态进行了处理
    ...
    With vsAdvice
        ...
        If int库存检查 <> 0 Or bln分批 Or bln时价 Then
            strTmp = .TextMatrix(lngRow, COL_门诊单位) '用于提示
...
Private Function GetRXKey(ByVal strKey As String, ByVal intNextCount As Integer) As String
'功能：返回药品处方条数限制关键字,用于处方NO分配
'参数：strKey=当前处方NO的Key,不包含处方条数限制Key部份
'      intNextCount=当前药品(一并)的条数,一并给药开始行或独立药品行才传入,一并给药中间行传入0
    mrsRXKey.Filter = "Key='" & strKey & "'"
    If mrsRXKey.EOF Then
        mrsRXKey.AddNew
        mrsRXKey!Key = strKey
        mrsRXKey!条数 = intNextCount
        mrsRXKey!张数 = 1
        mrsRXKey.Update
    ElseIf intNextCount > 0 Then '一并给药中间行,保持第一行的关键字
        mrsRXKey!条数 = mrsRXKey!条数 + intNextCount
        mrsRXKey.Update
    
        If mrsRXKey!条数 > gintRXCount Then
            mrsRXKey!张数 = mrsRXKey!张数 + 1
            mrsRXKey!条数 = intNextCount
            mrsRXKey.Update
        End If
    End If

    GetRXKey = mrsRXKey!张数
End Function
...
'返回：如果成功则返回发送号
    ...
    Dim cur医嘱合计 As Currency, str费别 As String
    ...
    Call InitBillSet
    Call InitRecordSet(rsSQL, rsTotal)
    ...
    With vsAdvice
        For i = .FixedRows To .Rows - 1
            If .Cell(flexcpData, i, COL_选择) = 0 And Not .Cell(flexcpPicture, i, COL_选择) Is Nothing Then
                    ...
                    If InStr(",5,6,", .TextMatrix(i, COL_诊疗类别)) > 0 Then
                        ...
                        If gintRXCount > 0 Then
                            ...
                            If Val(.TextMatrix(i, COL_相关ID)) <> Val(.TextMatrix(i - 1, COL_相关ID)) Then
                                j = GetMergeCount(i) '一并给药开始行或独立药品行才取值>=1
                            End If
                            strNOKey = strNOKey & "_" & GetRXKey(strNOKey, j)
                        End If
                    ElseIf .TextMatrix(i, COL_诊疗类别) = "M" Then
                ...
                If InStr(",5,6,7,", .TextMatrix(i, COL_诊疗类别)) > 0 Then
                    ...
                    If Val(.TextMatrix(i, COL_执行性质ID)) <> 5 Then
                        strSQL = _
                            ...
                            " C.收据费目,1 as 数量,B.现价 as 单价,[2] as 执行科室ID,0 as 从项" & _
                ...
                Else
                    ...
                    If strSQL <> "" Then
                        strSQL = _
                            ...
                            " A.屏蔽费别,A.加班加价,B.加班加价率,B.附术收费率,Y.门诊单位,Y.门诊包装,Y.剂量系数," & _
                            " Decode(A.类别,'4',E.在用分批,Y.药房分批) as 分批,E.跟踪在用,B.收入项目ID," & _
                            " C.收据费目,X.数量,Decode(A.是否变价,1,X.单价,B.现价) as 单价,X.执行科室ID,X.从项" & _
                ...
                If strSQL <> "" Then
                    Set rsMoney = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, Val(.TextMatrix(i, COL_药品ID)), Val(.TextMatrix(i, COL_执行科室ID)))
                    ...
                    For j = 1 To rsMoney.RecordCount
                        ...
                        If rsMoney!类别 = "4" And Nvl(rsMoney!跟踪在用, 0) = 1 _
                            ...
                            lng执行科室ID = Get收费执行科室ID(mlng病人ID, 0, rsMoney!类别, rsMoney!ID, 4, lng病人科室ID, 0, 1, lng执行科室ID)
                        End If
                        ...
                        If Not bln记帐 Then
                            ...
                            rsSQL!SQL = "ZL_门诊划价记录_INSERT(" & _
                                ...
                                ZVal(Nvl(mrsPati!门诊号, 0)) & ",NULL,'" & mrsPati!姓名 & "'," & _
                                "'" & Nvl(mrsPati!性别) & "','" & Nvl(mrsPati!年龄) & "'," & _
                                "'" & str费别 & "',NULL," & ZVal(.TextMatrix(i, COL_开嘱科室ID)) & "," & _
                                ...
                                IIF(bln离院带药, 3, Val(.TextMatrix(i, COL_计价特性))) & ")"
                        Else
                            '是否划价费用
                            If mbln记帐划价 Then
                                int划价 = 1
                            ...
                            rsSQL!SQL = "ZL_门诊记帐记录_INSERT(" & _
                                ...
                                ZVal(Nvl(mrsPati!门诊号, 0)) & ",'" & mrsPati!姓名 & "'," & _
                                "'" & Nvl(mrsPati!性别) & "','" & Nvl(mrsPati!年龄) & "'," & _
                                ...
                                "'" & UserInfo.姓名 & "'," & IIF(rsMoney!类别 = "4", lng卫材类别ID, lng药品类别ID) & "," & _
                                "NULL,'" & .TextMatrix(i, COL_医嘱内容) & "'," & Val(.TextMatrix(i, COL_ID)) & "," & _
                                "'" & .TextMatrix(i, COL_频率) & "'," & ZVal(.TextMatrix(i, COL_单量)) & "," & _
                                "'" & .TextMatrix(i, COL_用法) & "',1," & IIF(bln离院带药, 3, Val(.TextMatrix(i, COL_计价特性))) & ")"
                        End If
                        rsSQL.Update
                ...
                If gbln从项汇总折扣 And blnHaveSub And var父索引 <> Empty And lng父收入ID <> 0 Then
                    ...
                    str费别 = Nvl(mrsPati!费别) & IIF(gstr动态费别 <> "" And Not bln记帐, "," & gstr动态费别, "")
                    cur实收 = Format(ActualMoney(str费别, lng父收入ID, cur医嘱合计), gstrDec)
                    If InStr(str费别, ",") > 0 Then str费别 = Nvl(mrsPati!费别)
...
NextAdvice:
        ...
        '自动进行电子签名(未签名部份)
        '-----------------------------------------------------------------------------------------
        If Not gobjESign Is Nothing And Mid(gstrESign, 1, 1) = "1" And str医嘱IDs <> "" Then
            str医嘱IDs = Mid(str医嘱IDs, 2) '这里是组ID,返回为明细的ID
            intRule = ReadAdviceSignSource(1, mlng病人ID, mstr挂号单, str医嘱IDs, 0, False, strSource, mlng前提ID)
            ...
            rsSQL.AddNew
            rsSQL!类型 = 3: rsSQL!医嘱ID = 0: rsSQL!项目ID = 0: rsSQL!序号 = 0
        ...
        '提交病人数据
        '-----------------------------------------------------------------------------------------
        If Not CompletePatiSend(bln记帐, rsSQL, cur合计, str类别, str类别名称, strWarn, intWarn, blnTran) Then GoTo errH
    End With
    SendAdvice = lng发送号
FuncEnd:
    '删除所有已成功发送的行
...
'说明：如果出错,则在调用函数中处理,blnTran返回是否启用了事务
    ...
    Dim arrNOs() As String
    
    '病人费用报警
    If bln记帐 And cur合计 > 0 Then
        strSQL = "Select Nvl(适用病人,1) as 适用病人,Nvl(报警方法,1) as 报警方法," & _
            " 报警值,报警标志1,报警标志2,报警标志3 From 记帐报警线" & _
            " Where Nvl(病区ID,0)=0 And Nvl(适用病人,1)=[1]"
        Set rsWarn = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, IIF(Nvl(mrsPati!医保, 0) = 1, 2, 1))
