Attribute VB_Name = "mdlMspClientShell"
Option Explicit
...
Public Sub PlayWave(ByVal lngKey As Long)
    ...
    strFile = App.Path & "\Data\zlMspClientWave_" & lngKey & ".wav"
...
Public Function CommandBarInit(ByRef cbsMain As CommandBars) As Boolean
    ...
    Set cbsMain.Icons = frmMspResource.imgMenu.Icons
