...
Begin VB.Form frmPathAppendOut 
   ...
   ClientTop       =   375
   ClientWidth     =   11925
   Icon            =   "frmPathAppendOut.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.PictureBox picIcon 
      ...
      Height          =   330
      Left            =   11400
      MouseIcon       =   "frmPathAppendOut.frx":1708A
   ...
   Begin VB.Frame fraVariation 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsVariation 
         ...
         FormatString    =   $"frmPathAppendOut.frx":171DC
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   1
   ...
   Begin VB.Frame fraExecute 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsResult 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"frmPathAppendOut.frx":17241
         ScrollTrack     =   -1  'True
         ScrollBars      =   2
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.Image Image1 
         Height          =   720
         Left            =   120
         Picture         =   "frmPathAppendOut.frx":172BF
         Top             =   120
         Width           =   720
      End
      Begin VB.Label lblExePrompt 
         Caption         =   $"frmPathAppendOut.frx":17ABD
         Height          =   1335
         Left            =   960
         TabIndex        =   28
         Top             =   90
   ...
   Begin VB.PictureBox picInfo 
      ...
      Begin VB.Image imgInfo 
         Height          =   720
         Left            =   195
         Picture         =   "frmPathAppendOut.frx":17B5F
         Top             =   45
         Width           =   720
      End
   ...
   Begin MSComctlLib.ImageList imgNature 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPathAppendOut.frx":196A1
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPathAppendOut.frx":19C3B
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPathAppendOut.frx":1A1D5
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPathAppendOut.frx":1A76F
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPathAppendOut.frx":1AD09
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPathAppendOut.frx":1B2A3
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPathAppendOut.frx":1B83D
            Key             =   "Selected"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPathAppendOut.frx":1BBD7
            Key             =   "UnSelected"
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Frame fraEPR 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsEPR 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"frmPathAppendOut.frx":1BF71
         ScrollTrack     =   -1  'True
         ScrollBars      =   2
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmPathAppendOut"
...
Public Function ShowMe(frmParent As Object, t_pati As TYPE_Pati, t_pp As TYPE_PATH_Pati, _
...
'功能：加载路径分类
    ...
    For i = 1 To rsTmp.RecordCount
        ...
        If rsTmp!名称 = mstrItemType Then
            cboItemType.ListIndex = cboItemType.NewIndex
        End If
        rsTmp.MoveNext
    Next
    If cboItemType.ListIndex = -1 And cboItemType.ListCount > 0 Then
...
'功能：读取路径外项目的相关信息
    ...
    strSql = "Select a.分类,a.项目内容,a.项目结果,a.添加原因,a.图标ID,a.变异原因,b.病人医嘱ID " & vbNewLine & _
            " From 病人门诊路径执行 A,病人门诊路径医嘱 B Where a.ID = [1] And a.id = b.路径执行id(+)"
    On Error GoTo errH
    ...
    If mlngFun = 0 Then
        ...
        Else
            If mvItem.医嘱IDs <> "" Then
                ...
                mlng阶段ID = 0
                mlng天数 = 0
                If cboItems.Tag <> mPP.当前阶段ID & "_" & mPP.当前天数 Then
                    Call LoadCurrentItems
                End If
            End If
        End If
...
'参数:bln评估结果 -是否修改评估结果
    ...
    If mlngFun = 1 Or mlngFun = 2 Then
        ...
        strSql = "Zl_病人门诊路径生成_Update(" & mlng执行ID & ",'" & cboItemType.Text & "','" & mvItem.项目内容 & _
                 "','" & mvItem.项目结果 & "'," & ZVal(mvItem.图标ID) & ",'" & txtReason.Text & "','" & mvItem.变异原因 & _
        ...
        If mlngFun = 1 And mdatPathOut <> "0:00:00" And mdatPathOut < mPP.当前日期 Then
            ...
            If rsTmp.RecordCount = 1 Then
                ...
                strSql = "Zl_病人门诊路径评估_Insert(" & 2 & "," & mPP.病人路径ID & "," & rsTmp!阶段ID & _
        ...
        If mvItem.病历IDs <> "" Then
            For i = 0 To UBound(arrFile)
                ...
                If arrItem(1) = 0 Or arrItem(1) = 1 Then     '全文编辑方式的病历
                    ...
                    Call SaveRTFData(lng病历ID, mPati.病人ID, mPati.挂号ID, 0, edtEditor, 1)  '暂不支持选择指定婴儿的病历
                End If
            Next
        End If
...
'功能：编辑项目所对应的医嘱
    ...
    Call gobjKernel.ShowOutAdviceEdit(mfrmParent, 0, 2, mPati.病人ID, mPati.挂号NO, mvItem.医嘱IDs, CDate(mPP.当前日期), arrSQL, strAdviceOfItem)
        ...
        If Col = 0 Then
            ...
            Else
                ...
                If optEPRType(0).Value Then
                    strSql = " Select A.ID,Decode(A.种类,1,'门诊病历',5,'疾病证明报告',6,'知情文件') as 种类," & _
                             " A.编号,A.名称,A.说明,A.保留 as 编辑方式 From 病历文件列表 A" & _
                             " Where A.种类 IN(1,5,6) And Nvl(A.保留,0) IN(0,1,2)" & _
