...
Private Sub IDKind_Click(objCard As Card)
    ...
    Dim strOutclsPatientInfoXml As String
    ...
    If gobjOneCardComLib.zlReadCard(Me, mlngModul, mlngCardTypeID, True, strExpand, strOutCardNo, strOutclsPatientInfoXml) = False Then Exit Sub
...
Private Sub IDKind_ReadCard(ByVal objCard As Card, objPatientInfo As clsPatientInfo, blnCancel As Boolean)
    ...
    txtCard.Text = objPatientInfo.卡号
...
Private Sub zlInitData()
    ...
    strKey = gobjOneCardComLib.zlGetIDKindStr("")
    If strKey = "" Then mblnUnLoad = True:         Exit Sub
    
    
    IDKind.IDKindStr = strKey
    Call IDKind.zlInit(Me, glngSys, glngModul, gcnOracle, gstrDBUser, gobjOneCardComLib, "", txtCard)
