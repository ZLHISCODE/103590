...
Public Sub zlShowHealthArchives(ByVal frmMain As Object, ByVal lng病人ID As Long, _
   ...
   '---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    End If
End Sub
Private Function LoadclsPatientInfo() As Boolean
   '---------------------------------------------------------------------------------------------------------------------------------------------
    '功能:加载病人信息
...
Private Sub Form_Load()
    mblnUnLoad = Not LoadclsPatientInfo
...
Private Sub Form_Unload(Cancel As Integer)
    Set mrsInfor = Nothing
    Set mrsOtherCertificate = Nothing
    Set mrsDrug = Nothing
    Set mrsBacterin = Nothing
...
Private Sub LoadPhoto()
   '---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    '显示照片
    picPhoto.Cls
    strTempFile = sys.ReadLob(glngSys, 27, mlng病人ID)
