...
Private Sub cmdEnd_Click()
    ...
    Else
       If mobjDatabase.CheckAdoConnction(False) = False Then
         cmdCancel_Click
       End If
    End If
End Sub
...
Public Function ShowEdit(lngErrNum As Long, strNote As String, _
    strErrInfo As String, ByVal blnConnect As Boolean, ByVal objDatabase As clsDatabase) As Byte
'功能：显示错误提示窗口，可以选择重试
'参数：lngErrNum   错误编号
'      strNote     错误内容
'      strErrInfo  详细的错误信息
