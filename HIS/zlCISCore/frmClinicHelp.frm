...
Begin VB.Form frmClinicHelp 
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2355
            MinWidth        =   882
            Picture         =   "frmClinicHelp.frx":038A
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
         EndProperty
   ...
   Begin VB.PictureBox picItem 
      ...
      Height          =   675
      Left            =   4605
      Picture         =   "frmClinicHelp.frx":0C1C
      ScaleHeight     =   675
      ScaleWidth      =   7245
      TabIndex        =   12
      TabStop         =   0   'False
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":1238
            Key             =   "close"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":17D2
            Key             =   "expend"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":1D6C
            Key             =   "item"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgGray 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   7
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":2306
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":2520
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":273A
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":2954
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":2B6E
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":2D88
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":2FA8
            Key             =   "Quit"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgColor 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   7
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":31C8
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":33E2
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":35FC
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":3816
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":3A30
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":3C50
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicHelp.frx":3E70
            Key             =   "Quit"
         EndProperty
      EndProperty
   End
   ...
   Begin TabDlg.SSTab stbCatalog 
      ...
      WordWrap        =   0   'False
      TabCaption(0)   =   "目录(&C)"
      TabPicture(0)   =   "frmClinicHelp.frx":4090
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "picList"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "搜索(&S)"
      TabPicture(1)   =   "frmClinicHelp.frx":40AC
      ...
      TabCaption(2)   =   "书签(&I)"
      TabPicture(2)   =   "frmClinicHelp.frx":40C8
...
Public Sub ShowMe(ByVal bytModal As Byte, ByVal frmParent As Object, Optional ByVal lngItemID As Long)
    ...
    Else
        With rsTemp
            gstrSql = "Select nvl(max(参考目录ID),0) from 诊疗项目目录 where ID=" & lngItemID
            If .State = adStateOpen Then .Close
            Call SQLTest(App.ProductName, frmParent.Caption, gstrSql): .Open gstrSql, gcnOracle, adOpenStatic, adLockReadOnly: Call SQLTest
            lngItemID = .Fields(0).Value
        End With
        If lngItemID = 0 Then
...
Private Sub cmdDel_Click()
    ...
    Call SaveSetting("ZLSOFT", "公共模块\" & App.ProductName & "\诊疗参考书签\", UserInfo.用户名, strTemp)
End Sub
...
Private Sub cmdFind_Click()
    ...
    gstrSql = "select distinct I.分类ID,I.ID,I.编码,I.名称" & _
...
Private Sub cmdMark_Click()
    ...
    gstrSql = "select I.分类ID,I.ID,I.编码,I.名称" & _
            " from 诊疗参考目录 I" & _
...
Private Sub Form_Load()
    ...
    '提取书签显示
    strTemp = GetSetting("ZLSOFT", "公共模块\" & App.ProductName & "\诊疗参考书签\", UserInfo.用户名, "")
...
Private Sub zlShowRef(lngItemID As Long)
    ...
    With rsTemp
        Me.lblAlias.Caption = ""
        gstrSql = "select distinct I.分类ID,I.ID,I.编码,N.性质,N.名称,I.类型" & _
                " from 诊疗参考目录 I,诊疗参考别名 N" & _
                " where I.ID=N.参考目录ID and I.ID=" & lngItemID
        If .State = adStateOpen Then .Close
        Call SQLTest(App.ProductName, Me.Caption, gstrSql): .Open gstrSql, gcnOracle, adOpenStatic, adLockReadOnly: Call SQLTest
        Do While Not .EOF
            If !性质 = 1 Then
        ...
        gstrSql = "select 项目层次,项目序号,内容行号,decode(nvl(内容行号,0),0,参考项目,内容文本) as 内容" & _
                " from 诊疗参考内容" & _
                " where 参考目录id=" & lngItemID & " and (nvl(内容行号,0)=0 or length(ltrim(nvl(内容文本,'')))<>0)" & _
                " order by 项目序号,内容行号"
        If .State = adStateOpen Then .Close
        Call SQLTest(App.ProductName, Me.Caption, gstrSql): .Open gstrSql, gcnOracle, adOpenStatic, adLockReadOnly: Call SQLTest
        If .EOF Or .BOF Then
