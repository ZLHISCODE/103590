...
Public Event LoadUrlBegin(ByVal title As String, ByVal url As String, ByVal job As Long)
...
Private Function ChandleLoadUrlBegin(ByVal webWindow As Long, ByVal param As Long, ByVal url As Long, ByVal job As Long) As Long
    RaiseEvent LoadUrlBegin(MiniblinkAPICls.wkeGetTitleW(webWindow), SDLL.PointerToStringA(url), job)
End Function
