...
Public Function GetCookie() As String
    GetCookie = MiniblinkAPICls.wkeGetCookie(m_WebWindow)
End Function

Public Function GetGetURL() As String
    GetGetURL = MiniblinkAPICls.wkeGetURL(m_WebWindow)
End Function

Public Function GetVersion() As String
    GetVersion = MiniblinkAPICls.wkeVersionString
End Function

Public Function GetVersionNum() As Long
    GetVersionNum = MiniblinkAPICls.wkeVersion
End Function
