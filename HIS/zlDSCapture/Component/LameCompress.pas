...
const
   //Mp3 Compress Rate 
   _BITRATE32: Integer = 32;
   _BITRATE40: Integer = 40;
   _BITRATE48: Integer = 48;
   _BITRATE56: Integer = 56;
   _BITRATE64: Integer = 64;
   _BITRATE80: Integer = 80;
   _BITRATE96: Integer = 96;
   _BITRATE112: Integer = 112;
   _BITRATE128: Integer = 128;
   _BITRATE144: Integer = 144;
   _BITRATE160: Integer = 160;
   _BITRATE192: Integer = 192;
   _BITRATE224: Integer = 224;
   _BITRATE256: Integer = 256;
   _BITRATE320: Integer = 320;
 ...
 *)
  ...
  proc_beInitStream = function(pbeConfig: PBE_CONFIG; var dwSamples: DWORD; var dwBufferSize: DWORD; var phbeStream: HBE_STREAM): Integer; cdecl;
  {DP:METHOD
    Prototype for beEncodeChunk() routine.
  }
  proc_beEncodeChunk = function(hbeStream: HBE_STREAM; nSamples: DWORD; pSamples: pointer; pOutput: pointer; var pdwOutput: DWORD): Integer; cdecl;
  {DP:METHOD
    Prototype for beDeinitStream() routine.
  }
  proc_beDeinitStream = function(hbeStream: HBE_STREAM; pOutput: pointer; var pdwOutput: DWORD): Integer; cdecl;
  {DP:METHOD
    Prototype for beCloseStream() routine.
  }
  proc_beCloseStream = function(hbeStream: HBE_STREAM): Integer; cdecl;
  {DP:METHOD
  ...
  proc_lameWriteVBRHeader = function(fileName: LPCSTR): Integer; cdecl;  
...
var
  ...
  lameInitStream  : proc_beInitStream; 	// same stubs as for Blade
  lameEncodeChunk : proc_beEncodeChunk;
  lameDeinitStream: proc_beDeinitStream;
  lameCloseStream : proc_beCloseStream;
  lameVersion     : proc_beVersion;
  lameWriteVBRHeader: proc_lameWriteVBRHeader;
...
{$IFDEF LINUX}
  ...
  begin
    ...
    id3tag_set_genre := dlsym(Libhandle, 'id3tag_set_genre');
	  ...
	  lameInitStream  := dlsym(Libhandle, 'beInitStream');
	  lameEncodeChunk := dlsym(Libhandle, 'beEncodeChunk');
	  lameDeinitStream:= dlsym(Libhandle, 'beDeinitStream');
	  lameCloseStream := dlsym(Libhandle, 'beCloseStream');
	  lameVersion     := dlsym(Libhandle, 'beVersion');
	  lameWriteVBRHeader := dlsym(Libhandle, 'beWriteVBRHeader');    
  end;
{$ENDIF}
...
{$IFDEF WIN32}
  ...
  begin
    ...
    id3tag_set_genre := GetProcAddress(Libhandle, 'id3tag_set_genre');
	  ...
	  lameInitStream  := Windows.GetProcAddress(Libhandle, 'beInitStream');
	  lameEncodeChunk := Windows.GetProcAddress(Libhandle, 'beEncodeChunk');
	  lameDeinitStream:= Windows.GetProcAddress(Libhandle, 'beDeinitStream');
	  lameCloseStream := Windows.GetProcAddress(Libhandle, 'beCloseStream');
	  lameVersion     := Windows.GetProcAddress(Libhandle, 'beVersion');
	  lameWriteVBRHeader := Windows.GetProcAddress(Libhandle, 'beWriteVBRHeader');
  end;
{$ENDIF}
end;
