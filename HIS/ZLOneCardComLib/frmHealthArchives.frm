...
Private Function LoadPatiInfor() As Boolean
   '---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Dim strInfor As String, str证件 As String
    ...
    With mrsInfor
        ...
        .fields.Append "学历", adLongVarChar, 50, adFldIsNullable
        ...
        .fields.Append "联系人姓名1", adLongVarChar, 100, adFldIsNullable
        .fields.Append "联系人关系1", adLongVarChar, 100, adFldIsNullable
        .fields.Append "联系人电话1", adLongVarChar, 100, adFldIsNullable
        
        .fields.Append "联系人姓名2", adLongVarChar, 100, adFldIsNullable
        .fields.Append "联系人关系2", adLongVarChar, 100, adFldIsNullable
        .fields.Append "联系人电话2", adLongVarChar, 100, adFldIsNullable
        
        
        .fields.Append "联系人姓名3", adLongVarChar, 100, adFldIsNullable
        .fields.Append "联系人关系3", adLongVarChar, 100, adFldIsNullable
        .fields.Append "联系人电话3", adLongVarChar, 100, adFldIsNullable
        
        .fields.Append "新农合号", adLongVarChar, 100, adFldIsNullable
        .fields.Append "健康档案编号", adLongVarChar, 100, adFldIsNullable
        .fields.Append "费用支付方式", adLongVarChar, 100, adFldIsNullable
        .fields.Append "ABO血型", adLongVarChar, 100, adFldIsNullable
        .fields.Append "RH", adLongVarChar, 100, adFldIsNullable
        .fields.Append "医学警示", adLongVarChar, 100, adFldIsNullable
        .fields.Append "其他医学警示", adLongVarChar, 100, adFldIsNullable
    ...
    With mrsDrug
        ...
        .fields.Append "过敏药物", adLongVarChar, 200, adFldIsNullable
        .fields.Append "过敏反应", adLongVarChar, 200, adFldIsNullable
        .CursorLocation = adUseClient
        .CursorType = adOpenStatic
        .LockType = adLockOptimistic
        .Open
    ...
    With mrsBacterin
        If .State = 1 Then .Close
        .fields.Append "病人ID", adVarNumeric, 18, adFldIsNullable
        .fields.Append "接种时间", adLongVarChar, 50, adFldIsNullable
        .fields.Append "接种名称", adLongVarChar, 200, adFldIsNullable
        .CursorLocation = adUseClient
        .CursorType = adOpenStatic
        .LockType = adLockOptimistic
        .Open
    ...
    With mrsOtherCertificate
        If .State = 1 Then .Close
        .fields.Append "证件类型", adLongVarChar, 100, adFldIsNullable
        .fields.Append "证件号码", adLongVarChar, 100, adFldIsNullable
        .CursorLocation = adUseClient
        .CursorType = adOpenStatic
        .LockType = adLockOptimistic
        .Open
    ...
    '是否包含卡信息:1-包含医疗卡;0-不包含医疗卡
    If zl_PatiSvr_GetPatiInfo(mlng病人ID, Nothing, cllData, 1, , True, True) = False Then Exit Function
    ...
    With mrsInfor
        ...
        !职业 = cllTemp("_pocpt_name")
        !身份证号 = cllTemp("_pati_idcard")
        !联系人姓名1 = cllTemp("_contacts_name")
        !联系人关系1 = cllTemp("_contacts_relation")
        !联系人电话1 = cllTemp("_contacts_phno")
    '
    '        !联系人姓名2 = cllTemp("_pati_id")
    '        !联系人关系2 = cllTemp("_pati_id")
    '        !联系人电话2 = cllTemp("_pati_id")
    '
    '
    '        !联系人姓名3 = cllTemp("_pati_id")
    '        !联系人关系3 = cllTemp("_pati_id")
    '        !联系人电话3 = cllTemp("_pati_id")
    '
    '        !新农合号 = cllTemp("_pati_id")
    '        !健康档案编号 = cllTemp("_pati_id")
    '        !费用支付方式 = cllTemp("_pati_id")
    '        !ABO血型 = cllTemp("_pati_id")
    '        !RH = cllTemp("_pati_id")
    '        !医学警示 = cllTemp("_pati_id")
    '        !其他医学警示 = cllTemp("_pati_id")
        .Update
    End With
    ...
    If Not cllItems Is Nothing Then
        With mrsDrug
            For i = 1 To cllItems.count
                ...
                .AddNew
                    !过敏药物 = cllTemp("_pat_algc_cadn")
                    !过敏反应 = cllTemp("_allergy_info")
                .Update
            Next
        End With
    End If
    ...
    If Not cllItems Is Nothing Then
        With mrsBacterin
            For i = 1 To cllItems.count
                ...
                .AddNew
                    !病人ID = mlng病人ID
                    !接种时间 = cllTemp("_vaccinate_time")
                    !接种名称 = cllTemp("_vaccinate_name")
                .Update
            Next
        End With
    End If
    
    strInfor = "联系人姓名1,联系人关系1,联系人电话1,联系人姓名2,联系人关系2,联系人电话2,健康档案编号,新农合(卡)号,医疗费用支付方式,ABO,血型,RH,医学警示,其他医学警示"
    '读取其他证件
    strSQL = "Select 名称  From 证件类型 B"
    Set rsTemp = mobjDataBase.OpenSQLRecord(strSQL, Me.Caption)
    str证件 = ""
    With rsTemp
        Do While Not .EOF
            strInfor = strInfor & "," & !名称
            str证件 = str证件 & "," & !名称
            .MoveNext
        Loop
    End With
    
    Call zl_PatiSvr_GetPatiExtendInfo(mlng病人ID, strInfor, cllData)
    '    slave_list[]    C       从表项信息列表
    '       info_name   C   1   信息名
    '       upd_info_value  N   1   信息值
    '       pvid        n 1 就诊ID
    If Not cllData Is Nothing Then
        For i = 1 To cllData.count
              ...
              Select Case NVL(cllTemp("_info_name"))
                Case "联系人姓名1"
                    mrsInfor!联系人姓名1 = NVL(cllTemp("_upd_info_value"))
                    mrsInfor.Update
                Case "联系人关系1"
                    mrsInfor!联系人关系1 = NVL(cllTemp("_upd_info_value"))
                    mrsInfor.Update
                Case "联系人电话1"
                    mrsInfor!联系人电话1 = NVL(cllTemp("_upd_info_value"))
                    mrsInfor.Update
                Case "联系人姓名2"
                    mrsInfor!联系人姓名2 = NVL(cllTemp("_upd_info_value"))
                    mrsInfor.Update
                Case "联系人关系2"
                    mrsInfor!联系人关系2 = NVL(cllTemp("_upd_info_value"))
                    mrsInfor.Update
                Case "联系人电话2"
                    mrsInfor!联系人电话2 = NVL(cllTemp("_upd_info_value"))
                    mrsInfor.Update
                Case "健康档案编号"
                    mrsInfor!健康档案编号 = NVL(cllTemp("_upd_info_value"))
                    mrsInfor.Update
                Case "新农合(卡)号"
                    mrsInfor!新农合号 = NVL(cllTemp("_upd_info_value"))
                    mrsInfor.Update
                Case "医疗费用支付方式"
                    mrsInfor!医疗费用支付方式 = NVL(cllTemp("_upd_info_value"))
                    mrsInfor.Update
                Case "ABO"
                    If Val(NVL(cllTemp("_visit_id"))) = 0 And NVL(mrsInfor!ABO血型) = "" Then
                        mrsInfor!ABO血型 = NVL(cllTemp("_upd_info_value"))
                        mrsInfor.Update
                    End If
                Case "血型"
                    If Val(NVL(cllTemp("_visit_id"))) = 0 And NVL(mrsInfor!ABO血型) = "" Then
                ...
                Case "RH"
                    ...
                    mrsInfor.Update
                Case "医学警示"
                    mrsInfor!医学警示 = NVL(cllTemp("_upd_info_value"))
                    mrsInfor.Update
                Case "其他医学警示"
                    mrsInfor!其他医学警示 = NVL(cllTemp("_upd_info_value"))
                    mrsInfor.Update
                Case Else
                    If InStr(str证件 & ",", "," & NVL(cllTemp("_info_name")) & ",") > 0 Then
                        With mrsOtherCertificate
                            .AddNew
                                !证件类型 = NVL(cllTemp("_info_name"))
                                !证件号码 = NVL(cllTemp("_upd_info_value"))
                            .Update
                        End With
                    End If
            End Select
