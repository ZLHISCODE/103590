...
Public Property Get OperationValue() As String
    OperationValue = mlngFileID & "|" & mlng序号
End Property

Public Property Let OperationValue(ByVal strValue As String)
    Dim arrValue
    arrValue = Split(strValue, "|")
    If UBound(arrValue) >= 0 Then mlngFileID = Val(arrValue(0))
    If UBound(arrValue) >= 1 Then mlng序号 = Val(arrValue(1))
End Property
...
'        End With
    ...
    Case conMenu_File_PrintDayDetail, conMenu_Edit_Curve, conMenu_Edit_CurveTable, conMenu_Edit_Oper, conMenu_Edit_Curve_Show '批量录入,设置记录,显示
...
Public Sub zlUpdateCommandBars(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    Case conMenu_Edit_Curve, conMenu_Edit_CurveTable, conMenu_Edit_Curve_Show, conMenu_Edit_Oper '设置记录和显示
