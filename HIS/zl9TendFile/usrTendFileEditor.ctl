...
Begin VB.UserControl usrTendFileEditor 
   ...
   Begin VB.PictureBox picCloumn 
      ...
      Begin VB.CommandButton cmdFilterOK 
         Height          =   315
         Left            =   2460
         Picture         =   "usrTendFileEditor.ctx":1648
         Style           =   1  'Graphical
         TabIndex        =   30
         ToolTipText     =   "确认"
         Top             =   2310
      ...
      Begin VB.CommandButton cmdFilterCancel 
         Height          =   315
         Left            =   3000
         Picture         =   "usrTendFileEditor.ctx":1BD2
         Style           =   1  'Graphical
         TabIndex        =   31
         ToolTipText     =   "取消"
         Top             =   2310
   ...
   Begin VB.PictureBox picSignCheck 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfSignData 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"usrTendFileEditor.ctx":215C
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.Image imgNote 
         Height          =   480
         Left            =   120
         Picture         =   "usrTendFileEditor.ctx":21BE
         Top             =   90
         Width           =   480
      End
   End
   ...
   Begin MSComctlLib.ImageList imgRow 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   6
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "usrTendFileEditor.ctx":2E00
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "usrTendFileEditor.ctx":319A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "usrTendFileEditor.ctx":3534
            Key             =   ""
         EndProperty
         ...
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "usrTendFileEditor.ctx":3C20
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "usrTendFileEditor.ctx":3FBA
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.PictureBox picMain 
      ...
      Begin VB.ListBox lstSelect 
         ...
         Height          =   930
         Index           =   2
         ItemData        =   "usrTendFileEditor.ctx":4354
         Left            =   6675
         List            =   "usrTendFileEditor.ctx":4367
         TabIndex        =   84
         Top             =   1050
         Visible         =   0   'False
         Width           =   855
      ...
      Begin VSFlex8Ctl.VSFlexGrid VsfData 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"usrTendFileEditor.ctx":438B
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.PictureBox picInfo 
         ...
         Begin VB.PictureBox picImg 
            ...
            Height          =   225
            Left            =   840
            Picture         =   "usrTendFileEditor.ctx":43ED
            ScaleHeight     =   225
            ScaleWidth      =   285
            TabIndex        =   82
            Top             =   45
      ...
      Begin VB.PictureBox PicLst 
         ...
         Begin VB.ListBox lstSelect 
            ...
            Height          =   1470
            Index           =   0
            ItemData        =   "usrTendFileEditor.ctx":AC3F
            Left            =   -10
            List            =   "usrTendFileEditor.ctx":AC55
            TabIndex        =   5
            Top             =   825
            Visible         =   0   'False
            Width           =   1215
      ...
      Begin VB.PictureBox picSign 
         ...
         Begin VB.Image imgSign 
            Height          =   480
            Left            =   -30
            Picture         =   "usrTendFileEditor.ctx":AC8D
            Tag             =   "240"
            Top             =   -30
            Width           =   480
         End
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfHead 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"usrTendFileEditor.ctx":114DF
         ScrollTrack     =   -1  'True
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.PictureBox picDoubleChoose 
         ...
         Begin VB.PictureBox picChooseRight 
            ...
            Begin VB.ComboBox cboChoose 
               ...
               Height          =   300
               Index           =   1
               ItemData        =   "usrTendFileEditor.ctx":11541
               Left            =   -30
               List            =   "usrTendFileEditor.ctx":11551
               Style           =   2  'Dropdown List
               TabIndex        =   60
               Top             =   -30
               Width           =   1605
         ...
         Begin VB.PictureBox picChooseLeft 
            ...
            Begin VB.ComboBox cboChoose 
               ...
               Height          =   300
               Index           =   0
               ItemData        =   "usrTendFileEditor.ctx":11563
               Left            =   -30
               List            =   "usrTendFileEditor.ctx":11573
               Style           =   2  'Dropdown List
               TabIndex        =   58
               Top             =   -30
               Width           =   1605
      ...
      Begin VB.CommandButton cmdWord 
         ...
         Height          =   255
         Left            =   6120
         Picture         =   "usrTendFileEditor.ctx":11585
         Style           =   1  'Graphical
         TabIndex        =   23
         TabStop         =   0   'False
         Top             =   1290
      ...
      Begin VB.ListBox lstSelect 
         ...
         Height          =   2340
         Index           =   1
         ItemData        =   "usrTendFileEditor.ctx":118C7
         Left            =   6675
         List            =   "usrTendFileEditor.ctx":118DD
         Style           =   1  'Checkbox
         TabIndex        =   6
         Top             =   1590
         Visible         =   0   'False
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsTest 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"usrTendFileEditor.ctx":11915
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
...
Private mlngDigitalSign As Long             '数字签名项目id
...
Private mblnShowNullCollet As Boolean       '小结为空的数据下方是否画横线
...
Private mbln最后诊断  As Boolean            '标签是否绑定了最后诊断
...
Private Sub DrawCollectCell(ByVal hDC As Long, ByVal ROW As Long, ByVal COL As Long, ByVal Left As Long, ByVal Top As Long, ByVal Right As Long, ByVal Bottom As Long)
    ...
    Case 1  '上下划横线(起始行画上横线，结束行画下横线)
        ...
        End If
    Case 2  '汇总项下双横线
        If InStr(1, "|" & VsfData.TextMatrix(ROW, mlngCollectValue) & ";", "|" & COL - (cHideCols + VsfData.FixedCols - 1) & ";") <> 0 Then         'And Then
...
Private Function ReadStruDef() As Boolean
    ...
    With rsTemp
        ...
        Do While Not .EOF
            ...
            If !要素名称 = "最后诊断" Then mbln最后诊断 = True
            .MoveNext
        Loop
        If mint婴儿 <> 0 Then mbln最后诊断 = False
...
'                    End If
        ...
        mstrSQL中 = UCase(mstrSQL中 & ",MAX(签名级别) AS 签名级别,MAX(签名信息) AS 签名信息,MAX(交班签名人) AS 交班签名人,MAX(记录ID) AS 记录ID,'' AS 项目ID,MAX(行数) AS 行数,MAX(实际行数) AS 实际行数,Max(开始页号) AS 开始页号,Max(开始行号) AS 开始行号,MAX(汇总类别) AS 汇总类别,MAX(汇总文本) AS 汇总文本,MAX(汇总标记) AS 汇总标记,MAX(汇总日期) AS 汇总日期,MAX(开始时点) AS 开始时点,MAX(结束时点) AS 结束时点,f_List2str(Cast(Collect(汇总值) As t_Strlist), '|') 汇总值")
        ...
        mstrSQL列 = UCase(mstrSQL列 & ",签名级别,签名信息,交班签名人,记录ID,项目ID,行数,实际行数,开始页号,开始行号,汇总类别,汇总文本,汇总标记,汇总日期,开始时点,结束时点,汇总值")
...
Private Sub zlRefresh()
    ...
    For lngCount = 0 To UBound(aryItem)
        ...
        Case "最后诊断"
            ...
            Set rsTemp = zlDatabase.OpenSQLRecord(gstrSQL, "取设置的诊断", mlng病人ID, mlng主页ID, mlng文件ID, CDate(strTime), CDate(aryPeriod(1)))
            If NVL(rsTemp!诊断内容) = "" Then
    ...
    mstrSQL = "Select 项目id, 发生时间" & _
           " From (Select b.发生时间, Max(a.Id) As ID " & vbNewLine & _
           "        From 病人护理明细 A, 病人护理数据 B, 病人护理打印 C " & vbNewLine & _
           "        Where a.记录id = b.Id And Mod(a.记录类型, 10) = 5 and B.文件id=[1] And b.文件id = c.文件id And  b.发生时间 = c.发生时间  And c.开始页号 = [2] And c.结束页号 = [2] And B.签名人 is not null " & vbNewLine & _
           "        Group By b.发生时间 " & vbNewLine & _
           "        Order By b.发生时间) F, 病人护理明细 G" & vbNewLine & _
           " Where f.Id = g.Id and 项目id is not null "
    Set rsTmp = zlDatabase.OpenSQLRecord(mstrSQL, "提取护理数据", mlng文件ID, mint页码)
    
    '清除并拷贝记录集结构
    Call DataMap_Init(rsTemp)
    '绑定数据并设置护理记录单的格式,同时实现一行数据分行显示的功能
    Call PreTendFormat(rsTemp, rsTmp)
    Call cbsThis_Resize
...
Private Sub PreTendFormat(ByVal rsTemp As ADODB.Recordset, ByVal rsTmp As ADODB.Recordset)
    ...
    With vsfHead
        ...
        .ColHidden(mlngDigitalSign) = True
        ...
        Next
        '将固定行的行高如果大于最大行高则设置为最大行高
        For lngCount = 0 To .FixedRows - 1
           If .RowHeight(lngCount) > .RowHeightMax Then .RowHeight(lngCount) = .RowHeightMax
        Next
        .Height = 0
        For lngCount = 0 To .FixedRows - 1
    ...
    With VsfData
        ...
        For lngCount = VsfData.FixedRows To VsfData.Rows - 1
            lngStart = GetStartRow(lngCount)
            If VsfData.TextMatrix(lngStart, 2) <> "" Then
                rsTmp.Filter = " 发生时间 ='" & Format(VsfData.TextMatrix(lngStart, 2), "YYYY-MM-DD hh:mm:ss") & "'"
                If rsTmp.RecordCount > 0 Then
                    VsfData.TextMatrix(lngCount, mlngDigitalSign) = Val(NVL(rsTmp!项目ID))
                End If
            End If
        Next
                ...
                Else
                    ...
                    Else
                        If InStr(1, VsfData.TextMatrix(lngCount, mlngSigner), "/") <> 0 Then
                            If VsfData.TextMatrix(lngCount, mlngDigitalSign) = "" Then
                                VsfData.Cell(flexcpPicture, lngCount, 0) = imgRow.ListImages(审签).Picture
                            Else
                                VsfData.Cell(flexcpPicture, lngCount, 0) = imgRow.ListImages(数字审签).Picture
                            End If
                        '51589:刘鹏飞,2013-03-01,添加交班签名
                        ElseIf Trim(VsfData.TextMatrix(lngCount, mlngJoinSignName)) <> "" Then '交班签名
                            ...
                            Else
                                VsfData.Cell(flexcpPicture, lngCount, 0) = imgRow.ListImages(数字交班).Picture
                            End If
                        Else
                            If VsfData.TextMatrix(lngCount, mlngDigitalSign) = "" Then
                                VsfData.Cell(flexcpPicture, lngCount, 0) = imgRow.ListImages(签名).Picture
                            Else
                                VsfData.Cell(flexcpPicture, lngCount, 0) = imgRow.ListImages(数字签名).Picture
                            End If
                        End If
                    End If
...
'        mlngRowCount = mlngRecord + 1
        mlngDigitalSign = mlngRecord + 1
        mlngRowCount = mlngDigitalSign + 1
    ...
    Else
        ...
        If blnExchange = False Then
            gstrSQL = "" & _
                    ...
                    "SELECT DISTINCT B.ID,B.发生时间" & vbNewLine & _
                    "FROM 病人护理明细 A,病人护理数据 B" & vbNewLine & _
                    "WHERE A.记录ID=B.ID And A.数据来源 in (0,3) AND A.终止版本 IS NULL AND A.记录类型 =5 AND B.文件ID=[1]"
            Call SQLDIY(gstrSQL)
            Set rsTemp = zlDatabase.OpenSQLRecord(gstrSQL, "检查是否存在未签名的数据", mlng文件ID, gstrUserName)
            If rsTemp.RecordCount = 0 Then
                '101151:陈刘,2016-10-19,添加未签名数据保存人提示
...
Public Sub UnSignMe(Optional ByVal bln审签 As Boolean = False, Optional ByVal blnSingleCancel As Boolean = False)
'blnSingleCancel:是否是单个取消签名
    ...
    If NVL(rsTemp!记录人) <> gstrUserName Then
        RaiseEvent AfterRowColChange("您不是最后签名人，不能执行本操作！最后签名人为：" & NVL(rsTemp!记录人), True, mblnSign, mblnArchive)
        Exit Sub
    End If
...
ErrNext:
    ...
    Case conMenu_Edit_Modify
        If rsTemp.RecordCount <= 0 Then
            MsgBox "本页无护理数据,不能进行诊断设置,请先录入护理数据！", vbInformation, gstrSysName
        Else
            strTime = GetPeriod
            Call frmNurseFileDiagnose.ShowEdtor(Me, mlng病人ID, mlng主页ID, mlng文件ID, strTime)
            mblnInit = False
            Call InitVariable
            Call InitCons
            Call ReadStruDef
...
Private Sub cbsThis_Update(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    Case conMenu_Edit_Brief
        Control.Enabled = Control.Visible And Not mblnArchive And Not mblnVerify And mblnEditable
    Case conMenu_Edit_Modify '诊断设置
        Control.Enabled = Control.Visible And Not mblnArchive And Not mblnVerify And mblnEditable And Not mblnChange And mbln最后诊断
...
Private Sub txtLst_Change()
    ...
    lngHeight = txtLst.Height '原有高度
    lngCurHeight = PicLst.TextHeight("刘") * (intRows) + PicLst.TextHeight("刘") \ 3
    If lngCurHeight < Val(txtLst.Tag) Then lngCurHeight = Val(txtLst.Tag)
    lngDiffHeight = lngCurHeight - lngHeight '获取高度差
    txtLst.Height = lngCurHeight
    lbllst(1).Top = txtLst.Top + txtLst.Height + 20
    lstSelect(mintType - 1).Top = lbllst(1).Top + lbllst(1).Height + 20
    PicLst.Height = lstSelect(mintType - 1).Top + PicLst.TextHeight("刘") * (lstSelect(mintType - 1).ListCount) + PicLst.TextHeight("刘") \ 3
    If PicLst.Height + PicLst.Top + picMain.Top > ScaleHeight Then
        If ScaleHeight - picMain.Top - PicLst.Height < 0 Then
            PicLst.Top = 10
            PicLst.Height = ScaleHeight - picMain.Top - 10
        Else
            PicLst.Top = ScaleHeight - picMain.Top - PicLst.Height
        End If
    End If
...
Private Function InitMenuBar() As Boolean
    ...
    cbsThis.ActiveMenuBar.EnableDocking (xtpFlagAlignTop)
        ...
        With cbrToolBar.Controls
            ...
            Set cbrControl = .Add(xtpControlButton, conMenu_Edit_Modify, "诊断设置"): cbrControl.ToolTipText = "护理诊断设置"
            ...
            If strText <> "" Then
                ...
                If blnCheck Then
                    If mrsItems!项目类型 = 0 And InStr(1, "0,4", mrsItems!项目表示) <> 0 Then
                        ...
                        blnNumber = True
                        If Not blnCanves Then strText = Val(strText)
                        If NVL(mrsItems!项目小数, 0) <> 0 Then   '等于零是通过控件的MaxLength来控制的
                            ...
                            If InStr(1, strText, ".") <> 0 Then
                                ...
                                End If
                            End If
                            strText = IIf(Not blnCanves, Val(arrData(i)), arrData(i))
                        End If
...
'    objStream.Close
    ...
    End If
    If Not mrsTemperItems Is Nothing Then
        If mrsTemperItems.State = adStateOpen Then mrsTemperItems.Close
        Set mrsTemperItems = Nothing
    End If
    ...
    End If
    If Not mrsCellMap Is Nothing Then
        If mrsCellMap.State = adStateOpen Then mrsCellMap.Close
        Set mrsCellMap = Nothing
    End If
    If Not mrsCopyMap Is Nothing Then
        If mrsCopyMap.State = adStateOpen Then mrsCopyMap.Close
        Set mrsCopyMap = Nothing
    End If
    If Not mrsUsual Is Nothing Then
        If mrsUsual.State = adStateOpen Then mrsUsual.Close
        Set mrsUsual = Nothing
    End If
    If Not mfrmParent Is Nothing Then Set mfrmParent = Nothing
    If Not mobjVerify Is Nothing Then Set mobjVerify = Nothing
...
'功能：返回指定行记录ID信息,分组数据则返回改组内数据的记录ID，以“，”号分割
    ...
    strRecordid = ""
    lngDemo = Val(VsfData.TextMatrix(lngStart, mlngDemo))
    lngStartID = Val(VsfData.TextMatrix(lngStart, mlngRecord))
    If lngDemo = 1 Then
        For lngRow = lngStart To VsfData.Rows - 1
