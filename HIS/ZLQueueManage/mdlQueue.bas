...
'列名称（字段名称）  都是排队叫号记录中的字段，字段使用时必须使用数据库一样的名称
Public Const C_STR_COL_ID = "ID" '
Public Const C_STR_COL_病人ID = "病人ID" '
Public Const C_STR_COL_队列名称 = "队列名称" '
Public Const C_STR_COL_业务ID = "业务ID" '
Public Const C_STR_COL_科室ID = "科室ID" '
Public Const C_STR_COL_排队号码 = "号码" '
Public Const C_STR_COL_患者姓名 = "患者姓名" '
Public Const C_STR_COL_诊室 = "诊室" '
Public Const C_STR_COL_医生姓名 = "医生姓名" '
Public Const C_STR_COL_业务类型 = "业务类型" '
