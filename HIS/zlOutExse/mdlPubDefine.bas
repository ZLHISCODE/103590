...
Public Const conMenu_File_FeeCollect = 200   '收费员轧帐
Public Const conMenu_File_SetInsure = 201   '保险类别
...
'费用补充记录管理
'----------------------------------------------------------------------------------------------------------------------
Public Const conMenu_Edit_InsureBalance = 6900    '医保结算
Public Const conMenu_Edit_BalanceDel = 6901    '结算退费
Public Const conMenu_Edit_ReBalance = 6902    '重新结算
Public Const conMenu_Edit_BalanceCancel = 6903    '结算作废
Public Const conMenu_Edit_ReDel = 6904    '重新退费
Public Const conMenu_Edit_ViewBalance = 6905  '查阅单据
Public Const conMenu_Edit_ReprintBalanceReceipt = 6906    '重打票据
Public Const conMenu_Edit_PrintAmend = 6907    '补打票据
Public Const conMenu_Edit_PrintList = 6908 '打印费用清单
Public Const conMenu_Edit_DelPrint = 6909    '补打/重打退费票据
Public Const conMenu_View_RefreshType = 6910
Public Const conMenu_View_RefreshType_No = 6911
Public Const conMenu_View_RefreshType_Auto = 6912
Public Const conMenu_View_RefreshType_Ask = 6913
Public Const conMenu_Edit_RegistBalance = 6914    '挂号结算
