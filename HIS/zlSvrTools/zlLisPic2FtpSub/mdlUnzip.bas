...
Public Declare Function Wiz_SingleEntryUnzip1 Lib "zlUZip10.dll" _
  (ByVal ifnc As Long, ByRef ifnv As UNZIPnames, _
   ByVal xfnc As Long, ByRef xfnv As UNZIPnames, _
   dcll As DCLIST1, Userf As USERFUNCTION) As Long
...
Public Function VBUnzip1( _
    ...
    End If
    m_bCancel = False
    VBUnzip1 = Wiz_SingleEntryUnzip1(iIncCount, tInc, iExCount, tExc, tDCL, tUser)
