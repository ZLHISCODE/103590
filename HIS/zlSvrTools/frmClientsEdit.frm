...
Private Function Save() As Boolean
    ...
    If txtEdit(9).Enabled Or chkNoLimit.Enabled Then
        ...
        ElseIf optLink(3).value Then
            ...
            strMsg = "以及IP范围由" & strIpBegin & "到" & strIpEnd & "的客户端"
        End If
    End If
    ...
    If mEditType = 修改 Then
        ...
        '插入重要操作日志
        Call SaveAuditLog(2, "修改", "修改客户端“" & mstrCompterName & "”" & IIf(strMsg = "", "", strMsg) & "成功" & IIf(strNote = "", "", "其中" & Mid(strNote, 2)), mstrRemarks, "0308")
    End If
End Function
