...
'intMod =7 :加载查询SQL语句，同时传入需要查找的strSqlText
    ...
    With vsfList
        ...
        Do While Not rsData.EOF
            ...
            .TextMatrix(lngRowNum, .ColIndex("Sql_Text")) = "" & Replace(rsData!sql_text, Chr(10), "")
...
Private Sub cmdExcel_Click()
    ...
    If App.EXEName = "zlSvrStudio.EXE" And IsInstallExcel Then
        ...
        If objZlPrint Is Nothing Then
            vsfList.SaveGrid VB.App.Path & "\SqlList.xls", flexFileAll, flexXLSaveFixedCells
        ...
        End If
    Else
        vsfList.SaveGrid VB.App.Path & "\SqlList.xls", flexFileExcel, flexXLSaveFixedCells
        MsgBox "保存成功，已经保存至" & VB.App.Path & "\SqlList.xls"
    End If
