...
Private Sub cmdMulti_Click()
    ...
    For i = 1 To intProcNum
        ...
        End If
        Shell """" & strPath & "\zlLisPic2FtpSub.exe"" ""zlUserName=" & gstrUserName & "zlPassword=" & gstrLoginPwd & "zlServer=" & gstrServer & " ", vbMaximizedFocus
    Next
    Call Timer_Timer
...
Private Sub Timer_Timer()
    ...
    If intActive <> intProcNum Then
        If intProcNum <> intActive + intExit Then   '退出进程+活跃进程<>进程总数 说明有进程以外终止
