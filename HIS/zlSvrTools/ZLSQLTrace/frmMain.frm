...
Private Sub cbsMain_Update(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    Case conMenu_Edit_TraceOff, conMenu_Edit_Trace, conMenu_Edit_Trace_1, conMenu_Edit_Trace_4, conMenu_Edit_Trace_8, conMenu_Edit_Trace_12
        ...
        If Control.Enabled = False And Control.Id <> conMenu_Edit_TraceOff Then
            If cbsMain.Item(2).Controls.Find(, conMenu_Edit_TraceOff).Enabled = True Then
                Control.ToolTipText = "完成跟踪后点击停止自动获取Trace文件"
            Else
