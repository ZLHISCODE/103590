...
Public Function CheckProcManage() As Boolean
    ...
    If Err.Number <> 0 Then
        gcnOracle.Execute "Alter Table Zltools.Zlprocedure Add 升级前版本 Varchar2(50)"
        gcnOracle.Execute "Alter Table Zltools.Zlprocedure Add 升级后版本 Varchar2(50)"
        gcnOracle.Execute "Alter Table Zltools.zlProcedure Add 系统编号 Number(5)"
        gcnOracle.Execute "Alter Table Zltools.Zlprocedure Modify 说明 Varchar2(2000)"
    End If
