...
Private Sub SaveFormState()
    ...
    zlDatabase.SetPara "frmSelectExplorer_宽度", Me.Width, 100, 1208
    zlDatabase.SetPara "frmSelectExplorer_高度", Me.Height, 100, 1208
    zlDatabase.SetPara "frmSelectExplorer_分隔条", imgX.Left, 100, 1208
    ...
    zlDatabase.SetPara "frmSelectExplorer_列宽", strTmp
...
Private Sub RestoreFormState()
    ...
    Me.Width = zlDatabase.GetPara("frmSelectExplorer_宽度", 100, 1208, Me.Width)
    Me.Height = zlDatabase.GetPara("frmSelectExplorer_高度", 100, 1208, Me.Height)
    imgX.Left = zlDatabase.GetPara("frmSelectExplorer_分隔条", 100, 1208, imgX.Left)
    ...
    strTmp = zlDatabase.GetPara("frmSelectExplorer_列宽", 100, 1208, strTmp)
