...
Private Sub Form_Load()
    ...
    '药品类别
    strPar = zlDatabase.GetPara("住院临嘱药品发送类别", glngSys, p住院医嘱下达, , Array(chkDrug(0), chkDrug(1), chkDrug(2)))
...
Private Function Load诊疗类别() As Boolean
    ...
    str类别s = zlDatabase.GetPara("住院临嘱发送类别", glngSys, p住院医嘱下达, , Array(lblClass, lstClass))
...
Private Sub Form_Unload(Cancel As Integer)
    '保存条件设置
    If mblnOK Then
        Call zlDatabase.SetPara("住院临嘱发送类别", mstr类别s, glngSys, p住院医嘱下达)
        Call zlDatabase.SetPara("住院临嘱药品发送类别", mstr药品, glngSys, p住院医嘱下达)
    End If
End Sub
