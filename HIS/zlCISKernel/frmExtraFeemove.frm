...
Public Function ShowMe(frmParent As Object, ByVal lng病人ID As Long, ByVal lng主页ID As Long, ByVal str挂号单 As String, _
    ...
    On Error GoTo errH
    Set rsTmp = zldatabase.OpenSQLRecord(strSQL, "附费转移", lng病人ID, str挂号单, lng主页ID, lng医嘱ID, str诊疗类别, lng执行部门id)
...
Private Sub cmdOK_Click()
    ...
    With vsList
        ...
        gstrSQL = "Zl_病人医嘱附费_Move(" & mint记录性质 & ",'" & mstrNO & "'," & mint费用性质 & "," & lng医嘱ID & "," & lng发送号 & ")"
        Call zldatabase.ExecuteProcedure(gstrSQL, "附费转移")
    End With
