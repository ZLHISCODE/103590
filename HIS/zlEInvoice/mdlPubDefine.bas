...
Public Const conMenu_Edit_Audit_Add = 6820      '*新增对码(&A)
Public Const conMenu_Edit_Audit_Modify = 6821   '*修改对码(&U)
Public Const conMenu_Edit_Audit_Delete = 6822   '*删除对码(&D)
...
Public Const conMenu_Edit_EInvoice = 5016   '开具电子发票
Public Const conMenu_Edit_PrintEInvoice = 5012  '打印电子发票
Public Const conMenu_Edit_TurnPaper = 4810    '换开纸质票据
Public Const conMenu_Edit_ReTurnPaper = 4812  '重新换开票据
Public Const conMenu_Edit_CancelTurnPaper = 4811  '作废纸质票据
Public Const conMenu_Edit_PrintNotice = 4900  '告知单打印
Public Const conMenu_Edit_SendMsg = 3013 '信息推送
Public Const conMenu_Edit_FlatAccount = 8044 '平账处理
