...
Public Sub ShowColSet(ByVal frmMain As Form, ByVal strTittle As String, vsGrid As Object, _
        ...
        For i = 0 To .Cols - 1
            ...
            If Trim(.ColKey(i)) <> "" And (Val(arrSplit(0)) = 1 Or Val(arrSplit(0)) = 0) Then
                ...
                If Val(arrSplit(0)) = 1 Then
                    vsColSet.Cell(flexcpForeColor, lngRow, 0, lngRow, vsColSet.Cols - 1) = &H8000000A ' vbBlue
                End If
...
Private Sub vsColSet_AfterEdit(ByVal Row As Long, ByVal Col As Long)
    ...
    With vsColSet
        Select Case Col
        Case .ColIndex("选择")
            blnShow = Abs(Val(.TextMatrix(Row, Col))) = 1
