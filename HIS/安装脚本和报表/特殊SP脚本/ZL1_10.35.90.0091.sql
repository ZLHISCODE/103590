...
--过程修正部份
-------------------------------------------------------------------------------
--148883:余伟节,2020-04-26,Zlhis_Patient_006将撤销记录原始的ID一并写入消息关键值XML节点中
...
Create Or Replace Package Body b_Message Is
  ...
  Begin
    If p_Msg_Using('ZLHIS_PATIENT_006') = 0 Then
      Return;
    End If;
    Select Max(id), Max(科室id), Max(病区id), Max(护理等级id), Max(医疗小组id), Max(床号), Max(责任护士), Max(主任医师), Max(主治医师), Max(经治医师), Max(病情)
...
-------------------------------------------------------------------------------
---标准部件信息
EXECUTE Zlfiles_Autoupdate('ZL9LabWork.DLL','B5123386DBD5D97C23BF1CB6D4546431','10.35.90.0091',to_date('2020/4/28 9:35:47','YYYY-MM-DD HH24:MI:SS'),SYSDATE,'1','[APPSOFT]\APPLY','ZL9LabWork.dll','25','新版LIS业务部件','1','1','');
EXECUTE Zlfiles_Autoupdate('ZL9Stuff.dll','3D07718870DD98C2692283507CF1A447','10.35.90.0091',to_date('2020/4/27 9:15:32','YYYY-MM-DD HH24:MI:SS'),SYSDATE,'1','[APPSOFT]\APPLY','zl9Stuff','1','卫材管理部件','1','0','');
-------------------------------------------------------------------------------


------------------------------------------------------------------------------------
--系统版本号
Update zlSystems Set 版本号='10.35.90.0091' Where 编号=&n_System;
Commit;
