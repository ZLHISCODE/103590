...
Public Const conMenu_Edit_StartPath = 3861         '*启用路径
Public Const conMenu_Edit_StopPath = 3862          '*停用路径
Public Const conMenu_View_ShowStopPath = 3863      '*显示停用路径
...
Public Const conMenu_Edit_Medical = 3846
...
Public Const conMenu_Edit_RefundDeposit = 4823
