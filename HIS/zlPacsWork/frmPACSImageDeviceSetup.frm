...
Private Sub cmdOK_Click()
    SaveSetting "ZLSOFT", "私有模块\" & gstrDBUser & "\" & App.ProductName & "\" & Me.Name, "默认影像设备", mstrDeviceName
    Unload Me
End Sub
...
Private Sub Form_Load()
    ...
    '设置设备默认值
    mstrDeviceName = GetSetting("ZLSOFT", "私有模块\" & gstrDBUser & "\" & App.ProductName & "\" & Me.Name, "默认影像设备", "")
