...
Private mstr检查技师一 As String
Private mstr检查技师二 As String
Private mstr执行间 As String

Public Sub ShowMe(objParent As Object, ByVal lngCurDeptId As Long, ByVal lngAdviceID As Long, ByVal lngSendNO As Long, ByRef str检查技师一 As String, _
ByRef str检查技师二 As String, ByRef str执行间 As String)
    mstr检查技师一 = ""
    mstr检查技师二 = ""
    mstr执行间 = ""
...
On Error GoTo ErrorHand
    ...
    If cboRoom.Text = "" Then
        strRoom = ""
    Else
        strRoom = zlStr.NeedCode(cboRoom.Text)
    End If
    
    strSql = "ZL_影像检查记录_发送安排(" & mlngAdviceID & "," & mlngSendNo & ",1," & "'" & zlStr.NeedName(cbo技师一.Text) & "','" & zlStr.NeedName(cbo技师二.Text) & "','" & strRoom & "')"
    ...
    mstr检查技师一 = zlStr.NeedName(cbo技师一.Text)
    mstr检查技师二 = zlStr.NeedName(cbo技师二.Text)
    mstr执行间 = strRoom
...
On Error GoTo ErrorHand
    ...
    Do While Not rsTmp.EOF
        cboRoom.AddItem NVL(rsTmp!执行间) & "-" & NVL(rsTmp!检查设备)
