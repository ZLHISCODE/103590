...
Public Function ShowMe(frmParent As Form, lngOrderID As Long, Optional lngShowBigImg As Long, Optional dblBigImgZoom As Double = 1) As DicomImages
...
Private Sub DViewer_DblClick()
    ...
    If mlngShowBigImg = 1 Or DViewer.Images.Count = 0 Then Exit Sub
