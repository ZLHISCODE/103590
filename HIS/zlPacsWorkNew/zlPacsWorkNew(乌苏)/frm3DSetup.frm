...
Private Sub cmdOK_Click()
    ...
    '保存3D参数
    zlDatabase.SetPara "启用三维重建", chkUse3D.value, glngSys, 1290, InStr(mstrPrivs, ";参数设置;") > 0
    zlDatabase.SetPara "3D程序路径", txt3DExeDir.Text, glngSys, 1290, InStr(mstrPrivs, ";参数设置;") > 0
    zlDatabase.SetPara "3D参数", txt3DPara.Text, glngSys, 1290, InStr(mstrPrivs, ";参数设置;") > 0
    zlDatabase.SetPara "3D自动解压缩", chkAutoDecompress.value, glngSys, 1290, InStr(mstrPrivs, ";参数设置;") > 0
    
    For i = 1 To 6
        If chk3DFunc(i).value = 1 Then str3DFuncs = str3DFuncs & "," & i
    Next i
    zlDatabase.SetPara "3D功能", str3DFuncs, glngSys, 1290, InStr(mstrPrivs, ";参数设置;") > 0
    Unload Me
End Sub
