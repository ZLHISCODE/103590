...
Begin VB.Form frmPatholSpecimen 
   ...
   Begin MSComctlLib.Toolbar tbrMain 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button9 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Caption         =   "接收标本"
            Key             =   "tbAcceptSpecimen"
            ImageIndex      =   6
         EndProperty
         BeginProperty Button10 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Caption         =   "拒收标本"
            Key             =   "tbRejectSpecimen"
            ImageIndex      =   7
         EndProperty
      EndProperty
   End
   Begin VB.Frame Frame2 
      ...
      Begin RichTextLib.RichTextBox txtHistoryRecord 
         ...
         ScrollBars      =   3
         Appearance      =   0
         TextRTF         =   $"frmPatholSpecimen.frx":700E
      End
   End
   Begin VB.Frame Frame1 
      ...
      Begin VB.ListBox lstPartment 
         ...
         EndProperty
         Height          =   2790
         ItemData        =   "frmPatholSpecimen.frx":70AB
         Left            =   7320
         List            =   "frmPatholSpecimen.frx":70AD
         TabIndex        =   7
         Top             =   1080
         Width           =   2415
      End
    ...
    If Not HasMenu(objMenuBar, conMenu_PatholSpecimen) Then
        ...
        With cbrMenuBar.CommandBar
            Set cbrControl = CreateModuleMenu(.Controls, xtpControlPopup, conMenu_PatholSpecimen_LAB, "标签打印(&L)", "", 1, False)
                Set cbrPopControl = CreateModuleMenu(cbrControl.CommandBar.Controls, xtpControlButton, conMenu_PatholSpecimen_PreviewLab, "预览(V)", "", 1, False)
                Set cbrPopControl = CreateModuleMenu(cbrControl.CommandBar.Controls, xtpControlButton, conMenu_PatholSpecimen_PrintLab, "打印(P)", "", 1, False)
                
            Set cbrControl = CreateModuleMenu(.Controls, xtpControlPopup, conMenu_PatholSpecimen_ACP, "凭单打印(&A)", "", 1, False)
                Set cbrPopControl = CreateModuleMenu(cbrControl.CommandBar.Controls, xtpControlButton, conMenu_PatholSpecimen_PreviewAccept, "预览(V)", "", 1, False)
                Set cbrPopControl = CreateModuleMenu(cbrControl.CommandBar.Controls, xtpControlButton, conMenu_PatholSpecimen_PrintAccept, "打印(P)", "", 1, False)
            ...
            Set cbrControl = CreateModuleMenu(.Controls, xtpControlButton, conMenu_PatholSpecimen_Save, "标本保存(&S)", "", 1, False)
            Set cbrControl = CreateModuleMenu(.Controls, xtpControlButton, conMenu_PatholSpecimen_Accept, "标本接收(&R)", "", 0, False)
...
'更新菜单
    ...
    Select Case control.ID
        Case conMenu_PatholSpecimen_LAB
            control.Enabled = blnIsAllowAccept And mlngAdviceID > 0
        
            
        Case conMenu_PatholSpecimen_ACP
            control.Enabled = blnIsAllowAccept And mlngAdviceID > 0
...
'配置权限
    ...
    tbrMain.Buttons("tbAcceptSpecimen").Enabled = blnIsAllowAccept And Not blnIsReadOnly
'    cmdAccept.Enabled = blnIsAllowAccept And Not blnIsReadOnly
'    cmdAutoGet.Enabled = blnIsAllowAccept  And Not blnIsReadOnly
    
    tbrMain.Buttons("tbDelSpecimen").Enabled = blnIsAllowAccept And Not blnIsReadOnly
'    cmdDelSpecimen.Enabled = blnIsAllowAccept And Not blnIsReadOnly

    tbrMain.Buttons("tbRejectSpecimen").Enabled = blnIsAllowAccept And Not blnIsReadOnly
'    cmdReject.Enabled = blnIsAllowAccept And Not blnIsReadOnly

    tbrMain.Buttons("tbSaveSpecimen").Enabled = blnIsAllowAccept And Not blnIsReadOnly
'    cmdSave.Enabled = blnIsAllowAccept And Not blnIsReadOnly
    
    tbrMain.Buttons("tbLAB").Enabled = blnIsAllowAccept
'    cmdLabPrint.Enabled = blnIsAllowAccept

    tbrMain.Buttons("tbACP").Enabled = blnIsAllowAccept
'    cmdPrintSelect.Enabled = blnIsAllowAccept
'    cmdAcceptPrint.Enabled = blnIsAllowAccept
...
Private Sub AdjustFace()
    '调整界面布局
    Frame1.Left = 0
    Frame1.Top = tbrMain.Top + tbrMain.Height + 120
    Frame1.Width = Me.Width - 0
    Frame1.Height = Me.Height - Frame2.Height - tbrMain.Height - 300
    ...
    labRecordInf.Top = Frame1.Height - labRecordInf.Height - 120 + IIf(mbytFontSize = 9, 0, 85)
    ...
    txtHistoryRecord.Top = 240 + IIf(mbytFontSize = 9, 0, 120)
    txtHistoryRecord.Width = Frame2.Width - 240
    txtHistoryRecord.Height = Frame2.Height - 360 + IIf(mbytFontSize = 9, 0, -120)
    
    
    
'    '调整frame3的内容
'    Frame3.Left = 120
'    Frame3.Top = Me.Height - Frame3.Height - 120
'    Frame3.Width = Me.Width - 240
'
'    cmdReject.Left = Frame3.Width - cmdReject.Width
'    cmdReject.Top = 120
'
'    cmdAccept.Left = cmdReject.Left - cmdAccept.Width - 120
'    cmdAccept.Top = 120
'
'    cmdSave.Left = cmdAccept.Left - cmdSave.Width - 120
'    cmdSave.Top = 120
'
'    cmdDelSpecimen.Left = cmdSave.Left - cmdDelSpecimen.Width - 120
'    cmdDelSpecimen.Top = 120
'
'    cmdAutoGet.Left = cmdDelSpecimen.Left - cmdAutoGet.Width - 120
'    cmdAutoGet.Top = 120
'
'    cmdLabPrint.Left = 0
'    cmdLabPrint.Top = 120
'
'    cmdPrintSelect.Left = cmdLabPrint.Left + cmdLabPrint.Width
'    cmdPrintSelect.Top = 120
'
'    cmdAcceptPrint.Left = cmdPrintSelect.Left + cmdPrintSelect.Width + 120
'    cmdAcceptPrint.Top = 120
'
'
    labSpecimenName.Left = ufgData.Left + ufgData.Width + 120
    labSpecimenName.Top = ufgData.Top + IIf(mbytFontSize = 9, 0, 120)
'
...
'配置特检界面
    ...
    tbrMain.Buttons("tbAcceptSpecimen").Enabled = blnIsValid
    tbrMain.Buttons("tbRejectSpecimen").Enabled = blnIsValid
    tbrMain.Buttons("tbGetSpecimen").Enabled = blnIsValid
    tbrMain.Buttons("tbDelSpecimen").Enabled = blnIsValid
    tbrMain.Buttons("tbSaveSpecimen").Enabled = blnIsValid
    tbrMain.Buttons("tbLAB").Enabled = blnIsValid
    tbrMain.Buttons("tbACP").Enabled = blnIsValid
...
On Error GoTo errHandle
    Select Case UCase(Button.Key)
        ...
        Case UCase("tbACP"), UCase("tbACPPreview")
            '默认弹出预览窗口
            Call PrintAcceptNotification(False)

        Case UCase("tbACPPrint")
            Call PrintSpecimenLabel(True)
        
        Case UCase("tbGetSpecimen")
            '调用自动提取信息方法
            Call AutoGetSpecimenInf
            
        Case UCase("tbDelSpecimen")
            '删除标本
            Call DelSelectionSpecimen
        
        Case UCase("tbSaveSpecimen")
            '保存标本
            Call SaveCurSpecimenInf
            
        Case UCase("tbAcceptSpecimen")
            '标本接收
            Call SpecimenAccept
            
        Case UCase("tbRejectSpecimen")
            '标本拒收
            Call SpecimenReject
    End Select
Exit Sub
