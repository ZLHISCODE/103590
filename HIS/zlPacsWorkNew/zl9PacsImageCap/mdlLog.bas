...
Private Const G_STR_PROJECT = "PACSIMAGECAP"
...
Public Sub zlWritLog(ByVal strFuncName As String, ByVal strLogInfor As String, ParamArray arrPars() As Variant)
    ...
    If gobjlog Is Nothing Then
        ...
        Call gobjlog.SetBusinessDB(gcnVideoOracle)
    End If
    varPara = arrPars
    If gobjlog Is Nothing Then Exit Sub
    Call gobjlog.Log(G_STR_LOG_NAME, G_STR_PROJECT, 1291, strFuncName, EM_Trace, strLogInfor, varPara)
End Sub
