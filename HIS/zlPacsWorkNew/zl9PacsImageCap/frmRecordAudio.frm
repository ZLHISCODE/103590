...
Private Sub Form_Load()
    ...
    '判断如果临时目录不存在，则进行创建
    If Dir(GetAppPath & "\TmpImage", vbDirectory) = "" Then
        Call MkDir(GetAppPath & "\TmpImage")
    End If
    
    mstrRecordBufferFile = GetAppPath & "\TmpImage\WavBuffer.wav"
...
On Error GoTo errHandle
    ...
    If Trim(dlgSaveAs.FileName) <> "" Then Call FileCopy(mstrRecordBufferFile, dlgSaveAs.FileName)
