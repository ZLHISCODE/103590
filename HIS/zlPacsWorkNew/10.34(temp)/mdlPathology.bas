...
'制片显示列
Public Const gstrSlicesCols As String = "|制片ID>ID,key,w1000,hide,uncfg|材块ID,hide,uncfg|材块号>序号,w1000,align<2,0>,uncfg|取材位置|标本名称,uncfg|制片数|制片类型|制片方式|制片时间,fulldatetime,w2400|制片人|当前状态|清单状态|"
...
Public Const gstrSlices_制片人     As String = "制片人"
...
'特检信息显示列
Public Const gstrSpeExamCols As String = "|特检ID>ID,key,read,w1000,hide,uncfg|材块ID,hide,uncfg|材块号>序号,read,w1000,align<2,0>,uncfg|标本名称,read,uncfg|申请ID,hide,uncfg|抗体ID,hide,uncfg|抗体名称,btn,read,uncfg|特检细目,read|制作类型,read|特检医师,read|申请时间,fulldatetime,read,w2400|完成时间,fulldatetime,read,w2400|当前状态,read|清单状态,read|特检类型,hide,uncfg|"
...
Public Const gstrSpeExam_特检医师 As String = "特检医师"
