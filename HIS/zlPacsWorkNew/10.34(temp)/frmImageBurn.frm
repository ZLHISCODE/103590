...
'显示刻录窗口
Public Sub ShowBurn(ByVal lngCurAdviceId As Long, ByVal blnMoved As Boolean, owner As Object)
...
'获取预览图像数据
    ...
    strSQL = "select /*+RULE*/ * from (" & strSQL & " order by b.序列UID, a.图像号) " & IIf(blnIsAllData, "", " where 顺序号>=" & lngStartRecord & " and 顺序号<=" & lngEndRecord)
