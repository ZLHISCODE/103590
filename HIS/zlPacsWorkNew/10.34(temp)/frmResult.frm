...
Public Function zlGetResult(frmParent As Form, ByVal lngModul As Long, ByVal lngOrderID As Long, lngCur科室ID As Long, strResultInput As String) As String
    ...
    Set rsTemp = zlDatabase.OpenSQLRecord(strSql, "提取报告结果", mlngOrderID)
    ...
    If blnShowResult = False And blnShowCriticalValues = False And blnShowImageLevel = False And blnShowReportLevel = False And blnShowFuHeLevel = False Then Exit Function
