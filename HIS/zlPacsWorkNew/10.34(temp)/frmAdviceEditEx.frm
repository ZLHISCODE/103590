...
Private Sub Form_Load()
    ...
    If mbytUseType = 1 Then
        ...
        If mintType = 0 And mblnEdit = True Then vsExt.Editable = flexEDKbdMouse
...
'    End If
    ...
    If strNoneRegion <> "" Then
        ...
        Else
            ...
            '如果是出现了不适合或不存在的部位或方法，则允许编辑调整部位方法
            mblnEdit = True
        End If
    End If
...
Private Sub ShowWordInput(Optional ByVal bln人员 As Boolean)
'功能：显示词句输入
