...
Begin VB.Form frmReportImageEdit 
   ...
   Begin VB.CommandButton cmdInsert 
      Height          =   375
      Left            =   6600
      Picture         =   "frmReportImageEdit.frx":1184
      Style           =   1  'Graphical
      TabIndex        =   5
...
Private Sub cbrMain_Resize()
    ...
    Me.cbxMemoText.Left = Me.lblMemoText.Left + Me.lblMemoText.Width + 200 - cmdInsert.Width - cmdFont.Width
...
'功能：读取并加入常用备注
    ...
    strSql = _
        " Select 名称 From 影像图像备注 Where 名称 is Not Null And 人员=[1]" & _
        " Union" & _
        " Select 名称 From 影像图像备注 Where 名称 is Not Null And 人员 is Null" & _
        " Order by 名称"
    Set rsTmp = zlDatabase.OpenSQLRecord(strSql, Me.Caption, UserInfo.姓名)
    Do While Not rsTmp.EOF
        AddComboItem cbxMemoText.hWnd, CB_ADDSTRING, 0, rsTmp!名称
        rsTmp.MoveNext
    Loop
