...
Public Sub zlRefresh()
    ...
    Call ConfigEditable(gblnEditable)
...
Private Sub Command1_Click()
    Call gobjParent.SendReport("Test1", "Test2", "Test3")
End Sub

Private Sub Command2_Click()
    Call gobjParent.ClearReport(False, True, False)
End Sub
...
Private Sub Command3_Click()
    ...
    Call gobjParent.GetReport(strDescription, strResult, strAdvice)
    
    MsgBox "描述：" & strDescription & vbCrLf & "结果：" & strResult & vbCrLf & "意见：" & strAdvice
End Sub
