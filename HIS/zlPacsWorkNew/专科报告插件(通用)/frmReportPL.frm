...
Begin VB.Form frmReportPL 
   ...
   Begin VB.Frame frmCell 
      ...
      Begin VB.ComboBox cbo化生细胞 
         Height          =   300
         ItemData        =   "frmReportPL.frx":0000
         Left            =   960
         List            =   "frmReportPL.frx":000A
      ...
      Begin VB.ComboBox cbo颈管细胞 
         Height          =   300
         ItemData        =   "frmReportPL.frx":0016
         Left            =   960
         List            =   "frmReportPL.frx":0020
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   320
         Width           =   800
   ...
   Begin VB.Frame frmMicrobe 
      ...
      Begin VB.ComboBox cboHPV感染 
         Height          =   300
         ItemData        =   "frmReportPL.frx":002C
         Left            =   6720
         List            =   "frmReportPL.frx":0036
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   720
         Width           =   800
      ...
      Begin VB.ComboBox cbo疱疹病毒感染 
         Height          =   300
         ItemData        =   "frmReportPL.frx":0042
         Left            =   3960
         List            =   "frmReportPL.frx":004C
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   720
         Width           =   800
      ...
      Begin VB.ComboBox cbo球杆菌感染 
         Height          =   300
         ItemData        =   "frmReportPL.frx":0058
         Left            =   1320
         List            =   "frmReportPL.frx":0062
         Style           =   2  'Dropdown List
         TabIndex        =   1
         Top             =   720
         Width           =   800
      ...
      Begin VB.ComboBox cbo放线菌感染 
         Height          =   300
         ItemData        =   "frmReportPL.frx":006E
         Left            =   6720
         List            =   "frmReportPL.frx":0078
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   360
         Width           =   800
      ...
      Begin VB.ComboBox cbo念珠菌感染 
         Height          =   300
         ItemData        =   "frmReportPL.frx":0084
         Left            =   3960
         List            =   "frmReportPL.frx":008E
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   360
         Width           =   800
      ...
      Begin VB.ComboBox cbo滴虫感染 
         Height          =   300
         ItemData        =   "frmReportPL.frx":009A
         Left            =   1320
         List            =   "frmReportPL.frx":00A4
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Top             =   360
         Width           =   800
...
Public Sub zlRefresh()
    ...
    '设置界面控件是否可以编辑
    frmMicrobe.Enabled = gblnEditable
    frmCell.Enabled = gblnEditable
