...
Public Const conMenu_Process_ReValidAll = 101     '重新校对所有图像
Public Const conMenu_Process_UpDownALL = 102      '重新上传所有图像
Public Const conMenu_Process_ReValid = 103     '重新校对当前图像或检查
Public Const conMenu_Process_UpDown = 104      '重新上传当前图像或检查
Public Const conMenu_Process_Ignore = 106      '忽略当前图像
Public Const conMenu_Process_Exit = 105     '退出
