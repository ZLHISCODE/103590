...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame Frame5 
      ...
      Top             =   4260
      Width           =   4695
      Begin VB.CheckBox chkPersonSec 
         Caption         =   "姓名隐私保护"
         Height          =   255
         Left            =   2880
         TabIndex        =   31
...
On Error GoTo ErrorHand
    ...
    chkPersonSec.value = Val(GetSetting("ZLSOFT", G_STR_REGPATH, "姓名隐私保护", 1))
...
On Error GoTo ErrorHand1
    ...
    SaveSetting "ZLSOFT", G_STR_REGPATH, "姓名隐私保护", chkPersonSec.value
