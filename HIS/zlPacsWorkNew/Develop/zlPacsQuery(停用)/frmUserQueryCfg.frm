...
Begin VB.Form frmUserQueryCfg 
   ...
   Begin VB.Image imgNoCheck 
      Height          =   252
      Left            =   240
      Picture         =   "frmUserQueryCfg.frx":000C
      Stretch         =   -1  'True
      Tag             =   "0"
      Top             =   5160
      Visible         =   0   'False
   ...
   Begin VB.Image imgCheck 
      Height          =   252
      Left            =   240
      Picture         =   "frmUserQueryCfg.frx":037E
      Stretch         =   -1  'True
      Tag             =   "1"
      Top             =   5520
      Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmUserQueryCfg"
