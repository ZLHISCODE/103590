...
'Public Function CollectionExistKey(ByVal objColl As Collection, ByVal vKey As Variant) As Boolean
''判断集合关键字是否存在
'On Error Resume Next
'
'    objColl.Item vKey
'
'    CollectionExistKey = (Err.Number = 0)
'
'    Err.Clear
'
'End Function

Public Function SqlVerify(strSql As String) As String
