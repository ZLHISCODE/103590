...
Public Function ShowScRowRelation(ObjScShowCfg As clsScShowCfg, strCurDataChange As String, strPerformCol As String, blnIsEnabled As Boolean, ower As Object) As clsScShowCfg
