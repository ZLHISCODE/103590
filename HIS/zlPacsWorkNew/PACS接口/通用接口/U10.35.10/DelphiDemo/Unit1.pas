...
uses
  ...
  Dialogs, StdCtrls, ComCtrls, ExtCtrls;    //zlPacsInterface_TLB
...
type
  ...
  private
    ...
    ipacs: Variant;// _clsPacsInterface;

    //procedure ReadQueryData(var objPacsInterface: _clsPacsInterface; var objCurListView: TListView);
    procedure ReadQueryData(var objPacsInterface: Variant; var objCurListView: TListView);
  public
    { Public declarations }
  end;
...
begin
  ipacs := CreateOleObject('zlPacsInterface.clsPacsInterface');// CoclsPacsInterface.create;
...
begin
  ...
  ipacs.InitInterface(StrToInt(edtPartId.Text), edtOracleInstanceName.Text, edtOracleUserName.Text,
...
procedure TForm1.ReadQueryData(var objPacsInterface: Variant ; var objCurListView: TListView);
//**********************************************************
//
