...
Public gstrHISIP As String                   'HIS数据库服务器的IP地址
Public gstrUser As String                    'HIS数据库用户名
Public gstrPassw As String                   'HIS数据库密码
...
Public Sub Main()
    ...
    gstrPACSUser = GetSetting("ZLSOFT", "PACS回传", "PACS用户名", "zlhis")
    gstrPACSPassw = GetSetting("ZLSOFT", "PACS回传", "PACS密码", "u2k")
    gstrPACSsid = GetSetting("ZLSOFT", "PACS回传", "PACSsid", "orcl")
'
'
    gstrHISIP = GetSetting("ZLSOFT", "PACS回传", "HISIP地址", "200.200.200.3")
    gstrUser = GetSetting("ZLSOFT", "PACS回传", "HIS用户名", "pacs")
    gstrPassw = GetSetting("ZLSOFT", "PACS回传", "HIS密码", "pacs")
    glngInterval = GetSetting("ZLSOFT", "PACS回传", "监听间隔", "5")
