...
Private Sub Command2_Click()
    Call iPacs.DeleteElectrocardioReport(8803)
    
    Call iPacs.SendElectrocardioReport(8803, "心电报告测试", _
        "E:\ZLHIS\ZLPacsWork\心电接口\Ecg1.jpg#E:\ZLHIS\ZLPacsWork\心电接口\Ecg2.jpg", _
        "心电检查所见", "心电检查建议", "报告一声", "")
...
Private Sub Command4_Click()
    Dim strError As String
    strError = iPacs.PrintReport(2303, True)
