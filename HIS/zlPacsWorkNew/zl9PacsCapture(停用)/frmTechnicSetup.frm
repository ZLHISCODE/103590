...
On Error GoTo ErrHandle
    ...
    Call zlDatabase.SetPara("启动视频源", chkStartupVideo.value, glngSys, mlngModul, InStr(mstrPrivs, ";参数设置;") > 0)
...
Private Sub Form_Load()
    ...
    chkStartupVideo.value = Val(zlDatabase.GetPara("启动视频源", glngSys, mlngModul, "1", Array(chkStartupVideo), InStr(mstrPrivs, ";参数设置;") > 0))
...
Private Sub PicAction_Resize()
    ...
    If mlngModul <> G_LNG_PATHOLSYS_NUM Then
        ...
        chkStartupVideo.Left = chkStartupVideo.Left
        chkStartupVideo.Top = chkExitAfterSign.Top
        
        chkStartVideoCapture.Left = 240
        chkStartVideoCapture.Top = chkExitAfterSign.Top + chkExitAfterSign.Height + 105
