...
Private Const G_STR_PROJECT = "PACSWORK"
...
End Enum
Public Sub zlWritLog(ByVal strFuncName As String, ByVal strLogInfor As String, ByVal intLevel As gLogLevel, ParamArray arrPars() As Variant)
'intLevel 日志级别
    '---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Call gobjlog.Log(G_STR_LOG_NAME, G_STR_PROJECT, CStr(glngModul), strFuncName, intLevel, strLogInfor, varPara)
End Sub
