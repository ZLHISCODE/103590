...
Object = "{5C493D4E-FD57-4FF4-9BA4-C6C670BFF9A7}#49.0#0"; "zl9PacsControl.ocx"
    ...
    If Trim(strPlayFile) <> "" Then
        If Trim(Dir(strPlayFile)) <> "" Then
            ...
            If Trim(sErrMsg) <> "" Then
                Call MsgboxEx(Me, sErrMsg, vbOKOnly, G_STR_HINT_TITLE)
                Exit Sub
            End If
...
Private Sub VideoSaveAs()
    ...
    If Trim(DSPlayer.videoFile) = "" Then
        MsgboxEx Me, "没有可另存的视频文件。", vbOKOnly Or vbInformation, G_STR_HINT_TITLE
        Exit Sub
    End If
