...
// *****************************************************************************
  ...
  private
    ...
    function GetFullHandle: THandle;
    procedure SetFullHandle(const Value: THandle);
  protected
  ...
  published
    ...
    property FullHandle: THandle read GetFullHandle write SetFullHandle;
...
function TVideoWindow.GetFullHandle: THandle;
begin
  if FFullHandle = 0 then
    Result := Handle
  else
    Result := FFullHandle;
end;

procedure TVideoWindow.SetFullHandle(const Value: THandle);
begin
  FFullHandle := Value;
end;
