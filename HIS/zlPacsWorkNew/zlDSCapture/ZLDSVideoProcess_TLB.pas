...
// PASTLWTR : 1.2
// File generated on 2018-12-5 15:32:52 from Type Library described below.

// ************************************************************************  //
// Type Lib: Y:\PROGRAM\Capture Com(Delphi)\ZLDSVideoProcess.tlb (1)
...
// *********************************************************************//
  IDSCapture = interface(IDispatch)
    ...
    property CurTiming: Integer read Get_CurTiming;
  end;
...
// *********************************************************************//
  IDSCaptureDisp = dispinterface
    ...
    procedure StartTiming(IsSysTime: WordBool); dispid 267;
    procedure CloseTiming; dispid 268;
    property CurTiming: Integer readonly dispid 269;
  end;
...
// *********************************************************************//
  ...
  public
    ...
    procedure StartTiming(IsSysTime: WordBool);
    procedure CloseTiming;
    ...
    property CurTiming: Integer index 269 read GetIntegerProp;
  published
    property Anchors;
    property  ParentColor;
    property  ParentFont;
...
begin
  DefaultInterface.StartTiming(IsSysTime);
end;

procedure TDSCapture.CloseTiming;
begin
  DefaultInterface.CloseTiming;
end;
