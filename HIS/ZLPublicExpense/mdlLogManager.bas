...
Public Const G_STR_LOG_NAME = "一卡通接口调试日志"
...
End Sub
Public Sub WritLogCall(ByVal strLogName As String, ByVal strFuncName As String, strCallName As String, lcsCurentLogCallState As gLogCallState, _
...
End Sub
Public Sub WritLog(ByVal strLogName As String, ByVal strFuncName As String, ByVal strLogInfor As String, ParamArray arrPars() As Variant)
    '---------------------------------------------------------------------------------------------------------------------------------------------
    '功能:日志跟踪
    '入参:
    '返回:成功返回true,否则返回False
...
'    ByVal strLogInfor As String, Optional ByVal intLogType As Integer = 0, Optional strLogName As String = "一卡通接口调试日志", _
'    Optional strGroupName As String, Optional strBusinessName As String = "一卡通")
'    '---------------------------------------------------------------------------------------------------------------------------------------------
'    '功能:日志写入
...
'    If zlGetLogManagerObject(objLogManager) = False Then
'        Call gobjComlib.LogWrite(strLogName, lngModule, strBusinessName, "调用者:" & strCallFunName & IIf(strGroupName = "", "", "-" & strGroupName) & vbTab & strLogInforEx)
'        Exit Sub
'    End If
'    If objLogManager Is Nothing Then Exit Sub
