...
Private Sub Form_Load()
    ...
    '读取可用公用预交领用，36984
    If zlGetExpenceSvrObject(objExpenceSvr) = False Then Unload Me: Exit Sub
    If objExpenceSvr.zl_ExseSvr_GetReceiveInvoice(2, "", Nothing, False, _
        "2", "", 0, True, , mlngModule, 1, True, rsTmp) = False Then Unload Me: Exit Sub
