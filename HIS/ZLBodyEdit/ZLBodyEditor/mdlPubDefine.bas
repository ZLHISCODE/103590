...
Public Const conMenu_Manage_First = 8304         '第一级
Public Const conMenu_Manage_Second = 8305        '第二级
Public Const conMenu_Manage_Third = 8396         '第三级
Public Const conMenu_Manage_Fourth = 8397        '第四级
...
Public Const conMenu_PatholSpecimen_PrintAll = 3941         '打印所有
Public Const conMenu_PatholSpecimen_PreviewAll = 3942       '预览所有
Public Const conMenu_PatholSpecimen_PrintSingle = 3943      '单个打印
Public Const conMenu_PatholSpecimen_PreviewSingle = 3944    '单个预览
Public Const conMenu_PatholSpecimen_PrintAccept = 3945      '打印核收单
Public Const conMenu_PatholSpecimen_PreviewAccept = 3946     '打印核收单
...
Public Const conMenu_PatholSlices_PrintAll = 3961           '打印所有
Public Const conMenu_PatholSlices_PreviewAll = 3962         '预览所有
Public Const conMenu_PatholSlices_PrintSingle = 3963        '单个打印
Public Const conMenu_PatholSlices_PreviewSingle = 3964      '单个预览
...
Public Const conMenu_PatholSpeExam_PrintAll = 3991          '打印所有
Public Const conMenu_PatholSpeExam_PreviewAll = 3992        '预览所有
Public Const conMenu_PatholSpeExam_PrintSingle = 3993       '单个打印
Public Const conMenu_PatholSpeExam_PreviewSingle = 3994     '单个预览
Public Const conMenu_PatholSpeExam_List = 3995              '清单打印
Public Const conMenu_PatholSpeExam_RequestView = 3996       '申请查看
Public Const conMenu_PatholSpeExam_Accept = 3997            '特检接受
Public Const conMenu_PatholSpeExam_Finish = 3998            '特检完成
...
Public Const conMenu_Reserve_07 = 3952
Public Const conMenu_Reserve_08 = 3954
Public Const conMenu_Reserve_09 = 3958
Public Const conMenu_Reserve_21 = 4110
Public Const conMenu_Reserve_22 = 4115
