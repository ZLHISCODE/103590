...
Private Sub cmdOK_Click()
    ...
    '保存打印参数
    Call zlDatabase.SetPara("体温单打印机", mstrPrinter, glngSys, 1255, InStr(mstrPrivs, "护理选项设置") > 0)
    Call zlDatabase.SetPara("体温单纸张", mintPage, glngSys, 1255, InStr(mstrPrivs, "护理选项设置") > 0)
    Call zlDatabase.SetPara("体温单宽度", mlngWidth, glngSys, 1255, InStr(mstrPrivs, "护理选项设置") > 0)
    Call zlDatabase.SetPara("体温单高度", mlngHeight, glngSys, 1255, InStr(mstrPrivs, "护理选项设置") > 0)
    Call zlDatabase.SetPara("体温单纸向", mintOrient, glngSys, 1255, InStr(mstrPrivs, "护理选项设置") > 0)
    Call zlDatabase.SetPara("体温单进纸", mintBin, glngSys, 1255, InStr(mstrPrivs, "护理选项设置") > 0)
    Call zlDatabase.SetPara("体温单左边距", mlngLeft, glngSys, 1255, InStr(mstrPrivs, "护理选项设置") > 0)
    Call zlDatabase.SetPara("体温单右边距", mlngRight, glngSys, 1255, InStr(mstrPrivs, "护理选项设置") > 0)
    Call zlDatabase.SetPara("体温单上边距", mlngTop, glngSys, 1255, InStr(mstrPrivs, "护理选项设置") > 0)
    Call zlDatabase.SetPara("体温单下边距", mlngBottom, glngSys, 1255, InStr(mstrPrivs, "护理选项设置") > 0)
...
'    初始化打印参数
    ...
    mstrPrinter = zlDatabase.GetPara("体温单打印机", glngSys, 1255, Printer.DeviceName, Array(cboPrinter), InStr(mstrPrivs, "护理选项设置") > 0)
    mintPage = Val(zlDatabase.GetPara("体温单纸张", glngSys, 1255, Printer.PaperSize, Array(cboPage), InStr(mstrPrivs, "护理选项设置") > 0))
    mlngWidth = Val(zlDatabase.GetPara("体温单宽度", glngSys, 1255, Printer.Width, Array(txtWidth, UDWidth), InStr(mstrPrivs, "护理选项设置") > 0))
    mlngHeight = Val(zlDatabase.GetPara("体温单高度", glngSys, 1255, Printer.Height, Array(txtHeight, UDHeight), InStr(mstrPrivs, "护理选项设置") > 0))
    mintOrient = Val(zlDatabase.GetPara("体温单纸向", glngSys, 1255, Printer.Orientation, Array(opt纵向, opt横向), InStr(mstrPrivs, "护理选项设置") > 0))
    mintBin = Val(zlDatabase.GetPara("体温单进纸", glngSys, 1255, Printer.PaperBin, Array(cboBin), InStr(mstrPrivs, "护理选项设置") > 0))
    mlngLeft = Val(zlDatabase.GetPara("体温单左边距", glngSys, 1255, OFFSET_LEFT, Array(txt左, UD左), InStr(mstrPrivs, "护理选项设置") > 0))
    mlngRight = Val(zlDatabase.GetPara("体温单右边距", glngSys, 1255, OFFSET_RIGHT, Array(txt右, UD右), InStr(mstrPrivs, "护理选项设置") > 0))
    mlngTop = Val(zlDatabase.GetPara("体温单上边距", glngSys, 1255, OFFSET_TOP, Array(txt上, UD上), InStr(mstrPrivs, "护理选项设置") > 0))
    mlngBottom = Val(zlDatabase.GetPara("体温单下边距", glngSys, 1255, OFFSET_BOTTOM, Array(txt下, UD下), InStr(mstrPrivs, "护理选项设置") > 0))
