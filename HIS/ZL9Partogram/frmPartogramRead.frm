...
Public Function PrintRTBData(ByVal objOutTo As Object, ByVal blnHead As Boolean, ByVal lngCurY As Long, Optional ByVal strPage As String = "", Optional ByVal strPageFoot As String = "") As Boolean
    ...
    objOutTo.CurrentY = objOutTo.Height - objOutTo.ScaleX(Val(lngCurY * sinTwipsPerPixelY / 56.7), vbMillimeters, vbTwips) - 5
    
    If blnHead Then
        objOutTo.Print ""
    Else
        lngFoot = 180
        Select Case Val(strPageFoot)
        Case 0
            strPage = ""
        Case 1
            objOutTo.CurrentX = objOutTo.ScaleX(gPrinter.lngLeft, vbMillimeters, vbTwips) + 5
        Case 3
            objOutTo.CurrentX = objOutTo.Width - objOutTo.ScaleX(gPrinter.lngRight, vbMillimeters, vbTwips) - 90 * LenB(StrConv(strPage, vbFromUnicode)) - 5
        Case Else
