...
Public Function IsAllWindowClosed(ByVal lngBrwHwnd As Long) As Boolean
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.IsAllWindowClosed", lngBrwHwnd)
    ...
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.IsAllWindowClosed", IsAllWindowClosed)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.IsAllWindowClosed") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Public Function ClickCurrentWindow(ByVal lngBrwHwnd As Long, ByRef strMsg As String) As Boolean
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.ClickCurrentWindow", lngBrwHwnd, strMsg)
    ...
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.ClickCurrentWindow", ClickCurrentWindow)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.ClickCurrentWindow") = 1 Then
        Resume
    End If
End Function
...
Private Function CloseOneWindown(ByVal lngHwnd As Long) As String
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.CloseOneWindown", lngHwnd)
    ...
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.CloseOneWindown", CloseOneWindown)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.CloseOneWindown") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
'    Dim arrRet()        As Variant
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.GetAllWindows", lngCurPID, lngVBMain)
...
'            arrRet(UBound(arrRet)) = Array(lngNext, lngOwner, lngPop, IsWindowEnabled(lngNext), strClass, strWinText)
    ...
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.GetAllWindows", GetAllWindows)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.GetAllWindows") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Private Function GetAllChild(ByVal lngFrmHwnd As Long, Optional ByVal blnNormalWin As Boolean) As Variant
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.GetAllChild", lngFrmHwnd)
    ReDim Preserve arrRet(0)
    ...
    Loop
    GetAllChild = arrRet
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.GetAllChild", UBound(GetAllChild))
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.GetAllChild") = 1 Then
        Resume
    End If
End Function
...
Private Sub GetAllChildSub(ByVal lngParentHwnd As Long, Optional ByVal blnNormalWin As Boolean, Optional ByRef arrRet As Variant, Optional ByVal lngLevel As Long = 0)
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.GetAllChildSub", lngParentHwnd, UBound(arrRet), lngLevel)
    If lngLevel < 2 Then
        ...
        Loop
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.GetAllChildSub", UBound(arrRet))
    Exit Sub
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.GetAllChildSub") = 1 Then
        Resume
    End If
End Sub
...
Public Function IsTopModal(ByVal lngBrwHwnd As Long, Optional ByVal lngTopWin As Long) As Boolean
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.IsTopModal", lngBrwHwnd, lngTopWin)
    If mlngVBMain = 0 Then mlngVBMain = FindVBMain(lngBrwHwnd)
    If mlngPid = 0 Then mlngPid = GetCurrentProcessId
    If lngTopWin = 0 Then
    ...
    Else
        IsTopModal = True
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.IsTopModal", lngTopWin, lngBrwHwnd, IsTopModal)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.IsTopModal") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Private Function IsCanDoMessage(ByVal lngTopWin As Long) As Boolean
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.IsCanDoMessage", lngTopWin)
    IsCanDoMessage = True
    ...
    If IsCanDoMessage Then
        ...
        End If
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.IsCanDoMessage", IsCanDoMessage)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.IsCanDoMessage") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Private Function FindVBMain(ByVal lngBrwHwnd As Long) As Long
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.FindVBMain", lngBrwHwnd)
    ...
    Do While lngOwner <> 0
        ...
        End If
    Loop
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.FindVBMain", FindVBMain)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.FindVBMain") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Private Function FindExitButtonNormal(ByVal lngMainFrm As Long) As Long
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.FindExitButtonNormal", lngMainFrm)
    ...
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.FindExitButtonNormal", FindExitButtonNormal, FindExitButtonNormal)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.FindExitButtonNormal") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Private Function FindExitButtonMsgBox(ByVal lngMainFrm As Long, ByRef strMsg As String) As Long
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.FindExitButtonMsgBox", lngMainFrm, strMsg)
    ...
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.FindExitButtonMsgBox", FindExitButtonMsgBox, strErr)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.FindExitButtonMsgBox") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Private Function FindExitButtonErrCenter(ByVal lngMainFrm As Long, ByRef strMsg As String) As Long
    ...
    Dim lngToolBarHwnd  As Long
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.FindExitButtonErrCenter", lngMainFrm, strMsg)
    arrChild = GetAllChild(lngMainFrm)
    For i = 1 To UBound(arrChild)
        strClass = arrChild(i)(WI_Class)
        strWinText = arrChild(i)(WI_Text)
    ...
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.FindExitButtonErrCenter", FindExitButtonErrCenter, strError)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.FindExitButtonErrCenter") = 1 Then
        Resume
    End If
End Function
...
'    Dim vRect       As RECT, pCenter As POINTAPI
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.ClickButton", lngMainFrm, lngBtnHwnd)
    '防止多次触发Active时间
...
'    PostMessage lngBtnHwnd, BM_CLICK, 0, 0 '单击按钮
    ...
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.ClickButton")
    Exit Sub
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.ClickButton") = 1 Then
        Resume
    End If
End Sub
...
Public Sub ClickMenuExit(ByVal lngMainFrm As Long)
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.ClickMenuExit", lngMainFrm)
    '防止多次触发Active时间
    If GetForegroundWindow() <> lngMainFrm Then
        Call SetForegroundWindow(lngMainFrm)
    End If
    ...
    If lngReturnValue <> 0 Then
        ...
        End If
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlBrw.mdlAutoClick.ClickMenuExit", lngReturnValue, lngResult, Err.LastDllError)
    Exit Sub
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlBrw.mdlAutoClick.ClickMenuExit") = 1 Then
        Resume
    End If
End Sub
'--------------------------------------------------------------------------------------------------
