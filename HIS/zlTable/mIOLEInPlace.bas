Attribute VB_Name = "mIOLEInPlace"
Option Explicit

' =================================================================================================================
' 用于替换标准的 IOLEInPlaceActiveObject 接口，控制VB控件的Focus事件，实现捕捉Tab按键的功能
' =================================================================================================================
Private Type GUID
    Data1 As Long
    Data2 As Integer
...
Public Type IPAOHookStruct 'IOleInPlaceActiveObjectHook
    ...
    TBEx As Table   'Un-AddRefed native class pointer for making Friend calls
    ThisPointer As Long
End Type
