...
Public Function IsAllWindowClosed(ByVal lngBrwHwnd As Long) As Boolean
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.IsAllWindowClosed", lngBrwHwnd)
    ...
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.IsAllWindowClosed", IsAllWindowClosed)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.IsAllWindowClosed") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Public Function ClickCurrentWindow(ByVal lngBrwHwnd As Long, ByRef strMsg As String) As Boolean
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.ClickCurrentWindow", lngBrwHwnd, strMsg)
    ...
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.ClickCurrentWindow", ClickCurrentWindow)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.ClickCurrentWindow") = 1 Then
        Resume
    End If
End Function
...
Private Function CloseOneWindown(ByVal lngHwnd As Long) As String
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.CloseOneWindown", lngHwnd)
    ...
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.CloseOneWindown", CloseOneWindown)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.CloseOneWindown") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
'    Dim arrRet()        As Variant
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.GetAllWindows", lngCurPID, lngVBMain)
...
'            arrRet(UBound(arrRet)) = Array(lngNext, lngOwner, lngPop, IsWindowEnabled(lngNext), strClass, strWinText)
    ...
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.GetAllWindows", GetAllWindows)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.GetAllWindows") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Private Function GetAllChild(ByVal lngFrmHwnd As Long, Optional ByVal blnNormalWin As Boolean) As Variant
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.GetAllChild", lngFrmHwnd)
    ReDim Preserve arrRet(0)
    ...
    Loop
    GetAllChild = arrRet
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.GetAllChild", UBound(GetAllChild))
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.GetAllChild") = 1 Then
        Resume
    End If
End Function
...
Private Sub GetAllChildSub(ByVal lngParentHwnd As Long, Optional ByVal blnNormalWin As Boolean, Optional ByRef arrRet As Variant, Optional ByVal lngLevel As Long = 0)
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.GetAllChildSub", lngParentHwnd, UBound(arrRet), lngLevel)
    If lngLevel < 2 Then
        ...
        Loop
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.GetAllChildSub", UBound(arrRet))
    Exit Sub
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.GetAllChildSub") = 1 Then
        Resume
    End If
End Sub
...
Public Function IsTopModal(ByVal lngBrwHwnd As Long, Optional ByVal lngTopWin As Long) As Boolean
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.IsTopModal", lngBrwHwnd, lngTopWin)
    If mlngVBMain = 0 Then mlngVBMain = FindVBMain(lngBrwHwnd)
    If mlngPid = 0 Then mlngPid = GetCurrentProcessId
    If lngTopWin = 0 Then
    ...
    Else
        IsTopModal = True
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.IsTopModal", lngTopWin, lngBrwHwnd, IsTopModal)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.IsTopModal") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Private Function IsCanDoMessage(ByVal lngTopWin As Long) As Boolean
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.IsCanDoMessage", lngTopWin)
    IsCanDoMessage = True
    ...
    If IsCanDoMessage Then
        ...
        End If
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.IsCanDoMessage", IsCanDoMessage)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.IsCanDoMessage") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Private Function FindVBMain(ByVal lngBrwHwnd As Long) As Long
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.FindVBMain", lngBrwHwnd)
    ...
    Do While lngOwner <> 0
        ...
        End If
    Loop
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.FindVBMain", FindVBMain)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.FindVBMain") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Private Function FindExitButtonNormal(ByVal lngMainFrm As Long) As Long
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.FindExitButtonNormal", lngMainFrm)
    ...
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.FindExitButtonNormal", FindExitButtonNormal, FindExitButtonNormal)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.FindExitButtonNormal") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Private Function FindExitButtonMsgBox(ByVal lngMainFrm As Long, ByRef strMsg As String) As Long
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.FindExitButtonMsgBox", lngMainFrm, strMsg)
    ...
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.FindExitButtonMsgBox", FindExitButtonMsgBox, strErr)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.FindExitButtonMsgBox") = 1 Then
        Resume
    End If
End Function
'--------------------------------------------------------------------------------------------------
...
Private Function FindExitButtonErrCenter(ByVal lngMainFrm As Long, ByRef strMsg As String) As Long
    ...
    Dim lngToolBarHwnd  As Long
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.FindExitButtonErrCenter", lngMainFrm, strMsg)
    arrChild = GetAllChild(lngMainFrm)
    For i = 1 To UBound(arrChild)
        strClass = arrChild(i)(WI_Class)
        strWinText = arrChild(i)(WI_Text)
    ...
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.FindExitButtonErrCenter", FindExitButtonErrCenter, strError)
    Exit Function
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.FindExitButtonErrCenter") = 1 Then
        Resume
    End If
End Function
...
'    Dim vRect       As RECT, pCenter As POINTAPI
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.ClickButton", lngMainFrm, lngBtnHwnd)
    '防止多次触发Active时间
...
'    PostMessage lngBtnHwnd, BM_CLICK, 0, 0 '单击按钮
    ...
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.ClickButton")
    Exit Sub
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.ClickButton") = 1 Then
        Resume
    End If
End Sub
...
Public Sub ClickMenuExit(ByVal lngMainFrm As Long)
    ...
    On Error GoTo ErrH
    Call gobjLog.PushMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.ClickMenuExit", lngMainFrm)
    '防止多次触发Active时间
    If GetForegroundWindow() <> lngMainFrm Then
        Call SetForegroundWindow(lngMainFrm)
    End If
    ...
    If lngReturnValue <> 0 Then
        ...
        End If
    End If
    Call gobjLog.PopMethod(RLL_AllLog, "ZlMdi.mdlAutoClick.ClickMenuExit", lngReturnValue, lngResult, Err.LastDllError)
    Exit Sub
ErrH:
    If gobjLog.ErrCenter(RLL_RunError, "ZlMdi.mdlAutoClick.ClickMenuExit") = 1 Then
        Resume
    End If
End Sub
'--------------------------------------------------------------------------------------------------
