   ...
   Begin VB.PictureBox picPane 
      ...
      Begin VB.PictureBox pic 
         ...
         Begin VB.PictureBox picLine 
            ...
            Width           =   15
         End
         Begin zl9BodyEditorSCDQ.VsfGrid vsf 
            Height          =   270
            Left            =   450
            TabIndex        =   5
            Top             =   4440
...
Public Function ConvertToValue(ByVal intNo As Integer, ByVal Y As Long) As Double
    ...
    ConvertToValue = aryValue(0) - ((Y - mshScale.ROWHEIGHT(1)) / mshScale.ROWHEIGHT(1) - aryValue(3) + 1) * aryValue(2)
...
Public Function ConvertToY(ByVal intCol As Integer, ByVal dbValue As Double) As Long
    ...
    ConvertToY = ((Val(aryValue(0)) - dbValue) / Val(aryValue(2)) + Val(aryValue(3)) - 1) * mshScale.ROWHEIGHT(1) + mshScale.ROWHEIGHT(1)
            ...
            If (!类型 = 未记说明 Or !类型 = 上标说明) Then
                ...
                If rsTarget.RecordCount <> 0 Then
                    ...
                    Do While Not rsTarget.EOF
                        ...
                        rsTarget.MoveNext
                    Loop
                    sinY1 = ConvertToY(mItemSerial.体温, 40) + 90
...
Private Sub DrawPicLable()
    ...
    For intCol = 0 To picLable.UBound
        ...
        intMax = arrData(0)
        intStep = IIf(intCol = mItemSerial.体温, 1, 20)
...
'        Next
        ...
        For intCur = arrData(1) To intMax Step intStep
            If intCur = intMax Then
                If intCol = mItemSerial.体温 Then
                    DrawText picLable(intCol), 80, ConvertToY(intCol, intCur) - sinHeight * 2, "体温"
                    DrawText picLable(intCol), 80, ConvertToY(intCol, intCur), "(℃)"
                Else
                    DrawText picLable(intCol), 20, ConvertToY(intCol, intCur) - sinHeight * 2, "脉搏"
                    DrawText picLable(intCol), 20, ConvertToY(intCol, intCur), "(次/分)"
                End If
                DrawText picLable(intCol), 80, ConvertToY(intCol, intCur) + sinHeight * 2, intCur
            Else
