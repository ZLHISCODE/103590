...
'病历文件选择窗体的显示
Public Function ShowMe(frmParent As Object, ByVal rsTmp As ADODB.Recordset, Optional ByRef lngFileId As Long, Optional ByVal strCaption As String) As Boolean
'参数：frmParent  父窗体
'      rsTmp      需要填写的病历文件记录集
