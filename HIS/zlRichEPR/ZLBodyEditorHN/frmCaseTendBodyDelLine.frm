...
Public Function ShowEdit(ByVal frmParent As Object, ByVal intNowCol As Integer, ByVal lng护理等级 As Long, ByVal intBaby As Integer) As Boolean
...
Private Sub RefreshList()
    ...
    '得到所有的曲线项目
    gstrSQL = "SELECT A.记录名 FROM 体温记录项目 A,护理记录项目 B " & _
