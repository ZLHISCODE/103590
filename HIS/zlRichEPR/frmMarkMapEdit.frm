...
Begin VB.Form frmMarkMapEdit 
   ...
   Begin MSComDlg.CommonDialog dlgThis 
      ...
      _ExtentY        =   847
      _Version        =   393216
      Filter          =   $"frmMarkMapEdit.frx":058A
   End
   ...
   Begin VB.Image imgNote 
      Height          =   480
      Left            =   45
      Picture         =   "frmMarkMapEdit.frx":0647
      Top             =   135
      Width           =   480
   End
...
Public Function ShowMe(ByRef frmParent As Object, ByVal blnAdd As Boolean, Optional ByVal strItemCode As String, Optional oDIB As cDIB) As String
    '---------------------------------------------------
...
Dim rsTemp As New ADODB.Recordset
    ...
    Set rsTemp = zlDatabase.OpenSQLRecord(gstrSQL, Me.Caption, mstrItemCode)
    With rsTemp
...
Dim rsTemp As New ADODB.Recordset
    ...
    Else
        '修改模式，要确保该病历图形还存在
        gstrSQL = "select 名称 from 病历标记图形 where 编码 =[1] And Rownum = 1"
        Set rsTemp = zlDatabase.OpenSQLRecord(gstrSQL, Me.Caption, mstrItemCode)
        If rsTemp.EOF Then
...
Private Sub txtHeight_Change()
    ...
    If txtHeight > 999999 Then
        txtHeight = 999999
        txtHeight.SelStart = 9999
        Exit Sub
    End If
...
Private Sub txtWidth_Change()
    ...
    If txtWidth > 999999 Then
        txtWidth = 999999
        txtWidth.SelStart = 9999
        Exit Sub
    End If
...
Private Sub txt名称_Change()
    ...
    If Me.Tag = "新增" Then
        Me.txt简码.Text = zlCommFun.zlGetSymbol(Me.txt名称.Text, 0)
    End If
End Sub
