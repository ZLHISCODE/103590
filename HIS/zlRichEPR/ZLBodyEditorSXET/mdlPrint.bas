                            ...
                            Else
                                ...
                                If intCol Mod 2 = 1 Then
                                    ...
                                    If (Split(strValue(intRow), ";")(intCol + 2) <> "" And Split(strValue(intRow), ";")(intCol + 3) <> "") Or Val(Split(strValue(intRow), ";")(1)) = 2 Then
                                        ...
                                        Call DrawCell(objDraw, IIf(blnGrade, "", strTmp), lngTmpX + colFirstWidth + HOUR_STEP_Twips * 3 * (intCol - 1), Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2), HOUR_STEP_Twips * 3, (H_9pt + H_9pt \ 2), , , , lngColor, , objDraw.Font)
                                        If blnGrade Then
                                    ...
                                    Else
                                        ...
                                        lngColor = GridTextColor(Split(strValue(intRow), ";")(0), strTmp)
                                        Call DrawCell(objDraw, IIf(blnGrade, "", strTmp), lngTmpX + colFirstWidth + HOUR_STEP_Twips * 6 * Fix(intCol / 2), Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2), HOUR_STEP_Twips * 6, (H_9pt + H_9pt \ 2), , , , lngColor, , objDraw.Font)
                                        If blnGrade Then
                                            objDraw.FontSize = 7.5 * sngScale
...
'    H_9pt = objDraw.TextHeight("字")
    ...
    For lngCol = 0 To 41
        ...
        lngY2 = (lngTmpY + 3 * H_9pt / 2) + 70 * 3 * H_9pt / 2                          '得到32度的坐标(lngTmpY + 3 * H_9pt / 2) + 80 * 3 * H_9pt / 2
        ...
        For intItemDrawCount = 0 To intItemCount - 1
            ...
            For lngCol = 0 To 7 * 6 - 1 '纵
                ...
                Else
                    ...
                    For i = 0 To UBound(aryData)
                        'lngValue = (lngTopRow - 1) * lngStep + lngMax
                        If lngTopRow < 2 Then lngTopRow = 2
                        lngTopRow = lngTopRow - 2
...
Private Function DrawBodyScale(objDraw As Object, X As Long, Y As Long, intGuageRow As Integer, arrstrItem() As String, Optional sngScale As Long = 1)
    ...
    For i = 0 To intCountItem '纵
        ...
        If intItemTop < 2 Then intItemTop = 2
        intItemTop = intItemTop - 2
        l = 0
        For j = 0 To intGuageRow '横
            ...
            If j = 91 Then '90时体温为33
                '首行为名称
                strItem = GetSplitStr(aryItem(i), 2)
                '--根据最高行决定刻度输入
                lngY = Y + H_9pt / 2 'objDraw.TextHeight("1") / 2
                Call DrawText(objDraw, X + 50, lngY, strItem, lngColor)
                ...
                Call DrawText(objDraw, X + IIf(GetSplitStr(aryItem(i), 2) = "体温", 50, 50), lngY, strItem, lngColor)
                'lngY = lngY + objDraw.TextHeight("1")
