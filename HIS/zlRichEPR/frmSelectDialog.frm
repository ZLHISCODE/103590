            ...
            Case "ListView"
                With objSet.ColumnHeaders
                    ...
                    For lngCol = LBound(varColumns) To UBound(varColumns)
                        ...
                        .Add , "_" & varColumn(0), varColumn(0), BlowUp(CDbl(varColumn(1))), varColumn(2)
                    Next
                End With
            Case "MSHFlexGrid"
            Case "DataGrid"
...
Private Sub ReSetFontSize()
    ...
    picTitle.Font.Size = mbytFontSize
    lblCaption.Font.Size = mbytFontSize
    lblCaption.Top = 30
    picTitle.Height = lblCaption.Height + lblCaption.Top + 30
    cmdClose.Top = 30
    tvw.Font.Size = mbytFontSize
    lvw.Font.Size = mbytFontSize
    chk.Font.Size = mbytFontSize
    chk.Width = TextWidth(chk.Value & "刘") + 30
    cmdOK.Font.Size = mbytFontSize
    cmdOK.Height = TextHeight("刘") + 100
    cmdOK.Width = TextWidth(" 确定(&O) ")
...
Public Function ShowSelect(ByVal frmMain As Form, _
                            ...
                            Optional ByVal CanSort As Boolean = True, _
