...
Private mlngSectID As String          '科室ID
...
Public Function Preview(ByVal intPrintRange As Integer, ByVal lngBeginY As Long, ByVal lngLeft As Long, _
    ...
    intBeginPage As Integer, intEndPage As Integer, intPageNo As Integer, strArrFromTo() As String, Optional ByVal lngStartIndex As Long = -1, Optional ByVal lng科室id As Long) As Boolean
    '******************************************************************************************************************
    '功能：对指定的病历(集)进行打印预览
...
'功能：打印体温表
    ...
    If Not ExistsPrinter Then MsgBox "系统中没有可用的打印机。", vbInformation: Exit Sub
    If MsgBox("准备打印体温单，打印机是否已经准备就绪？", vbQuestion + vbYesNo + vbDefaultButton2, gstrSysName) = vbNo Then Exit Sub
...
Private Sub Form_Load()
    ...
    mlngLeft = Val(zlDatabase.GetPara("体温单左边距", glngSys, 1255, OFFSET_LEFT)) * 56.7
    ...
    mintPage = Val(zlDatabase.GetPara("体温单纸张", glngSys, 1255, Printer.PaperSize))
