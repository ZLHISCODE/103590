   ...
   Begin VB.PictureBox picPane 
      ...
      Begin VB.PictureBox pic 
         ...
         Begin VB.PictureBox picLine 
            ...
            Width           =   15
         End
         Begin zl9BodyEditorYX.VsfGrid vsf 
            Height          =   270
            Left            =   450
            TabIndex        =   5
            Top             =   4440
    ...
    If rs.BOF = False Then
        If IsNull(rs.Fields(0).Value) = False Then
            ...
            Do While Not rs.EOF
                ...
                '设置表格内项目
                mshScale.ColWidth(rs.AbsolutePosition - 1) = IIf(mshScale.FixedCols < 4, 1600 / mshScale.FixedCols, 450)
...
'                End If
                ...
                '在最下面显示单位
                mshScale.TextMatrix(mshScale.Rows - 1, rs.AbsolutePosition - 1) = zlcommfun.NVL(rs("单位").Value)
...
'                                lng次数 = 12, "Ⅻ")
                ...
                Else
                    ...
                    If strtmp <> "" And mshUpTab.TextMatrix(2, intCol) <> "" Then
...
'    lblTime.Caption = "日期:" & Format(strFrom, "MM-DD") & "～" & Format(strTo, "MM-DD")
    ...
    With mshUpTab
        ...
        For intCol = 1 To .Cols - 1
            ...
            If strtmp <= strTo Then
                .TextMatrix(1, intCol) = lngValue + (intCol - 1)
            End If
            strtmp = Format(CDate(strFrom) + intCol - 1, "yyyy年MM月dd日")
            .TextMatrix(0, intCol) = Mid(strtmp, 6)
            .TextMatrix(2, intCol) = ""
        Next
    End With
