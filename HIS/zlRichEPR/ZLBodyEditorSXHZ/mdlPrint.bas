...
Public Function DrawPatiInfo(objDraw As Object, X As Long, Y As Long, strInfo As String, ByVal lngPaperWidth As Long) As Boolean
    ...
    Dim X1 As Long, lngWith As Long, lngX As Long
    ...
    '汉中体温单要求打印一行，此处在打印自前进行判断，如果宽度超长就把X坐标提前。
    X1 = X
    X1 = X1 + objDraw.TextWidth("姓名:" & Split(strInfo, "'")(0)) + W_9pt / 3
    X1 = X1 + objDraw.TextWidth("性别:" & Split(strInfo, "'")(5)) + W_9pt / 3
    X1 = X1 + objDraw.TextWidth("年龄:" & Split(strInfo, "'")(6)) + W_9pt / 3
    X1 = X1 + objDraw.TextWidth("入院日期:" & Split(strInfo, "'")(3)) + W_9pt / 3
    
    lngWith = X1 + objDraw.TextWidth("住院号:" & Split(strInfo, "'")(1) + "科室:" & Split(strInfo, "'")(2) + "床号:" & Split(strInfo, "'")(4)) + W_9pt / 3
    If lngWith > lngPaperWidth Then
        lngX = (lngWith - lngPaperWidth) / 2
        X1 = X - lngX
        lngPaperWidth = lngPaperWidth + (lngWith - lngPaperWidth)
    Else
        lngX = 0
        X1 = X
    End If
                ...
                If Split(strValue(intRow), ";")(0) = "呼吸" Then
                    ...
                    For intCol = 0 To 42
                        If intCol = 0 Then
                            ...
                            Call DrawLine(objDraw, lngTmpX, Y + intRow * (H_9pt + H_9pt \ 2), lngTmpX, Y + intRow * (H_9pt + H_9pt \ 2) + 2 * (H_9pt + H_9pt \ 2), , , 1)
                            Call DrawLine(objDraw, lngTmpX, Y + intRow * (H_9pt + H_9pt \ 2), lngTmpX + colFirstWidth, Y + intRow * (H_9pt + H_9pt \ 2), , , 1)
                            Call DrawLine(objDraw, lngTmpX + colFirstWidth, Y + intRow * (H_9pt + H_9pt \ 2), lngTmpX + colFirstWidth, Y + intRow * (H_9pt + H_9pt \ 2) + 2 * (H_9pt + H_9pt \ 2), , , 1)
                        ...
                        Else
                            ...
                            If int呼吸表格输出格式 = 0 Then
                                If intCol Mod 2 = 0 Then
                                    Call DrawCell(objDraw, strTmp, lngTmpX + colFirstWidth + HOUR_STEP_Twips * (intCol - 1), Y + intRow * (H_9pt + H_9pt \ 2), HOUR_STEP_Twips, (H_9pt + H_9pt \ 2), , , , COLOR.红色, , objDraw.Font, "1000", 1, 1)
                                Else
                                    Call DrawCell(objDraw, strTmp, lngTmpX + colFirstWidth + HOUR_STEP_Twips * (intCol - 1), Y + intRow * (H_9pt + H_9pt \ 2) + (H_9pt + H_9pt \ 2), HOUR_STEP_Twips, (H_9pt + H_9pt \ 2), , , , COLOR.红色, , objDraw.Font, "0000", 1, 1)
                                End If
                            Else
                                If int呼吸位置 = 2 Then
                                    Call DrawCell(objDraw, strTmp, lngTmpX + colFirstWidth + HOUR_STEP_Twips * (intCol - 1), Y + intRow * (H_9pt + H_9pt \ 2), HOUR_STEP_Twips, (H_9pt + H_9pt \ 2), , , , COLOR.红色, , objDraw.Font, "1000", 1, 1)
                    ...
                    For intCol = 0 To 42
                        If (intCol) Mod 6 = 0 Then
                            Call DrawLine(objDraw, lngTmpX + colFirstWidth + HOUR_STEP_Twips * intCol, Y + intRow * (H_9pt + H_9pt \ 2), lngTmpX + colFirstWidth + HOUR_STEP_Twips * intCol, Y + intRow * (H_9pt + H_9pt \ 2) + 2 * (H_9pt + H_9pt \ 2), , , 1)
                        Else
                    ...
                    If blnExistData Then
                        ...
                        For intCol = 0 To 14
                            If intCol = 0 Then
                                ...
                                Call DrawLine(objDraw, lngTmpX, Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2), lngTmpX, Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2) + (H_9pt + H_9pt \ 2), , , 1)
                            Else
                                ...
                                If intCol Mod 2 = 1 Then
                                    ...
                                    If (Split(strValue(intRow), ";")(intCol + 2) <> "" And Split(strValue(intRow), ";")(intCol + 3) <> "") Or Val(Split(strValue(intRow), ";")(1)) = 2 Then
                                        ...
                                        Else
                                            ...
                                            Call DrawCell(objDraw, strTmp, lngTmpX + colFirstWidth + HOUR_STEP_Twips * 3 * (intCol - 1), Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2), HOUR_STEP_Twips * 3, (H_9pt + H_9pt \ 2), , , , COLOR.红色, , objDraw.Font, "1111", 1, 1)
                                        End If
                                        
                                        If (intCol + 1) Mod 2 = 0 Then
                                            Call DrawLine(objDraw, lngTmpX + colFirstWidth + HOUR_STEP_Twips * 3 * (intCol - 1), Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2), lngTmpX + colFirstWidth + HOUR_STEP_Twips * 3 * (intCol - 1), Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2) + (H_9pt + H_9pt \ 2), IIf(intCol = 1, COLOR.黑色, COLOR.红色), , 1)
                                        End If
                                    ...
                                    Else
                                        ...
                                        Else
                                            ...
                                            Call DrawCell(objDraw, strTmp, lngTmpX + colFirstWidth + HOUR_STEP_Twips * 6 * Fix(intCol / 2), Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2), HOUR_STEP_Twips * 6, (H_9pt + H_9pt \ 2), , , , COLOR.红色, , objDraw.Font, "1111", 1, 1)
                                        End If
                                        
                                        Call DrawLine(objDraw, lngTmpX + colFirstWidth + HOUR_STEP_Twips * 6 * Fix(intCol / 2), Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2), lngTmpX + colFirstWidth + HOUR_STEP_Twips * 3 * (intCol - 1), Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2) + (H_9pt + H_9pt \ 2), IIf(intCol = 1, COLOR.黑色, COLOR.红色), , 1)
                            ...
                            If intCol = 14 Then
                                Call DrawLine(objDraw, lngTmpX + colFirstWidth + HOUR_STEP_Twips * 3 * (intCol - 1) + HOUR_STEP_Twips * 3, Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2), lngTmpX + colFirstWidth + HOUR_STEP_Twips * 3 * (intCol - 1) + HOUR_STEP_Twips * 3, Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2) + (H_9pt + H_9pt \ 2), COLOR.黑色, , 1)
                            End If
                        Next
                    End If
                End If
    ...
    '            End If
        ...
        If intGridRows > 0 And intGridRows > intFactRow Then
            ...
            For intRow = 1 To intCount
                ...
                Call DrawCell(objDraw, "", lngTmpX, Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2), colFirstWidth, (H_9pt + H_9pt \ 2), , , , COLOR.红色, , objDraw.Font, , 1, 1)
                Call DrawLine(objDraw, lngTmpX, Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2), lngTmpX, Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2) + (H_9pt + H_9pt \ 2), , , 1)
                
                For intCol = 1 To 14
                    Call DrawCell(objDraw, "", lngTmpX + colFirstWidth + HOUR_STEP_Twips * 3 * (intCol - 1), Y + (intFactRow + intAdd) * (H_9pt + H_9pt \ 2), HOUR_STEP_Twips * 3, (H_9pt + H_9pt \ 2), , , , COLOR.红色, , objDraw.Font, "1111", 1, 1)
...
Private Sub DrawBodyPageFooter(objDraw As Object, X As Long, Y As Long, ByVal intPageNo As Integer, ByVal intBeginPage As Integer)
    ...
    lngX = lngX / 2
    Call DrawCell(objDraw, strNOPage, lngX, Y, W_9pt * 20, H_9pt + H_9pt \ 2, , , , , , objDraw.Font, "0000", 0, 0)
End Sub
...
Private Function DrawBodyInfo(objDraw As Object, X As Long, Y As Long, ByVal colFirstWidth As Long, _
    ...
    Call DrawCell(objDraw, "每日时间", X, Y + (H_9pt + H_9pt \ 2) * 3, colFirstWidth, H_9pt + H_9pt \ 2, 0, 0, , , , objDraw.Font, "1111", 1, 1, False)
    
    Call DrawLine(objDraw, X, Y, X + colFirstWidth, Y, , , 1)
    Call DrawLine(objDraw, X, Y, X, Y + (H_9pt + H_9pt \ 2) * 3 + H_9pt + H_9pt \ 2, , , 1)
    Call DrawLine(objDraw, X + colFirstWidth, Y, X + colFirstWidth, Y + (H_9pt + H_9pt \ 2) * 3 + H_9pt + H_9pt \ 2, , , 1)
    ...
    For intDay = 0 To 6
        ...
        ElseIf intDay = 0 Then
            ...
            strTmp = Format(strTmp, "yyyy-MM-dd") 'Right(strTmp, 5)
        ...
        Call DrawLine(objDraw, lngLeft + (HOUR_STEP_Twips * 6) * intDay, Y, lngLeft + (HOUR_STEP_Twips * 6) * intDay + (HOUR_STEP_Twips * 6), Y, , , 1)
        Call DrawLine(objDraw, lngLeft + (HOUR_STEP_Twips * 6) * intDay, Y, lngLeft + (HOUR_STEP_Twips * 6) * intDay, Y + H_9pt + H_9pt \ 2, IIf(intDay = 0, 0, COLOR.红色), , 1)
        Call DrawLine(objDraw, lngLeft + (HOUR_STEP_Twips * 6) * intDay + (HOUR_STEP_Twips * 6), Y, lngLeft + (HOUR_STEP_Twips * 6) * intDay + (HOUR_STEP_Twips * 6), Y + H_9pt + H_9pt \ 2, , , 1)
        
        Call DrawCell(objDraw, CStr(lngStartDay + intDay), lngLeft + (HOUR_STEP_Twips * 6) * intDay, Y + H_9pt * 1 + H_9pt \ 2, (HOUR_STEP_Twips * 6), H_9pt + H_9pt \ 2, 0, 0, , RGB(255, 0, 0), , objDraw.Font, "1111", 1, 1, False)
        
        Call DrawLine(objDraw, lngLeft + (HOUR_STEP_Twips * 6) * intDay, Y + H_9pt * 1 + H_9pt \ 2, lngLeft + (HOUR_STEP_Twips * 6) * intDay, Y + H_9pt * 1 + H_9pt \ 2 + H_9pt + H_9pt \ 2, IIf(intDay = 0, 0, COLOR.红色), , 1)
        Call DrawLine(objDraw, lngLeft + (HOUR_STEP_Twips * 6) * intDay + (HOUR_STEP_Twips * 6), Y + H_9pt * 1 + H_9pt \ 2, lngLeft + (HOUR_STEP_Twips * 6) * intDay + (HOUR_STEP_Twips * 6), Y + H_9pt * 1 + H_9pt \ 2 + H_9pt + H_9pt \ 2, , , 1)
        ...
        End If
        Call DrawLine(objDraw, lngLeft + (HOUR_STEP_Twips * 6) * intDay, Y + (H_9pt + H_9pt \ 2) * 2, lngLeft + (HOUR_STEP_Twips * 6) * intDay, Y + (H_9pt + H_9pt \ 2) * 2 + H_9pt + H_9pt \ 2, IIf(intDay = 0, 0, COLOR.红色), , 1)
        Call DrawLine(objDraw, lngLeft + (HOUR_STEP_Twips * 6) * intDay + (HOUR_STEP_Twips * 6), Y + (H_9pt + H_9pt \ 2) * 2, lngLeft + (HOUR_STEP_Twips * 6) * intDay + (HOUR_STEP_Twips * 6), Y + (H_9pt + H_9pt \ 2) * 2 + H_9pt + H_9pt \ 2, , , 1)
...
'                objDraw.FontSize = 9
    ...
    For i = 1 To 7
        ...
        Call DrawLine(objDraw, X, lngCurY, X, lngCurY + (H_9pt + H_9pt \ 2), IIf(i = 7, 0, COLOR.红色), 1, 1)
    Next
            ...
            If aryTmp(1) <> "" Then
                For i = 1 To Len(aryTmp(1))
                    If lngY1 < lngYMax Then
                        ...
                        Call DrawRotateText(objDraw, lngX - objDraw.TextWidth(strTmp) / 2 + 15, lngY1 + 15, strTmp, 255)
...
'                    lngArrXY(lngCol, 0) = 2
                    ...
                    Case 1
                        If InStr(aryData(0), ";") > 0 Then
                            ...
                            Case Is <= lngMin
                                strTag = "·"
                                Call DrawLine(objDraw, X1, Y1, X1, Y1 + 200, lngColor, , 1, True)
                            Case Is >= lngMax
                                strTag = "·"
                                Call DrawLine(objDraw, X1, Y1, X1, Y1 - 200, lngColor, , 1, True)
                            End Select
                            ...
                            If Val(aryTmp(2)) = 1 Then
                                '复试合格
                                Call DrawText(objDraw, X1 - 50, Y1 - 250, "v", vbRed)
                            End If
...
'                            End If
                        ...
                        If lng项目序号 = 1 Then
                            Call PointAdd(rsPoint, lngX, IIf(Y2 > Y1, Y2, Y1) - H_9pt \ 3, lng项目序号, IIf(Y2 < Y1, strTag, mstrChar(1)), lngColor, lngCol, CStr(aryTmp(5)))
                        Else
                            Call PointAdd(rsPoint, lngX, Y2 - H_9pt \ 3, lng项目序号, strTag, lngColor, lngCol, "")
                        End If
                    ...
                    If lngCol > 0 Then
                        ...
                        If lngUpIndex > -1 Then
                            If lngArrXY(lngUpIndex, 0) = 2 Then
                                If lngArrXY(lngUpIndex, 5) <> 1 And lngArrXY(lngCol, 5) <> 1 Then
                                    Call DrawLine(objDraw, lngArrXY(lngUpIndex, 1), lngArrXY(lngUpIndex, 2), X, Y, lngColor, , 1)
                                End If
                                ...
                                If Y2 <> lngTmpY Then
                                    ...
                                    Case 1          '体温项目
                                        If Y2 > Y Then
                                            Call DrawLine(objDraw, X, Y, X, Y2, 255, 2, , False)
                                        End If
                                    Case 2
                                        If lngArrXY(lngUpIndex, 4) = 2 Then
                                            Call DrawLine(objDraw, lngArrXY(lngUpIndex, 1), lngArrXY(lngUpIndex, 3), X, Y2, lngColor, , 1)
                                        End If
                                    End Select
...
'    H_9pt = objDraw.TextHeight("字")
    ...
    For intRow = 0 To intGuageRow - 1
        ...
        If Not (intRow = 69 Or intRow = 87) Then
            If (intRow + 1) Mod 5 = 1 Then
                If intRow = 50 Then
                    Call DrawLine(objDraw, lngTmpX + 10, Y0 + ROWHEIGHT * 5, lngTmpX + HOUR_STEP_Twips * 6 * 7, Y0 + ROWHEIGHT * 5, RGB(200, 0, 0), , 1)
                Else
                    Call DrawLine(objDraw, lngTmpX + 10, Y0 + ROWHEIGHT * 5, lngTmpX + HOUR_STEP_Twips * 6 * 7, Y0 + ROWHEIGHT * 5, COLOR.深灰色, , 1)
                End If
            Else
                Call DrawLine(objDraw, lngTmpX + 10, Y0 + ROWHEIGHT * 5, lngTmpX + HOUR_STEP_Twips * 6 * 7, Y0 + ROWHEIGHT * 5, COLOR.灰色, , 1)
            End If
        Else
            Call DrawLine(objDraw, lngTmpX + 10, Y0 + ROWHEIGHT * 5, lngTmpX + HOUR_STEP_Twips * 6 * 7, Y0 + ROWHEIGHT * 5, RGB(200, 0, 0), , 1)
        End If
    ...
    For intCol = 0 To 6
        ...
        objDraw.Line (X0 + HOUR_STEP_Twips * 1, lngTmpY)-(X0 + HOUR_STEP_Twips * 1, Y), COLOR.灰色
        objDraw.Line (X0 + HOUR_STEP_Twips * 2, lngTmpY)-(X0 + HOUR_STEP_Twips * 2, Y), COLOR.灰色
        objDraw.Line (X0 + HOUR_STEP_Twips * 3, lngTmpY)-(X0 + HOUR_STEP_Twips * 3, Y), COLOR.灰色
        objDraw.Line (X0 + HOUR_STEP_Twips * 4, lngTmpY)-(X0 + HOUR_STEP_Twips * 4, Y), COLOR.灰色
        objDraw.Line (X0 + HOUR_STEP_Twips * 5, lngTmpY)-(X0 + HOUR_STEP_Twips * 5, Y), COLOR.灰色

        Call DrawLine(objDraw, X0 + HOUR_STEP_Twips * 6, lngTmpY, X0 + HOUR_STEP_Twips * 6, Y, IIf(intCol = 6, 0, RGB(200, 0, 0)), , 1)
    Next
...
Private Function DrawBodyScale(objDraw As Object, X As Long, Y As Long, intGuageRow As Integer, arrstrItem() As String, Optional sngScale As Long = 1)
    ...
    lngPercW = mlngFirstWidth / intCountItem '呼吸和体温共用一个刻度,因此:mlngFirstWidth / (intCountItem + 1)
...
'            ElseIf j >= intItemTop And lngTmpVal >= CLng(GetSplitStr(aryItem(i), 4)) Then
            ...
            If j >= intItemTop And lngTmpVal >= CLng(GetSplitStr(aryItem(i), 4)) Then
                ...
                Else
                    '打印名称(脉搏/呼吸/体温)
                    If lngTmpVal = 41.5 Then
                        Call DrawText(objDraw, X + (lngPercW - objDraw.TextWidth(CStr(CStr(lngTmpVal)))) / 2 - lngPercW / 2, Y + objDraw.TextHeight(CStr(CStr(lngTmpVal))) / 2 - 30, "体", CLng(GetSplitStr(aryItem(int体温), 0)))
                        Call DrawText(objDraw, X + (lngPercW - objDraw.TextWidth(CStr(CStr(lngTmpVal)))) / 2 - lngPercW / 2, Y + H_9pt + objDraw.TextHeight(CStr(CStr(lngTmpVal))), "温", CLng(GetSplitStr(aryItem(int体温), 0)))
                    ElseIf lngTmpVal = 38.9 Then    '呼吸
                           Call DrawRotateText(objDraw, X + lngPercW - objDraw.TextWidth("脉") - (int体温 - int呼吸) * lngPercW, Y + objDraw.TextHeight(CStr(CStr(lngTmpVal))) / 2 - 30, "(", CLng(GetSplitStr(aryItem(int体温), 0)))
                        Call DrawRotateText(objDraw, X + (lngPercW - objDraw.TextWidth("脉")) / 2 - (int体温 - int呼吸) * lngPercW, Y + H_9pt + objDraw.TextHeight(CStr("摄")), "摄", CLng(GetSplitStr(aryItem(int体温), 0)))
                        Call DrawRotateText(objDraw, X + (lngPercW - objDraw.TextWidth("脉")) / 2 - (int体温 - int呼吸) * lngPercW, Y + H_9pt * 4 + objDraw.TextHeight(CStr("氏")), "氏", CLng(GetSplitStr(aryItem(int体温), 0)))
                        Call DrawRotateText(objDraw, X + (lngPercW - objDraw.TextWidth("脉")) / 2 - (int体温 - int呼吸) * lngPercW, Y + H_9pt * 7 + objDraw.TextHeight(CStr("表")), "表", CLng(GetSplitStr(aryItem(int体温), 0)))
                        Call DrawRotateText(objDraw, X + lngPercW - objDraw.TextWidth("脉") - (int体温 - int呼吸) * lngPercW, Y + H_9pt * 12 + objDraw.TextHeight(CStr(CStr(lngTmpVal))), ")", CLng(GetSplitStr(aryItem(int体温), 0)))
                    End If
                End If
                Y = Y + H_9pt + H_9pt \ 2
                l = l + 1
        ...
        '强制输出标识信息
        If i = 0 Then   '脉搏
            Call DrawText(objDraw, X + (lngPercW - objDraw.TextWidth("脉")) / 2, lngTmpY + (intGuageRow - 10) * (H_9pt + H_9pt \ 2) + H_9pt * 7, "脉", CLng(GetSplitStr(aryItem(int脉搏), 0)))
            Call DrawText(objDraw, X + (lngPercW - objDraw.TextWidth("脉")) / 2, lngTmpY + (intGuageRow - 8) * (H_9pt + H_9pt \ 2) + H_9pt * 7, "搏", CLng(GetSplitStr(aryItem(int脉搏), 0)))
        ElseIf i = 2 Then   '体温，在体温栏打印呼吸两字
            Call DrawText(objDraw, X + (lngPercW - objDraw.TextWidth("脉")) / 2, lngTmpY + (intGuageRow - 10) * (H_9pt + H_9pt \ 2) + H_9pt * 7, "呼", CLng(GetSplitStr(aryItem(int呼吸), 0)))
            Call DrawText(objDraw, X + (lngPercW - objDraw.TextWidth("脉")) / 2, lngTmpY + (intGuageRow - 8) * (H_9pt + H_9pt \ 2) + H_9pt * 7, "吸", CLng(GetSplitStr(aryItem(int呼吸), 0)))
        End If
        
        X = X + lngPercW
        If i = 0 Then lngPercW = lngPercW / 2
    Next
    ...
    For i = 0 To intCountItem
        ...
        If i = 0 Or i = intCountItem Then
            Call DrawLine(objDraw, X, Y, X, Y + (intGuageRow) * (H_9pt + H_9pt \ 2) + H_9pt * 7, , , 1)
        End If
    ...
    '为了将值传给下一个画图的起始点
    X = lngTmpX + lngPercW * intCountItem  '+ W_9pt \ 2  '
    Y = lngTmpY
End Function
...
'                            lng次数 = 12, "Ⅻ")
            ...
            If mblnStopFlag Then
                ...
                End If
            Else
                lngArryOPSDay(i) = IIf(lngArryOPSDay(i) <> "" And lngArryOPSDay(i) <> "-1", lngArryOPSDay(i), strTmp)
            End If
        ...
        Case Else
            ...
            If (i - Index) <= mintOpDays Then
                ...
                Else
                    lngArryOPSDay(i) = IIf(lngArryOPSDay(i) <> "", lngArryOPSDay(i) & "/" & (i - Index), (i - Index))
                End If
...
'            objOut.SetPages
    ...
    '婴儿体温单开始时间以出生时间为准，病人体温单开始时间根据操作员设置提取
    If intBaby = 0 Then
        '提取病案主页从表中的体温单开始日期
        gstrSQL = " Select 信息值 From 病案主页从表 Where 病人ID=[1] And 主页ID=[2] And 信息名='体温单开始日期'"
        Set rsTemp = zlDatabase.OpenSQLRecord(gstrSQL, "提取病案主页从表中的体温单开始日期", lng病人ID, lng主页id)
        If rsTemp.RecordCount <> 0 Then
            strBeginDate = Format(rsTemp!信息值, "yyyy-MM-dd HH:mm:ss")
        End If
    End If
    ...
    If rsTmp.RecordCount > 0 Then
        ...
        '更新填写手术次数,格式:(2),第一次手术不填写
        For i = 0 To TmplngDayCount - 1
            If Right(lngArr手术后天数(i), 2) = "/1" Then
                If UBound(Split(lngArr手术后天数(i), "/")) >= 1 Then
                    lngArr手术后天数(i) = lngArr手术后天数(i) & "(" & UBound(Split(lngArr手术后天数(i), "/")) + 1 & ")"
                End If
            End If
        Next
    End If
...
'                    End If
                    Call DrawRotateText(objDraw, sinX1 - objDraw.TextWidth(strChar) / 2, sinY1 + 15, strChar, 255)
'                    If Asc(strChar) < 0 Then
'                        intCharNumber = 0
