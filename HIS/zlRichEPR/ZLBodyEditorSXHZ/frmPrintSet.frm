...
'    初始化打印参数
    ...
    mstrPrinter = zlDatabase.GetPara("体温单打印机", glngSys, 1255, Printer.DeviceName, , InStr(mstrPrivs, "护理选项设置") > 0)
    mintPage = Val(zlDatabase.GetPara("体温单纸张", glngSys, 1255, Printer.PaperSize, , InStr(mstrPrivs, "护理选项设置") > 0))
    mlngWidth = Val(zlDatabase.GetPara("体温单宽度", glngSys, 1255, Printer.Width, , InStr(mstrPrivs, "护理选项设置") > 0))
    mlngHeight = Val(zlDatabase.GetPara("体温单高度", glngSys, 1255, Printer.Height, , InStr(mstrPrivs, "护理选项设置") > 0))
    mintOrient = Val(zlDatabase.GetPara("体温单纸向", glngSys, 1255, Printer.Orientation, , InStr(mstrPrivs, "护理选项设置") > 0))
    mintBin = Val(zlDatabase.GetPara("体温单进纸", glngSys, 1255, Printer.PaperBin, , InStr(mstrPrivs, "护理选项设置") > 0))
    mlngLeft = Val(zlDatabase.GetPara("体温单左边距", glngSys, 1255, OFFSET_LEFT, , InStr(mstrPrivs, "护理选项设置") > 0))
    mlngRight = Val(zlDatabase.GetPara("体温单右边距", glngSys, 1255, OFFSET_RIGHT, , InStr(mstrPrivs, "护理选项设置") > 0))
    mlngTop = Val(zlDatabase.GetPara("体温单上边距", glngSys, 1255, OFFSET_TOP, , InStr(mstrPrivs, "护理选项设置") > 0))
    mlngBottom = Val(zlDatabase.GetPara("体温单下边距", glngSys, 1255, OFFSET_BOTTOM, , InStr(mstrPrivs, "护理选项设置") > 0))
