...
Begin VB.Form frmDegreeCard 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(96)=   "txt(75)"
      Tab(0).Control(96).Enabled=   0   'False
      Tab(0).ControlCount=   97
      TabCaption(1)   =   "住院信息(&2)"
...
'功能：读取指定病人信息,并显示在界面上
    ...
    Else
        strTxt = "病人ID=0,姓名=1,性别=2,年龄=3,门诊号=4,费别=5,医疗付款方式=6,医保号=7,险类=8,区域=9,国籍=10,民族=11,学历=12,婚姻状况=13,职业=14," & _
                ...
                " 出院中医诊断=54,登记时间=63,就诊卡号=64,其他证件=65,病人类型=66,住院预交余额=69,住院费用余额=70,户口地址=71,户口地址邮编=72,籍贯=73,联系人身份证号=74,联系人附加信息=75"
    End If
    ...
    If strPlus <> "" Then
        ...
        If Not rsTmp.EOF Then
            If Not IsNull(rsTmp!信息值) Then txt(txtName.身份证号).Text = rsTmp!信息值
        End If
    End If
