...
'    Next
    For X = 30 To 210
        '¸ßÏÞÇúÏß
        picImg.Line (X + int_×ó±ß¾à, (arrHigh(0) / X ^ 2 + arrHigh(1) / X + arrHigh(2)) + int_ÏÂ±ß¾à)- _
        ...
        '¼ìÑé½á¹ûÇúÏß
        picImg.DrawWidth = 2
        picImg.Line (X + int_×ó±ß¾à, (arrVAL(0) / X ^ 2 + arrVAL(1) / X + arrVAL(2)) + int_ÏÂ±ß¾à)- _
        ...
        'µÍÏÞÇúÏß
        picImg.Line (X + int_×ó±ß¾à, (arrLow(0) / X ^ 2 + arrLow(1) / X + arrLow(2)) + int_ÏÂ±ß¾à)- _
    ...
    'X ÖáÏß
    picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 220, int_ÏÂ±ß¾à)
    picImg.Line (int_×ó±ß¾à + 220, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 215, int_ÏÂ±ß¾à + 0.3)
    picImg.Line (int_×ó±ß¾à + 220, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 215, int_ÏÂ±ß¾à - 0.3)
    'X Öá¿Ì¶È
    picImg.Line (int_×ó±ß¾à + 10, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 10, int_ÏÂ±ß¾à + 0.3)
    picImg.Line (int_×ó±ß¾à + 30, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 30, int_ÏÂ±ß¾à + 0.3)
    picImg.Line (int_×ó±ß¾à + 70, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 70, int_ÏÂ±ß¾à + 0.3)
    picImg.Line (int_×ó±ß¾à + 120, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 120, int_ÏÂ±ß¾à + 0.3)
    picImg.Line (int_×ó±ß¾à + 150, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 150, int_ÏÂ±ß¾à + 0.3)
    picImg.Line (int_×ó±ß¾à + 200, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 200, int_ÏÂ±ß¾à + 0.3)
    
    'Y ÖáÏß
    picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à)-(int_×ó±ß¾à, int_ÏÂ±ß¾à + 14)
    picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à + 14)-(int_×ó±ß¾à - 3, int_ÏÂ±ß¾à + 14 - 0.5)
    picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à + 14)-(int_×ó±ß¾à + 3, int_ÏÂ±ß¾à + 14 - 0.5)
    'Y Öá¿Ì¶È
    picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à + 5)-(int_×ó±ß¾à + 3, int_ÏÂ±ß¾à + 5)
    picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à + 10)-(int_×ó±ß¾à + 3, int_ÏÂ±ß¾à + 10)
    picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à + 12)-(int_×ó±ß¾à + 3, int_ÏÂ±ß¾à + 12)
...
Public Function Draw_2010D(arrHigh() As Double, arrVAL() As Double, arrLow() As Double, arrNianDu() As Double, strImgPath As String, str±ê±¾ºÅ As String) As String
    ...
    For intLoop = 15 To 200
        ...
        '¸ßÏÞÇúÏß
        picImg.Line (X + int_×ó±ß¾à, (dblAA1 * Exp(dblBB1 * X ^ dblC1)) + int_ÏÂ±ß¾à)- _
       ...
       '¼ìÑé½á¹ûÇúÏß
        picImg.DrawWidth = 2
        picImg.Line (X + int_×ó±ß¾à, (dblAA * Exp(dblBB * X ^ dblC)) + int_ÏÂ±ß¾à)- _
        ...
        'µÍÏÞÇúÏß
        picImg.Line (X + int_×ó±ß¾à, (dblAA2 * Exp(dblBB2 * X ^ dblC2)) + int_ÏÂ±ß¾à)- _
                    (X - 1 / 2 + int_×ó±ß¾à, (dblAA2 * Exp(dblBB2 * (X - 1 / 2) ^ dblC2)) + int_ÏÂ±ß¾à), vbGreen
        picImg.Line (X + int_×ó±ß¾à, (dblAA2 * Exp(dblBB2 * X ^ dblC2)) + int_ÏÂ±ß¾à)- _
                    (X + 1 / 2 + int_×ó±ß¾à, (dblAA2 * Exp(dblBB2 * (X + 1 / 2) ^ dblC2)) + int_ÏÂ±ß¾à), vbGreen
                    
        'Ñª½¬Õ³¶È
        picImg.Line (int_×ó±ß¾à, arrNianDu(1) + int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 200, arrNianDu(1) + int_ÏÂ±ß¾à)
        If intLoop Mod 20 = 0 Then
            picImg.Line (X + int_×ó±ß¾à, arrNianDu(0) + int_ÏÂ±ß¾à)-(X + int_×ó±ß¾à - 2.5, arrNianDu(0) + int_ÏÂ±ß¾à)
            picImg.Line (X + int_×ó±ß¾à, arrNianDu(0) + int_ÏÂ±ß¾à)-(X + int_×ó±ß¾à + 2.5, arrNianDu(0) + int_ÏÂ±ß¾à)
            
            picImg.Line (X + int_×ó±ß¾à, arrNianDu(2) + int_ÏÂ±ß¾à)-(X + int_×ó±ß¾à - 2.5, arrNianDu(2) + int_ÏÂ±ß¾à)
            picImg.Line (X + int_×ó±ß¾à, arrNianDu(2) + int_ÏÂ±ß¾à)-(X + int_×ó±ß¾à + 2.5, arrNianDu(2) + int_ÏÂ±ß¾à)
    ...
    'Y ÖáÏß
    picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à)-(int_×ó±ß¾à, int_ÏÂ±ß¾à + 34)
    picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à + 34)-(int_×ó±ß¾à - 4, int_ÏÂ±ß¾à + 34 - 0.5)
    picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à + 34)-(int_×ó±ß¾à + 4, int_ÏÂ±ß¾à + 34 - 0.5)


    'X ÖÜ±êÇ©£¬¿Ì¶ÈÏß
    For intLoop = 0 To 200 Step 20
        picImg.Line (int_×ó±ß¾à + intLoop, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + intLoop, int_ÏÂ±ß¾à + 0.5)
        picImg.FontBold = False
        With picImg
    ...
    For intLoop = 6 To 30 Step 6
        picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à + intLoop)-(int_×ó±ß¾à + 3, int_ÏÂ±ß¾à + intLoop)
        With picImg
            .CurrentX = int_×ó±ß¾à - 17
...
Public Function Draw_SA6000(strLow As String, strVal As String, strHigh As String, strImgPath As String, str±ê±¾ºÅ As String) As String
    ...
    For intLoop = 1 To 220
        ...
        picImg.Line (X + int_×ó±ß¾à, GetY_SA6000(sngX1, sngY1, sngX2, sngY2, X) + int_ÏÂ±ß¾à)-(X + 3 - 7 / 50 / 2 + int_×ó±ß¾à, GetY_SA6000(sngX1, sngY1, sngX2, sngY2, X + 3 - 7 / 50 / 2) + int_ÏÂ±ß¾à), vbRed
        picImg.Line (X + int_×ó±ß¾à, GetY_SA6000(sngX1, sngY1, sngX2, sngY2, X) + int_ÏÂ±ß¾à)-(X + 3 + 7 / 50 / 2 + int_×ó±ß¾à, GetY_SA6000(sngX1, sngY1, sngX2, sngY2, X + 3 + 7 / 50 / 2) + int_ÏÂ±ß¾à), vbRed
       ...
       '¼ìÑé½á¹ûÇúÏß
        ...
        picImg.DrawWidth = 1
        picImg.Line (X + int_×ó±ß¾à, GetY_SA6000(sngX1, sngY1, sngX2, sngY2, X) + int_ÏÂ±ß¾à)-(X + 3 - 7 / 50 / 2 + int_×ó±ß¾à, GetY_SA6000(sngX1, sngY1, sngX2, sngY2, X + 3 - 7 / 50 / 2) + int_ÏÂ±ß¾à), vbGreen
        picImg.Line (X + int_×ó±ß¾à, GetY_SA6000(sngX1, sngY1, sngX2, sngY2, X) + int_ÏÂ±ß¾à)-(X + 3 + 7 / 50 / 2 + int_×ó±ß¾à, GetY_SA6000(sngX1, sngY1, sngX2, sngY2, X + 3 + 7 / 50 / 2) + int_ÏÂ±ß¾à), vbGreen
        picImg.DrawWidth = 1
        ...
        picImg.Line (X + int_×ó±ß¾à, GetY_SA6000(sngX1, sngY1, sngX2, sngY2, X) + int_ÏÂ±ß¾à)-(X + 3 - 7 / 50 / 2 + int_×ó±ß¾à, GetY_SA6000(sngX1, sngY1, sngX2, sngY2, X + 3 - 7 / 50 / 2) + int_ÏÂ±ß¾à), vbMagenta
        picImg.Line (X + int_×ó±ß¾à, GetY_SA6000(sngX1, sngY1, sngX2, sngY2, X) + int_ÏÂ±ß¾à)-(X + 3 + 7 / 50 / 2 + int_×ó±ß¾à, GetY_SA6000(sngX1, sngY1, sngX2, sngY2, X + 3 + 7 / 50 / 2) + int_ÏÂ±ß¾à), vbMagenta
    Next
    ...
    'Y ÖáÏß
    picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à)-(int_×ó±ß¾à, int_ÏÂ±ß¾à + 38)
    picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à + 38)-(int_×ó±ß¾à - 4, int_ÏÂ±ß¾à + 38 - 0.5)
    picImg.Line (int_×ó±ß¾à, int_ÏÂ±ß¾à + 38)-(int_×ó±ß¾à + 4, int_ÏÂ±ß¾à + 38 - 0.5)


    'X Öá¿Ì¶È
    picImg.Line (int_×ó±ß¾à + 3, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 3, int_ÏÂ±ß¾à + 0.5)
    picImg.Line (int_×ó±ß¾à + 10, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 10, int_ÏÂ±ß¾à + 0.5)
    picImg.Line (int_×ó±ß¾à + 30, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 30, int_ÏÂ±ß¾à + 0.5)
    picImg.Line (int_×ó±ß¾à + 100, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 100, int_ÏÂ±ß¾à + 0.5)
    picImg.Line (int_×ó±ß¾à + 200, int_ÏÂ±ß¾à)-(int_×ó±ß¾à + 200, int_ÏÂ±ß¾à + 0.5)
...
'        If x = 20 Then
'            sngX1 = 1: sngY1 = Split(Split(strLow, ";")(1), ",")(0): sngX2 = 200: sngY2 = Split(Split(strHigh, ";")(1), ",")(0)
'            Z = x + 7 / 8 + int_×ó±ß¾à - 15
'            U = GetY_SA6000_541(sngX1, sngY1, sngX2, sngY2, x) + int_ÏÂ±ß¾à
'            picImg.Line (x + int_×ó±ß¾à - 15, GetY_SA6000_541(sngX1, sngY1, sngX2, sngY2, x) + int_ÏÂ±ß¾à)-(Z, U), vbRed
'        Else
'            sngX1 = 1: sngY1 = Split(Split(strLow, ";")(1), ",")(0): sngX2 = 200: sngY2 = Split(Split(strHigh, ";")(1), ",")(0)
'            picImg.Line (Z, U)-(x + 7 / 8 + int_×ó±ß¾à - 15, GetY_SA6000_541(sngX1, sngY1, sngX2, sngY2, x) + int_ÏÂ±ß¾à), vbRed
'            Z = x + 7 / 8 + int_×ó±ß¾à - 15
'            U = GetY_SA6000_541(sngX1, sngY1, sngX2, sngY2, x) + int_ÏÂ±ß¾à
'        End If
'
            ...
            '¸ßÏÞÇúÏß
            sngX1 = 1: sngY1 = Split(Split(strLow, ";")(1), ",")(0): sngX2 = 200: sngY2 = Split(Split(strHigh, ";")(1), ",")(0)
            picImg.Line (X + int_×ó±ß¾à - 15, GetY_ZL6000C(sngX1, sngY1, sngX2, sngY2, X) + int_ÏÂ±ß¾à)-(X + 7 / 8 + 0.2 + int_×ó±ß¾à - 15, GetY_ZL6000C(sngX1, sngY1, sngX2, sngY2, X) + int_ÏÂ±ß¾à), vbRed

           '¼ìÑé½á¹ûÇúÏß
            sngX1 = 1: sngY1 = Split(Split(strVal, ",")(1), "-")(1): sngX2 = 200: sngY2 = Split(Split(strVal, ",")(4), "-")(1)
            picImg.Line (X + int_×ó±ß¾à - 15, GetY_ZL6000C(sngX1, sngY1, sngX2, sngY2, X) + int_ÏÂ±ß¾à - 0.1415926)-(X + 7 / 8 + 0.2 + int_×ó±ß¾à - 15, GetY_ZL6000C(sngX1, sngY1, sngX2, sngY2, X) + int_ÏÂ±ß¾à - 0.1415926), vbGreen

            'µÍÏÞÇúÏß
            sngX1 = 1: sngY1 = Split(Split(strLow, ";")(0), ",")(0): sngX2 = 200: sngY2 = Split(Split(strHigh, ";")(0), ",")(0)
            picImg.Line (X + int_×ó±ß¾à - 15, GetY_ZL6000C(sngX1, sngY1, sngX2, sngY2, X) + int_ÏÂ±ß¾à)-(X + 7 / 8 + 0.2 + int_×ó±ß¾à - 15, GetY_ZL6000C(sngX1, sngY1, sngX2, sngY2, X) + int_ÏÂ±ß¾à), vbMagenta
    Next
