...
Public Const conMenu_PlugPopup = 6 '外接程序
'            检验技师工作站使用   6100-6199
'文件菜单
...
'护士站病人入出转
Public Const conMenu_Manage_Change_Undo = 322         '撤销功能

Public Const conMenu_Manage_Change_In = 3510          '病人入科
Public Const conMenu_Manage_Change_Turn = 3511      '转科
Public Const conMenu_Manage_Change_Bed = 3512         '换床
Public Const conMenu_Manage_Change_House = 3513       '包房
Public Const conMenu_Manage_Change_Out = 3514         '病人出院
Public Const conMenu_Manage_Change_InPati = 3515      '转为住院病人
Public Const conMenu_Manage_Change_BedGrid = 3516     '更改床位等级
Public Const conMenu_Manage_Change_PatiInfo = 3517    '调整住院信息
Public Const conMenu_Manage_Change_Baby = 3518        '新生儿登记
Public Const conMenu_Manage_Change_ReCalcFee = 3519   '按费别重算费用
Public Const conMenu_Manage_Change_InsureSel = 3520   '医保病种选择
...
'排队叫号系统
Public Const conMenu_Queue_CallThis = 8210      '直呼
Public Const conMenu_Queue_CallNext = 8211      '顺呼，呼叫下一个
Public Const conMenu_Queue_CallFirst = 8212     '优先
Public Const conMenu_Queue_ReInQueue = 8213     '复诊
Public Const conMenu_Queue_ReCall = 8214        '重呼
Public Const conMenu_Queue_Abandon = 8215       '弃号
Public Const conMenu_Queue_Refresh = 8216       '刷新
Public Const conMenu_Queue_Setup = 8217         '参数设置
Public Const conMenu_Queue_Update = 8218        '修改
