...
Begin VB.Form frmItemClassEdit 
   ...
   ClientTop       =   3750
   ClientWidth     =   5775
   Icon            =   "frmTemplateClass.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fra 
      ...
      Begin VB.CommandButton cmd 
         ...
         Index           =   0
         Left            =   3930
         Picture         =   "frmTemplateClass.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   7
         TabStop         =   0   'False
         Top             =   1035
...
Public Function ShowEdit(ByVal frmMain As Object, ByVal strTemplate As String, ByVal strDataKey As String, ByVal strUpDataKey As String, Optional ByVal bytMode As Byte = 1) As Boolean
    '******************************************************************************************************************
    '功能：
    '参数：
    '返回：
...
Private Function NewDefaultCode(ByVal strUpKey As String, ByRef objTxtParent As Object, ByRef objTxt As Object, ByRef objChk As Object) As Boolean
    ...
    If strUpKey = "" Then
        ...
        Call zlCommFun.SetCondition(rsCondition, "id", "")
