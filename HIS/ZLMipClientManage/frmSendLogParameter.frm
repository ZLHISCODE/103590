...
Begin VB.Form frmSendLogPara 
   ...
   ClientTop       =   375
   ClientWidth     =   6540
   Icon            =   "frmSendLogParameter.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2745
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.Image img 
         ...
         Index           =   1
         Left            =   225
         Picture         =   "frmSendLogParameter.frx":000C
         Top             =   315
         Width           =   480
      End
      Begin VB.Label lbl 
   ...
   End
End
Attribute VB_Name = "frmSendLogPara"
...
Public Function ShowConfigDialog(ByVal frmParent As Object) As Boolean
    ...
    strPara = gclsBusiness.ParameterRead(10)
    If strPara <> "" Then
...
'    strPara = txt(7).Text & ";" & txt(8).Text & ";" & txt(9).Text & ";" & txt(10).Text
    ...
    Call zlCommFun.SetParameter(rsPara, "参数号", 10)
