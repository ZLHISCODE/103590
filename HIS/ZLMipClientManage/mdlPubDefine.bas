...
Public Const conMenu_Manage_Table = 2617
Public Const conMenu_Manage_Item = 2618
Public Const conMenu_Manage_Station = 2619
Public Const conMenu_Manage_SendLog = 2620
Public Const conMenu_Manage_ReceiveLog = 2621
...
Public Const conMenu_PatholManage = 10 '病理管理
Public Const conMenu_CollectionPopup = 11 '收藏管理
...
Public Const conMenu_File_Close = 197            '*退出(&X)
''病人费用查询
...
'
Public Const conMenu_Manage_LoadData = 211      '*安装消息数据
Public Const conMenu_Manage_UnLoadData = 212     '安装消息数据
Public Const conMenu_Manage_Upgrade = 213        '*升级消息客户端
Public Const conMenu_Manage_UnLoad = 214        '安装消息数据
...
'临床路径编辑菜单
Public Const conMenu_Edit_OutLogModi = 3040 '修改出径登记
Public Const conMenu_Edit_OutLogView = 3041 '查看出径登记
...
'对象
'----------------------------------------------------------------------------------------------------------------------
Public Const conMenu_Object_DBUser = 6820 '数据库所有者
...
Public Const conMenu_View_Check = 3819
Public Const conMenu_View_UnCheck = 3820
...
'
''病理菜单
'Public Const conMenu_Antibody_Manage = 8126     '抗体管理
'Public Const conMenu_Meal_Manage = 8127         '套餐维护
'Public Const conMenu_Pathol_Request = 8128      '病理申请
'Public Const conMenu_Report_Delay = 8129        '报告延迟
'Public Const conMenu_Con_Request = 8130         '会诊申请
'Public Const conMenu_Con_Feedback = 8131        '会诊反馈
'Public Const conMenu_Decalin_Task = 8132        '脱钙任务管理
'Public Const conMenu_Bat_SlicesAccept = 8133    '制片批量接受
'Public Const conMenu_Bat_SlicesSure = 8134      '制片批量确认
'Public Const conMenu_Bat_SpeExamAccept = 8135   '特检批量接受
'Public Const conMenu_Bat_SpeExamSure = 8136     '特检批量确认
'Public Const conMenu_Bat_Process = 8137         '批量处理
'Public Const conMenu_Quality_Manage = 8138      '病理质量管理
'Public Const conMenu_Pathol_NumConfig = 8139    '病理号码配置
'
''档案管理菜单
'Public Const conMenu_PatholArchivesManage = 8150
'Public Const conMenu_PatholArchivesClass = 8151 '档案类别配置
'Public Const conMenu_PatholArchivesPlace = 8152 '档案位置配置
'Public Const conMenu_PatholArchivesFile = 8153  '档案文件归档
'Public Const conMenu_PatholArchivesMaterial = 8154  '档案材料归档
'Public Const conMenu_PatholArchivesLend = 8155      '档案借阅管理
...
'
''收藏菜单
'Public Const conMenu_Collection_Manage = 8401 '收藏管理
'Public Const conMenu_Collection_To = 8402 '收藏到
'Public Const conMenu_Examine_Share = 8403 '查看共享
'
'
''三维重建菜单
