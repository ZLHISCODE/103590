...
'        Me.Width = Viewer.Images(1).SizeX * Screen.TwipsPerPixelX * mdblBigImgZoom
'        Me.Height = Viewer.Images(1).SizeY * Screen.TwipsPerPixelY * mdblBigImgZoom
...
'    Me.Width = mDcmImg.SizeX * Screen.TwipsPerPixelX * mdblBigImgZoom
'    Me.Height = mDcmImg.SizeY * Screen.TwipsPerPixelY * mdblBigImgZoom
    Call InitFaceSize(mDcmImg.SizeX * mdblBigImgZoom, mDcmImg.SizeY * mdblBigImgZoom)
