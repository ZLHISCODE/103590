...
Private Const G_STR_LOG_NAME = "电子签名调试日志"
Private Const G_STR_PROJECT = "zl9ESign"
...
Public Sub LogWrite(ByVal strFunction As String, ByVal strLog As String, ParamArray arrPars() As Variant)
'功能:此方法兼容以前日志,10.35.140以后建议直接使用 zlWriteLog
    
    zlWriteLog strFunction, strLog, arrPars
    
    If Not gobjLog Is Nothing Then Exit Sub '日志部件存在时,退出
