...
Private mblnCanShow As Boolean
...
Public Sub SetShowState(ByVal isShow As Boolean, Optional isDelayClsoe As Boolean)
    If Not isShow And isDelayClsoe Then
...
Public Sub ShowTipInfo(ByVal strInfo As String, Optional blnMultiRow As Boolean, Optional blnOutline As Boolean, Optional lngMaxWidth As Long)
'功能：显示或者隐藏提示
...
Private Sub timTip_Timer()
    ...
    Else
        ...
        If sngTime - sngBegin >= 0.2 And mblnCanShow Then
            Call ShowMe
        End If
    End If
